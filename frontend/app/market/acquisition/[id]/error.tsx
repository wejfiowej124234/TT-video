...
/** `/market/acquisition/[id]` 段错误边界；与 `market/acquisition/error` 同形 */
export default function MarketAcquisitionDetailSegmentError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      console.error("Market acquisition detail segment error:", error?.message);
    }
  }, [error]);
  ...
  return (
    <main
      ...
      role="alert"
      data-tt-error-boundary-root="market-acquisition-detail"
    >
      ...
      <div className="mt-4 flex flex-wrap justify-center gap-3">
        ...
        >
          {t("market_segment_acquisition_title")}
        </Link>
        <Link
          href="/"

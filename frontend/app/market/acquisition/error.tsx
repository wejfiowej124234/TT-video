...
/** `/market/acquisition` 页面级错误边界；与 `/market` error 同形。 */
export default function MarketAcquisitionError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      console.error("Market acquisition page error:", error?.message);
    }
  }, [error]);
  ...
  return (
    <main
      ...
      role="alert"
      data-tt-error-boundary-root="market-acquisition"
    >

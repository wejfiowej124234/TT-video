...
/** `/market/provider/showcase/[id]` 段错误边界；与 `market/provider/error` 同形 */
export default function MarketProviderShowcaseDetailSegmentError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      console.error("Market provider showcase detail segment error:", error?.message);
    }
  }, [error]);
  ...
  return (
    <main
      ...
      role="alert"
      data-tt-error-boundary-root="market-provider-showcase-detail"
    >

...
/** 自由市场路由 · 页面级错误边界（项目优化清单 2.3），28 与根 error 一致；文案 i18n */
export default function MarketError({
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      console.error("Market page error:", error?.message);
    }
  }, [error]);

  return (
    <main className="mx-auto flex min-h-[50vh] max-w-lg flex-col items-center justify-center px-6 py-12" role="alert">
      ...
      <p id={appErrorRetryHintId} className="mt-3 text-meta text-ink-600 leading-relaxed text-center max-w-lg px-2">

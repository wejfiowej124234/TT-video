...
/** 51-31-25：Escrow 路由 loading，i18n 与读屏可播报 */
export default function EscrowLoading() {
  const { t } = useTranslation();
  return (
    <main className="min-h-[60vh] flex items-center justify-center p-8" role="status" aria-label={t("escrow_detailAria")} aria-busy="true">

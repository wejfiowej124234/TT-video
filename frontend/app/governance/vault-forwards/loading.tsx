...
/** 与 vault-forwards 页：标题 + 筛选槽 + 六列表格骨架 */
export default function GovernanceVaultForwardsLoading() {
  const { t } = useTranslation();
  return (
    <main
      className="mx-auto max-w-6xl p-8"
      role="status"
      aria-label={t("governance_vault_forwards_title")}
      aria-busy="true"
    >
      <div className="min-h-[44px] h-11 w-80 max-w-full bg-ink-200 rounded-[var(--radius-sm)] animate-pulse" aria-hidden />

    ...
    <main className="mx-auto max-w-3xl px-4 py-8 text-ink-800">
      ...
      <div className="mt-6 space-y-2">
        ...
        <input
          ...
          className={`w-full min-h-[44px] rounded-[var(--radius-sm)] border border-ink-300 bg-white px-3 py-2 font-mono text-small ${travelFocusRingCoreOffset2WhiteClasses}`}
        />
      ...
      <div className="mt-6 flex flex-wrap gap-3">
        <button
          ...
          onClick={() => claim()}
          className={`inline-flex min-h-[44px] items-center justify-center rounded-[var(--radius-sm)] border border-ink-300 bg-white px-4 py-2 text-small font-medium text-ink-800 transition-colors motion-reduce:transition-none hover:bg-ink-50 disabled:opacity-50 ${travelFocusRingOffset2Classes}`}
        >
        ...
        <button
          ...
          className={`inline-flex min-h-[44px] items-center justify-center rounded-[var(--radius-sm)] border border-travel-500 bg-travel-500 px-4 py-2 text-small font-medium text-white transition-colors motion-reduce:transition-none hover:bg-travel-600 disabled:opacity-50 ${travelFocusRingOffset2Classes}`}
        >
      ...
      <nav className="mt-10 flex flex-wrap gap-4" aria-label={t("governance_nav_label")}>
        <Link
          ...
          className={`inline-flex min-h-[44px] items-center text-travel-500 hover:underline underline-offset-2 transition-colors motion-reduce:transition-none ${travelFocusRingOffset2Classes}`}
        >

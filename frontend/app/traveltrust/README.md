...
| L1 槽位 | `TravelTrustLockedHomeChrome` → `TravelTrustHomeLandingNavSlot` → `TravelTrustLandingChrome`（**LOCKED** · portal → `document.body` · z-280） |
| 正文 | `TravelTrustHomeBodyModule` — **唯一 HOME_BODY_MODULE**（Hero + 3D + BelowFold） |

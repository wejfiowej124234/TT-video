...
export default function CommunityTopicTagLoading() {
  ...
  return (
    ...
    >
      <section
        className="rounded-[var(--radius-md)] border border-ref-sun/25 bg-slate-900/70 backdrop-blur-md p-4 sm:p-5 mb-4 space-y-3 shadow-scifi-panel"
        aria-hidden
      >
        <div className="flex flex-wrap items-center gap-2">
          <div className="min-h-[44px] h-11 w-28 rounded-full bg-slate-800/80 border border-slate-600/50 animate-pulse" />
          <div className="min-h-[44px] h-11 w-36 rounded-full bg-ref-sun/10 border border-ref-sun/32 animate-pulse" />
        </div>

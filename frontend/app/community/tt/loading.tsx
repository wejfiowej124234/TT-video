...
export default function CommunityTTLoading() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-lg rounded-[var(--radius-md)] p-8 bg-slate-900/70 backdrop-blur-md border border-ref-sun/25 shadow-scifi-panel-lo space-y-4 animate-pulse">
        <div className="min-h-[44px] h-11 w-4/5 mx-auto bg-gradient-to-r from-ref-sun/20 to-ref-coral/15 rounded" aria-hidden />
        ...
        <div className="h-12 w-44 mx-auto rounded-[var(--radius-md)] bg-ref-sun/12 border border-ref-sun/28 mt-2" aria-hidden />
      </div>
    </main>
  );
}

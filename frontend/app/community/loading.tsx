...
export default function CommunityLoading() {
  ...
  return (
    ...
    >
      <header
        className="rounded-[var(--radius-md)] border border-cyan-400/40 bg-slate-900/60 backdrop-blur-md px-4 py-4 sm:px-6 sm:py-5 mb-4 shadow-scifi-banner-strong"
        aria-hidden
      >
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <div className="flex gap-2 flex-wrap">
            <div className="min-h-[44px] h-11 w-24 rounded-full bg-fuchsia-500/15 border border-fuchsia-400/40 animate-pulse" />
      ...
      <div
        className="w-full rounded-[var(--radius-xl)] border border-cyan-400/40 bg-slate-900/70 backdrop-blur-md px-4 py-3 mb-4 flex items-center gap-3 min-h-[52px]"
        aria-hidden
      >
        <div className="h-11 w-11 min-h-[44px] min-w-[44px] rounded-full bg-fuchsia-500/15 border border-fuchsia-400/40 animate-pulse shrink-0" />
        <div className="flex-1 h-4 bg-slate-700/50 rounded-[var(--radius-sm)] animate-pulse" />
        <div className="h-4 w-20 bg-cyan-500/15 rounded-[var(--radius-sm)] animate-pulse shrink-0" />
      </div>

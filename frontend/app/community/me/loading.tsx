      ...
      <header className="rounded-[var(--radius-md)] border border-cyan-400/40 bg-slate-900/60 backdrop-blur-md px-4 py-6 mb-4 shadow-scifi-banner" aria-hidden>
        <div className="flex items-start gap-4">
          <div className="relative flex-shrink-0">
            <div className="h-20 w-20 rounded-full bg-slate-700/70 ring-2 ring-cyan-400/40 animate-pulse" />
        ...
        <div className="flex items-center gap-2 mt-4 flex-wrap">
          <div className="min-h-[44px] h-11 w-28 rounded-full bg-cyan-500/20 border border-cyan-400/40 animate-pulse" />
          <div className="h-11 w-11 min-h-[44px] min-w-[44px] rounded-full bg-slate-800/80 border border-slate-500/50 animate-pulse" />
        </div>
      </header>

      <section className="rounded-[var(--radius-md)] border border-cyan-500/30 bg-slate-900/70 backdrop-blur-md p-4 mb-4" aria-hidden>

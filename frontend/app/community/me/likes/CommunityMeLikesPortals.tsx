...
import { CommunityMeUnlikeConfirmDialog } from "@/components/community/CommunityMeUnlikeConfirmDialog";
import type { CommunityMeLikesPageViewModel } from "./useCommunityMeLikesPage";

/** 与 `page.tsx` 同源 · portal 详情/举报（①） */
export function CommunityMeLikesPortals({
  vm,
  confirmSurface = "page",
}: {
  vm: CommunityMeLikesPageViewModel;
    ...
    <>
      ...
      {detailPost && (
        <PostDetailDrawerPortal
          ...
          {...detailVideoFeedDrawerProps(likedPostsForGrid, detailPost, setDetailPost)}
        />
      )}
      {interactionToast ? (
        <div
      ...
      <CommunityMeUnlikeConfirmDialog
        open={unlikeConfirmPostId != null}
        busy={unlikeConfirmBusy}
        t={t}

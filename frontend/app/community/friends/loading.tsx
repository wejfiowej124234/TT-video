  ...
  return (
    <main className="max-w-4xl mx-auto px-3 py-4 sm:px-4 sm:py-6 pb-24 safe-area-pb" role="status" aria-label={t("community_tab_friends")} aria-busy="true">
      <header className="mb-4 space-y-2" aria-hidden>
        <div className="min-h-[44px] h-11 w-44 max-w-full rounded-[var(--radius-sm)] bg-gradient-to-r from-ref-sun/25 to-ref-coral/20 animate-pulse" />
      ...
      <section className="rounded-[var(--radius-md)] border border-ref-sun/25 bg-slate-900/70 backdrop-blur-md overflow-hidden shadow-scifi-panel">

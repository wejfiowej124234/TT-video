...
export default function GuideRegisterAlreadyGuidePanel({
  successFocusRef,
  t,
}: {
  ...
  return (
    <main
      ...
      aria-label={t("guideRegister_alreadyGuideTitle")}
    ...
    >
      ...
      <div className={`${TT_GUIDE_REGISTER_L5.pageColumn} flex flex-1 flex-col items-center justify-center gap-8`}>
        <div className={TT_GUIDE_REGISTER_L5.statusCardWrap}>
          <AuthL5Card surface="guide_register_already">
            ...
            <p className="text-h4 font-semibold text-slate-100" role="status" aria-live="polite">
              {t("guideRegister_alreadyGuideTitle")}
            </p>
            <p className="mt-2 text-small text-slate-300/95">{t("guideRegister_alreadyGuideDesc")}</p>

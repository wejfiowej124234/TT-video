...
import { GUIDE_DETAIL_HERO_RING_CLASS, GUIDE_DETAIL_PANEL_CLASS } from "./guideDetailPageConstants";
    ...
    <main className="relative min-h-screen" role="status" aria-label={t("guideDetail_title")} aria-busy="true">
      ...
      <div className="relative z-10 min-h-screen px-4 py-8 md:py-12">
        <div className="mx-auto max-w-2xl space-y-6">
          ...
          <section className={`${GUIDE_DETAIL_PANEL_CLASS} p-6`} aria-hidden>
            <div className="flex flex-col sm:flex-row gap-4 items-start">
              <div className={`w-24 h-24 shrink-0 rounded-full bg-ink-600/70 ${GUIDE_DETAIL_HERO_RING_CLASS} animate-pulse motion-reduce:animate-none`} />
              <div className="flex-1 space-y-3 min-w-0">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <div className="min-h-[44px] h-11 w-40 rounded-[var(--radius-md)] bg-ref-sun/10 border border-ref-sun/35 animate-pulse motion-reduce:animate-none" />
                </div>
              </div>
            </div>
          </section>
          <section className={GUIDE_DETAIL_PANEL_CLASS} aria-hidden>

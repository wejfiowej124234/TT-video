      ...
      <div className={`${ADMIN_FILTER_CARD_CLASS} flex flex-wrap items-end gap-3`} data-tt-admin-queue-list-filter="steward">
        ...
        <label className={ADMIN_FILTER_FIELD_LABEL_CLASS}>
          ...
          >
            ...
            <option value="">{t("admin_steward_list_filterAll")}</option>

            <option value="stake_pending">{t("admin_steward_list_statusStakePending")}</option>

            <option value="submitted">{t("admin_steward_list_statusSubmitted")}</option>

            <option value="reviewing">{t("admin_steward_list_statusReviewing")}</option>

            <option value="approved">{t("admin_steward_list_statusApproved")}</option>

            <option value="rejected">{t("admin_steward_list_statusRejected")}</option>

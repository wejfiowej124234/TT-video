...
type AdminSchedulerJobsPageHeaderProps = {
  pageTitleId: string;
};

export function AdminSchedulerJobsPageHeader({ pageTitleId }: AdminSchedulerJobsPageHeaderProps) {
  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-3">
      <div>
        ...
        <p className="mt-1 text-body text-ink-600">{t("admin_scheduler_jobs_subtitle_l5")}</p>
      </div>

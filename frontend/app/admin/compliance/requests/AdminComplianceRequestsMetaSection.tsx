...
type AdminComplianceRequestsMetaSectionProps = {
  meta: Record<string, unknown> | null;
  loading: boolean;
  error: AdminFetchErrorKind | null;
};

export function AdminComplianceRequestsMetaSection({ meta, loading, error }: AdminComplianceRequestsMetaSectionProps) {
  return (
    <>

...
type AdminLifecyclePageHeaderProps = {
  pageTitleId: string;
};

export function AdminLifecyclePageHeader({ pageTitleId }: AdminLifecyclePageHeaderProps) {
  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-3">
      <div>
        ...
        <p className="mt-1 text-body text-ink-600">{t("admin_lifecycle_subtitle_l5")}</p>
      </div>

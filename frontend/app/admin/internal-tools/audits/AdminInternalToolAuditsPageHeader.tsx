...
type AdminInternalToolAuditsPageHeaderProps = {
  pageTitleId: string;
};

export function AdminInternalToolAuditsPageHeader({ pageTitleId }: AdminInternalToolAuditsPageHeaderProps) {
  ...
  return (
    <header className="flex flex-wrap items-center justify-between gap-3">
      <div>
        ...
        <p className="mt-1 text-body text-ink-600">{t("admin_tool_audits_subtitle_l5")}</p>
      </div>

/**
 * 设置 Hub → **`/me/security`** / **`/me/password`**（账户安全不再从社区资料卡重复入口）。
...
test.describe.serial("/me/settings → account security pages", () => {

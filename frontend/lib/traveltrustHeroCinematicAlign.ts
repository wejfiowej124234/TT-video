...
/** split Canvas 左栏内地球 rig X（略偏左，避免右卡遮挡 · 100% 截图） */
export const TT_HERO_SPLIT_GLOBE_X = -0.36;
...
/** 首屏地球缩放（L5：略收，文案区为第一视觉锚点） */
export const TT_HERO_SPLIT_GLOBE_SCALE_MUL = 0.84;

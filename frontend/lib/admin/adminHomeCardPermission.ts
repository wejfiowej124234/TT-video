...
export const ADMIN_HOME_CARD_REQUIRED_PERM: Record<string, AdminPermissionId> = {
  ...
  "/admin/backup": ADMIN_PERM.PLATFORM_READ,
  ...
  "/admin/vacancy-ledger": ADMIN_PERM.FINANCE_READ,
  ...
  "/admin/content/translation": ADMIN_PERM.CONTENT_READ,
  "/admin/content/seo": ADMIN_PERM.CONTENT_READ,
  "/admin/content/announcements": ADMIN_PERM.CONTENT_READ,
  "/admin/content/roadmap": ADMIN_PERM.CONTENT_READ,

...
describe("adminHomeSectionPending", () => {
  ...
  it("does not treat core list volume as inbox pending", () => {
    const n = sectionPendingCount(
      "core",
      { provider: 5, guide: 0, steward: 0, approvals: 0, disputes: 0, reports: 0 },
      emptyChannels,
  ...
  it("sums community pending from inbox reports channel", () => {
    const n = sectionPendingCount(
      "community",
      { provider: 0, guide: 0, steward: 0, approvals: 0, disputes: 0, reports: 4 },
      emptyChannels,
      { orders: 0, disputes: 0 },
      false,
      false,
  ...
  it("includes disputes in onboarding section pending (Cut C OD-C-04)", () => {
    const n = sectionPendingCount(
      "onboarding",
      { provider: 1, guide: 0, steward: 0, approvals: 0, disputes: 2, reports: 9 },
      emptyChannels,
      { orders: 0, disputes: 0 },
      false,
      false,

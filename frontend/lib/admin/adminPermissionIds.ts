...
export const ADMIN_PERM = {
  ...
  FEE_ROUTER_READ: "admin.fee_router.read",
  ...
  ANNOUNCEMENT_AUDIENCE_PUBLIC_USER: "admin.content.announcement.audience.public_user",
  ANNOUNCEMENT_AUDIENCE_TOKEN_HOLDER: "admin.content.announcement.audience.token_holder",
  ANNOUNCEMENT_AUDIENCE_TECHNICAL_PUBLIC: "admin.content.announcement.audience.technical_public",
...
export const ADMIN_PERMISSION_MATRIX_ROWS: {
  ...
  { id: ADMIN_PERM.FEE_ROUTER_READ, labelKey: "admin_perm_fee_router_read" },
  ...
  {
    id: ADMIN_PERM.ANNOUNCEMENT_AUDIENCE_PUBLIC_USER,
    labelKey: "admin_perm_announcement_audience_public_user",
  },
  {
    id: ADMIN_PERM.ANNOUNCEMENT_AUDIENCE_TOKEN_HOLDER,
    labelKey: "admin_perm_announcement_audience_token_holder",
    superOnly: true,
  },
  {
    id: ADMIN_PERM.ANNOUNCEMENT_AUDIENCE_TECHNICAL_PUBLIC,
    labelKey: "admin_perm_announcement_audience_technical_public",
  },

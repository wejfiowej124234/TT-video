...
export function TravelTrustFaqStrip() {
  ...
  const sectionMotion = traveltrustSectionMotionProps("faq", reduceMotion);
    ...
    >
      ...
      >
        ...
        <ul className={TT_FAQ_ACCORDION_L5.listClass}>
          {FAQ_ITEMS.map(({ q: qKey, a: aKey, rich }, i) => {
            ...
            return (
              <motion.li
                ...
                whileHover={reduceMotion ? undefined : TT_FAQ_ACCORDION_L5.itemHover}
                whileTap={reduceMotion ? undefined : TT_FAQ_ACCORDION_L5.triggerTap}
                viewport={{ once: true, margin: "-6% 0px" }}
                transition={traveltrustSectionChildStagger(i, reduceMotion, TT_FAQ_ACCORDION_L5.listStaggerBase)}

...
/** 与 `#0c0a09` 暖墨底一致（非地球 mesh · Canvas clear/fog） */
export const TT_CINEMATIC_3D_BG = "#0c0a09";
...
export const TT_BRAND_3D = {
  ...
  mint: "#6ee7b7",
  teal: "#0c6e69",
  /** Hero 空域与 Canvas clear 同键（非冷天蓝） */
  sky: TT_CINEMATIC_3D_BG,
} as const;
...
> = {
  ...
  merchant: { primary: "#fbbf24", secondary: "#fca47c", pulse: "#fff7ed" },
  acquisition: { primary: "#a78bfa", secondary: "#c4b5fd", pulse: "#f5f3ff" },

...
export function TravelTrustPageComplianceBlock() {
  ...
  return (
    ...
    <motion.div
      ...
      data-tt-traveltrust-page-compliance-border-pulse-l5="1"
    ...
    >
      ...
      {!reduceMotion ? (
        ...
        <motion.span
          ...
          className="pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-ref-sun/55 to-transparent"

          aria-hidden

          animate={{ opacity: [...TT_PAGE_COMPLIANCE_L5.topBorderPulse.opacity] }}

          transition={{

            duration: TT_PAGE_COMPLIANCE_L5.topBorderPulse.duration,

            repeat: TT_PAGE_COMPLIANCE_L5.topBorderPulse.repeat,

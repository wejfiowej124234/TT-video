...
export function DidRankRouteSuspenseFallback() {
  ...
  return (
    <main
      className={`${darkRoutePageShellClass(surface)} relative flex flex-col items-center justify-center gap-6 overflow-hidden p-8`}
    ...
    >
      ...
      <ProductCrossNav
        ...
        linkClassName="inline-flex min-h-[44px] items-center justify-center text-ref-sun hover:text-ref-sun underline motion-sub focus:outline-none focus-visible:ring-2 focus-visible:ring-ref-coral/50 focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a0a] rounded-[var(--radius-sm)] px-0.5"

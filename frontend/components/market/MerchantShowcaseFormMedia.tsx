...
export function MerchantShowcaseFormMedia({
  t,
  form,
  setForm,
  coverLabelId,
  ...
  return (
    <section className="space-y-4" aria-labelledby="m-studio-media">
      <h3 id="m-studio-media" className={marketStudioModalSectionHeadingCyan}>

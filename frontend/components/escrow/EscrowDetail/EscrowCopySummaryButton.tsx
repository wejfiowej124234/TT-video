...
const protocolDidButtonClass = `text-cyan-300 hover:text-cyan-100 hover:drop-shadow-scifi-cyan-lg transition-colors disabled:opacity-60 disabled:cursor-wait rounded-[var(--radius-sm)] motion-sub print:hidden ${deepShellPillControlFocusClasses}`;

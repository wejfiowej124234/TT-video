...
export interface ItineraryResultsSectionProps {
  ...
  country: string;
  cities: string[];
  /** 表单未齐：磨砂锁（国家/城市/时间/人数/预算） */
  previewLocked: boolean;
  /** 本会话已主动「AI 生成行程」且表单齐：才展示真卡与订单入口 */
  showLiveAiResults: boolean;
...
function ItineraryResultsSection({
  ...
  const showGenerating = submitting && !showLiveAiResults;
  ...
  return (
    <section
      ...
      data-tt-home-ai-preview-locked={previewLocked ? "1" : "0"}
      data-tt-home-ai-live={showLiveAiResults ? "1" : "0"}
    ...
    >
      ...
      <div className="flex flex-wrap items-center gap-3 mb-2">
        ...
        {showLiveAiResults && (country || cities.length > 0) && (

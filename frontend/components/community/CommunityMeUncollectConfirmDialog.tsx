...
export function CommunityMeUncollectConfirmDialog({
  open,
  busy,
  t,
  surface = "page",
  ...
  return createPortal(
    <div
      ...
      data-tt-community-uncollect-confirm="1"
      onMouseDown={(e) => {
      ...
      >
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <button type="button" className={confirmClass} onClick={() => void onConfirm()} disabled={busy}>
            {busy ? t("community_me_notes_menu_remove_collect_pending") : t("community_me_notes_menu_remove_collect")}
          </button>
        </div>
      </div>
    </div>,

      ...
      {items.map((post) => {
        ...
        return (
          <Link
            ...
            href={href}
            role="listitem"
            className={`group block break-inside-avoid mb-2 rounded-[var(--radius-md)] overflow-hidden border border-cyan-500/25 bg-slate-900/60 motion-sub hover:border-cyan-400/50 hover:shadow-scifi-masonry-hover ${communityCardLinkFocus}`}
          >

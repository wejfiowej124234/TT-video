...
export default function CommunityFeedCardActions({
  ...
  return (
    <div className="flex items-center gap-4 pt-2 border-t border-slate-600/50 px-3 sm:px-4 pb-3 sm:pb-4">
      <form
        className="contents"
        onSubmit={(e) => {
          e.preventDefault();
      ...
      >
        <button
          type="submit"
          className={`inline-flex min-h-[44px] items-center justify-center gap-1.5 text-meta motion-sub rounded-[var(--radius-md)] px-1.5 py-1 ${communityShellTabFocus} ${liked ? "text-cyan-300" : "text-slate-300 hover:text-cyan-100"}`}
      ...
      <form className="contents" onSubmit={commentTrigger}>
        <button
          type="submit"
          className={`inline-flex min-h-[44px] items-center justify-center gap-1.5 text-meta text-slate-300 hover:text-cyan-100 motion-sub rounded-[var(--radius-md)] px-1.5 py-1 ${communityShellTabFocus}`}
      ...
      >
        <button
          type="submit"
          className={`inline-flex min-h-[44px] items-center justify-center gap-1.5 text-meta motion-sub rounded-[var(--radius-md)] px-1.5 py-1 ${communityShellTabFocus} ${collected ? "text-fuchsia-300" : "text-slate-300 hover:text-fuchsia-300"}`}

...
"$PYTHON_BIN" scripts/ops/region_vault_claim_broadcast_nonce_preflight.py self-test
"$PYTHON_BIN" scripts/ops/region_vault_claim_broadcast_receipt_archive.py self-test
"$PYTHON_BIN" scripts/ops/region_vault_claim_production_go_gate.py self-test
"$PYTHON_BIN" scripts/ops/region_vault_claim_evidence_bundle_merkle.py self-test
"$PYTHON_BIN" scripts/ops/broadcast_batch_json_assert.py 1

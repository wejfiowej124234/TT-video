...
for var in JOB_BUILD JOB_FRONTEND JOB_REGIONAL_MATRIX JOB_A11Y JOB_E2E JOB_FINANCE_RECONCILE JOB_CONFIG_CENTER JOB_FEATURE_FLAG JOB_JOB_QUEUE JOB_SECRET_KEY JOB_BROADCAST_BATCH_1 JOB_BROADCAST_BATCH_2 JOB_BROADCAST_BATCH_3; do
  r="${!var:-unknown}"
  if [ "${r}" != "success" ]; then

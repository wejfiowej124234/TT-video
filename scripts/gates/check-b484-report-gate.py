#!/usr/bin/env python3
"""
B-484：将 governance protocol consistency report.v1.json 与 gate 比对。
用法：python3 scripts/gates/check-b484-report-gate.py <report.v1.json>
"""
...
from _b484_governance_eval import SCHEMA_GATE, slo_violations  # noqa: E402
...
def main() -> int:
    ...
    gate_path = root / "config" / "b484_governance_protocol_consistency_gate.v1.json"
    ...
    print("check-b484-report-gate: OK (B-484 governance & protocol consistency gate)", file=sys.stderr)
    return 0

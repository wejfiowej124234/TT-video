#!/usr/bin/env python3
"""
B-483：将 auditability report.v1.json 与 gate 比对。
用法：python3 scripts/gates/check-b483-report-gate.py <report.v1.json>
"""
...
from _b483_auditability_eval import SCHEMA_GATE, slo_violations  # noqa: E402
...
def main() -> int:
    ...
    gate_path = root / "config" / "b483_auditability_forensics_gate.v1.json"
    ...
    print("check-b483-report-gate: OK (B-483 auditability & forensics gate)", file=sys.stderr)
    return 0

#!/usr/bin/env python3
"""
B-485：将 user-verifiable transparency report.v1.json 与 gate 比对。
用法：python3 scripts/gates/check-b485-report-gate.py <report.v1.json>
"""
...
from _b485_user_verifiability_eval import SCHEMA_GATE, slo_violations  # noqa: E402
...
def main() -> int:
    ...
    gate_path = root / "config" / "b485_user_verifiable_transparency_gate.v1.json"
    ...
    print("check-b485-report-gate: OK (B-485 user-verifiable transparency gate)", file=sys.stderr)
    return 0

...
python3 scripts/ops/region_vault_claim_broadcast_receipt_revalidate_rpc.py self-test
python3 scripts/ops/region_vault_claim_production_go_gate.py self-test
python3 scripts/ops/region_vault_claim_evidence_bundle_manifest_openssl_smoke.py self-test
python3 scripts/ops/broadcast_batch_json_assert.py 2

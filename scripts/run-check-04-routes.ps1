...
& $pyExe scripts/check-04-routes-vs-code.py
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $pyExe scripts/check-04-frontend-routes-vs-app.py
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $pyExe scripts/check-13-1-table1-routes-vs-app.py
if ($LASTEXITCODE -ne 0) { exit $LASTEXITCODE }
& $pyExe scripts/check-13-1-routes-covered-by-04-frontend-table.py
exit $LASTEXITCODE

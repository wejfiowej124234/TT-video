...
if (-not $env:DID_RANK_SEED_MARKET_DEMO) { $env:DID_RANK_SEED_MARKET_DEMO = "1" }
...
if (-not $env:TRAVELTRUST_ALLOW_LOCAL_PROFILE_AVATAR) { $env:TRAVELTRUST_ALLOW_LOCAL_PROFILE_AVATAR = "1" }
if ($env:API_PORT) {

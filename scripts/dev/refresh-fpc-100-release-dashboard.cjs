...
const executiveSummary = {
  ...
  owner_daily_metrics: ['TT_RELEASE_READINESS', 'TT_RELEASE_DECISION'],
  ...
  governance: 'FROZEN @ v5 · Do not expand',
  execution: 'B02→B41 only',
};
...
const md = [
  ...
  '| Metric | Value |',
  '|--------|-------|',
  `| **TT_RELEASE_READINESS** | **${executiveSummary.release_readiness_pct}%** |`,
  `| **TT_RELEASE_DECISION** | **${executiveSummary.release_decision}** |`,
  '',
  `_Next batch: ${executiveSummary.next_required_batch || '—'} · v${versionReg.current_product_version.replace('v', '')}_ · Governance FROZEN — no v5 expansion_`,
  '',

...
ROWS: list[Row] = [
    ...
    ("GOV-03", "Seat concentration", "vote cap 400 bps", "/governance?view=region", "GET /governance/voting-power", "TtgSeatConcentrationRegistry", "Seat holder", "—", "PASS", "G24-GOV-CONC-01 · GO_governance_concentration_audit_sepolia/", "—", "需链上验证"),
    ...
    ("Governor", "Vote", "cast vote wallet", "/governance/proposals/[id]", "POST /governance/proposals/:id/vote", "Governor", "voter", "—", "PARTIAL", "Phase A vote capped · API stub ① PASS", "P1", "需链上验证"),

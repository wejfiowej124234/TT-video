...
library TtgV9DesignLockConstants {
    ...
    uint256 internal constant PLATFORM_FEE_BPS = 500; // 5% — Escrow rate; change only via governance
    uint256 internal constant STEWARD_SHARE_BPS = 4500; // of platform fee when Active Steward

...
| **维度结论摘要** | **§一** |
| **细则与建议** | **§二** 起 |
| **主规范 / Tokens** | **[31](31-TT社区页面设计.md)**（**v2.11+** · **88** / **FIVE-MAIN**）、**[22](22-Design-Tokens-旅游Web3融合体系-v1.0.md)**、**[25](25-顶级UI标准-Landing-Discover-Itinerary.md)** |
| **附属地位** | 本文 **2026-03 时点检查**；冲突以 **31 + 88** 为准 |

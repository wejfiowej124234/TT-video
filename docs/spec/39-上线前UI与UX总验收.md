...
| **92** | **全站** **F/X/G** **分区** **表** **A** **；** **共享** **资金** **组件** **=** **F** **约束** **（** **§四** **）** **。** |
...
| □ | 验收项 | 依据 |
|---|--------|------|
| □ | 本变更涉及之前台路由已在 **PR** **或** **变更说明** **中** **标注** **F** **/** **X** **/** **G** **，** **且** **与** **[92 §四 表 A](92-P0-全站UI分区控制表-金融体验灰区与动效裁决.md#四全站页面分区控制表p0)** **一致** | **07 §五 5.3**、**CONTRIBUTING** |
| □ | **未** **在** **F** **区** **或** **共享** **资金** **组件** **上** **引入** **Experience** **级** **粒子** **/** **强** **glow** **/** **娱乐化** **动效** | **92 §四**、**13 §一** |

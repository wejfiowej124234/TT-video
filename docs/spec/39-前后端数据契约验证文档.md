...
### 2.1 注册接口 (POST /api/v1/auth/register)
...
pub struct RegisterBody {
    ...
    pub password: String,
    pub nickname: String,
    pub role: UserRole, // "tourist" | "guide"
}
...
| role | `UserRole` (enum) | `"tourist" \| "guide"` | ✅ | 需 `#[serde(rename_all = "snake_case")]` |
| token | `String` | `string` | ✅ | - |
| refresh_token | `String` | `refreshToken` (string) | ✅ | 需 `#[serde(rename = "refreshToken")]` |
| user | `UserProfile` | `UserProfile` | ✅ | 嵌套类型，见 §2.2 |

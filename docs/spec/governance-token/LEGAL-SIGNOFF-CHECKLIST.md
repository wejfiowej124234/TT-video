...
| ☐ | **NAV 赎回非保本（R4 · P1 纪要）** | 对外材料与 **[08-4 §2](08-4-对外口径包.md)**「NAV 窗口赎回」工程草案一致：**NAV 比例赎回、非本金保证**；窗口/上限以 **protocol-ssot** · **fund-flow-ssot §4** 为准；**禁止**保本/刚性兑付措辞 |
...
|------|------|
| 文档版本（ZH） | 0.2.0（① 维护快照） |
| 文档版本（EN） | 0.2.0-draft-en |
| 定稿日期 | 2026-06-03 |
| 法务确认 | **Sebastian Ward（塞巴斯蒂安·沃德）** · Owner 自证 · [签字索引](../../frontend/evidence/GO_local_phase1/SOLO-MAINTAINER-SIGNATURE-INDEX.md) |
| 产品确认 | **Sebastian Ward（塞巴斯蒂安·沃德）** |

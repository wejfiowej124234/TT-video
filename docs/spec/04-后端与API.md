...
| GET | /meta | 版本与 SSOT 绑定、defaults 快照（REQUEST_BODY_LIMIT_BYTES、REQUEST_TIMEOUT_SECS 等）；前端 fail-closed 校验用，见 §四、05 §七点六 |
...
**Phase 0（架构锁定）、Phase 5（风控与运营就绪）** 定义及产出见 [07-开发流程与顺序](07-开发流程与顺序.md) §二；本文以下为 Phase 1～4。**与 07 阶段对照**：Phase 1～4 与 07 §二 阶段表、§三 文档与实现顺序对照表一一对应（04 Phase 1≈07 Phase 1；04 Phase 2≈07 Phase 2 链下；04 Phase 3/4 与 07 Phase 3/4 争议与链上/前端、支付+KYC 对应），完整阶段以 07 §二为准。

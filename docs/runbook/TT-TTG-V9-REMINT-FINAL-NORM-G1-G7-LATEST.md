...
**② evidence:** `evidence/GO_ttg_v9_remint_sepolia/V9_REMINT_SEPOLIA_PASS_STOP.json`

---

## −1 · TTG V9 Monetary Invariant (supreme)
...
**Form:** `MAX_SUPPLY = 25T` · `NO_FURTHER_MINT` · Token non-upgradeable · business layer upgradeable.  
**Full matrix (forbidden vs allowed):** [TT-TTG-V9-MONETARY-INVARIANT-LATEST.md](TT-TTG-V9-MONETARY-INVARIANT-LATEST.md).
...
| ② Sepolia full lifecycle + G6 live cutover | **`V9_REMINT_SEPOLIA_PASS_STOP`** (2026-08-21) |
| **②.5 Security Audit / Mainnet Readiness** | **`V9_AUDIT_CANDIDATE`** + Internal Wave · Critical/High=0 · [Audit Ladder](TT-TTG-V9-SECURITY-AUDIT-LADDER-LATEST.md) |
| Remediation → Sepolia Regression | `V9_SEPOLIA_REGRESSION_PASS` |
| ③ Mainnet Official pin | Owner written auth · separate · **no auto-promote** |

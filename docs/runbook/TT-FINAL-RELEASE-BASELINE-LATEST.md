# TT · FINAL RELEASE BASELINE（唯一体系 · Home AI 预览闸 · Web tip 已烤）
...
```text
本轮：Home AI 行程卡状态机 Delta + Freeze + Web tip 烤入
...
| 轴 | 状态 |
|----|------|
| local_git / registry / psg_pin | tip `1b622923`（Freeze overlay 后 HEAD ≠ tip = Expected） |
| web / release_identity | **PASS** @ `1b622923` |
| api | **Expected Difference** @ `f9c227de`（本 Delta 仅前端） |

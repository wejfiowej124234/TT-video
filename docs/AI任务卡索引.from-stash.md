...
**GO 发版闭环十卡（** **2026-04-16** **）** **：** **母表** **B-418～B-427** **，** **定版 Runbook** **[`TT-GO-CLOSELOOP-10-B418-B427-001.md`](./runbook/TT-GO-CLOSELOOP-10-B418-B427-001.md)** **；** **B-418** **～** **B-427** **均已** **封口** **（** **主索引** **一览** **337～346** **；** **本** **一览** **386～395** **）** **。**
...
| 202 | TT-B191-TRAVELTRUST-PAGE-04-13-1-CLOSE-001 | frontend / 路由契约 · `/traveltrust` | 已封口（**实现轮完成**） | **B-191**：**`GET /api/v1/traveltrust/page-brief`**（**`crates/api/src/routes/traveltrust_page.rs`** + **`routes/mod.rs`**）；**04 §3.3/§3.4** **`/traveltrust` Implemented** + **page-brief** 行；**13-1 表 1 · Network** **Implemented**；**`frontend/modules/traveltrust-home`** **`TravelTrustPageBriefProvider`**（**非** **`page.tsx`** **`TravelTrustPageBriefHydrate`** 直挂 — **2026-05-26 文档勘误**）、**`frontend/lib/api.ts`**、**`frontend/lib/analytics.ts`** **`source`/`target`**；**85** **封口清单** **1/3/7** **与** **CTA·埋点·`page-brief`** **对齐**（**台账同批** **登记**）；**`TravelTrustStickyCta`** **① 未**挂载现行页树（**FIVE-MAIN** · **contract**）；互证 [**母表 B-191**](./任务母表.md) · [**正文**](#tt-b191-traveltrust-page-04-13-1-close-001) |
...
| 274 | TT-B262-14-REGIONVAULT-CLAIM-BROADCAST-EXECUTION-001 | ops / 14 · RegionVault claim 广播 JSON-RPC 执行与报告落盘 | **已封口**（**2026-04-14** **；** **EXTEND** **2026-04-15** **：** **`--signing-order-static-table`****+** **`signing_order_static_table_validated`** **、** **`execute`**** **self-test** **stub** **隔离** **+** **子进程** **预检** **、** **B-282** **resume** **断言** **）** | **B-262**：**承** **B-256**；**`execute`** **`eth_sendRawTransaction`** **→** **`14-REGIONVAULT-CLAIM-BROADCAST-EXECUTION-REPORT-V1`**；互证 [**母表 B-262**](./任务母表.md) · [**正文**](#tt-b262-14-regionvault-claim-broadcast-execution-001) |
...
| 286 | TT-B276-BROADCAST-NONCE-PREFLIGHT-RPC-001 | ops · 广播 · B-262 前 nonce 与 RPC 单调预检 | **已封口**（**2026-04-15**） | **B-276**：**`preflight`**** **`-o`** **`14-REGIONVAULT-CLAIM-BROADCAST-NONCE-PREFLIGHT-REPORT-V1`** **；** **B-262** **`--require-preflight-ok`** **软** **强制** **（** **默认** **不** **传** **则** **不** **校验** **）** **。** **互证** [**母表 B-276**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) · **[`ops/RUNBOOK.md`](../ops/RUNBOOK.md)** |
| 287 | TT-B277-MULTISTEP-SIGNING-ORDER-CROSS-BATCH-001 | ops · 广播 · 多 batch 全局发送顺序表 | **已封口**（**2026-04-15**） | **B-277**：**`region_vault_claim_broadcast_signing_order_static.py`** **`emit`****/**`verify`****/**`self-test`** **；** **`execute`**** **`--signing-order-static-table`** **+** **`04`**** **§3.5** **`TT-B277`** **机读句** **。** **互证** [**母表 B-277**](./任务母表.md) · [**正文**](#tt-b277-multistep-signing-order-cross-batch-001) |
| 288 | TT-B278-PENDING-NONCE-GAP-DETECTOR-001 | ops · 广播 · pending nonce 空洞检测 | **已封口**（**2026-04-15**） | **B-278**：**只读** **mempool** **深度** **/** **空洞** **超阈** **可选** **阻断** **。** **互证** [**母表 B-278**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 289 | TT-B279-REPLACEMENT-AND-CANCELLED-TX-NONCE-001 | ops · 广播 · 替换/取消 tx 与证据对齐 | **已封口**（**2026-04-15**） | **B-279**：**Runbook+规则** **：** **同** **nonce** **替换** **后** **`tx_hash`** **与** **报告** **对齐** **。** **互证** [**母表 B-279**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 290 | TT-B280-MEMPOOL-ORDERING-DISCLOSURE-001 | ops · 广播 · mempool 顺序披露 | **已封口**（**2026-04-15**） | **B-280**：**B-266** **附属** **披露** **字段** **（** **默认** **不** **改** **`GO`** **判定** **）** **。** **互证** [**母表 B-280**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 291 | TT-B281-HOT-WALLET-NONCE-EXTERNAL-DRIFT-001 | ops · 广播 · 热钱包外部 nonce 漂移 | **已封口**（**2026-04-15**） | **B-281**：**多** **工具** **共用** **地址** **floor** **漂移** **检测** **。** **互证** [**母表 B-281**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 292 | TT-B282-IDEMPOTENT-RESUME-SKIP-MINED-STEPS-001 | ops · 广播 · 幂等续跑跳过已 mined | **已封口**（**2026-04-15**） | **B-282**：**`region_vault_claim_broadcast_pipeline_resume.py`** **`resume-execute`**** **`--signing-order-static-table`** **→** **`execute`**** **；** **`execute`**** **self-test** **断言** **`resume_from_prior_execution_report`** **（** **`eth_sendRawTransaction`** **skipped** **）** **。** **别名** **TT-B277-BROADCAST-PIPELINE-IDEMPOTENT-RESUME-AUTOMATION-001** **（** **非** **B-277** **母** **表** **TT** **）** **。** **互证** [**母表 B-282**](./任务母表.md) · [**正文**](#tt-b282-idempotent-resume-skip-mined-steps-001) · **[`ops/RUNBOOK.md`](../ops/RUNBOOK.md)** |
| 293 | TT-B283-B263-RECEIPT-FETCH-BACKOFF-001 | ops · B-263 · receipt 拉取退避 | **已封口**（**2026-04-15**） | **B-283**：**429/5xx/timeout** **分类** **退避** **，** **默认** **保守** **。** **互证** [**母表 B-283**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 294 | TT-B284-PARTIAL-RUN-OPERATOR-RUNBOOK-001 | ops · Runbook · 部分失败恢复 | **已封口**（**2026-04-15**） | **B-284**：**stub** **重签** **/** **nonce** **重算** **/** **`OUT_DIR`** **标准** **作业** **。** **互证** [**母表 B-284**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 295 | TT-B285-QUARANTINE-FAILED-STUB-SNAPSHOT-001 | ops · 证据 · 失败隔离包 | **已封口**（**2026-04-15**） | **B-285**：**quarantine** **包** **写入** **`operator_run_evidence`** **。** **互证** [**母表 B-285**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 296 | TT-B286-REPLAY-GUARD-STUB-CONTENT-HASH-001 | ops · 广播 · stub 内容哈希重放防护 | **已封口**（**2026-04-15**） | **B-286**：**可选** **sha256** **+** **env** **二次** **确认** **。** **互证** [**母表 B-286**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 297 | TT-B287-MANUAL-OVERRIDE-WITH-JUSTIFICATION-001 | ops · 广播 · override 审计理由 | **已封口**（**2026-04-15**） | **B-287**：**`--allow-non-go-*`** **须** **`OVERRIDE_REASON`** **落** **JSON** **。** **互证** [**母表 B-287**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 298 | TT-B288-MIN-CONFIRMATIONS-OPTIONAL-GATE-001 | ops · B-266 · 最小确认数闸 | **已封口**（**2026-04-15**） | **B-288**：**可选** **env** **块** **深** **不足** **不** **默认** **`GO`** **。** **互证** [**母表 B-288**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 299 | TT-B289-REORG-RECEIPT-INVALIDATION-NOTE-001 | ops · 广播 · reorg 披露与头校验 | **已封口**（**2026-04-15**） | **B-289**：**证据** **说明** **+** **可选** **`safe|finalized`** **脚本** **。** **互证** [**母表 B-289**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 300 | TT-B290-RPC-CHAIN-TIP-LAG-WATCH-001 | ops · 广播 · 链尖滞后 watch | **已封口**（**2026-04-15**） | **B-290**：**双** **RPC** **尖** **滞后** **可选** **阻断** **。** **互证** [**母表 B-290**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 301 | TT-B291-GAS-PREFLIGHT-AND-FEE-CAP-001 | ops · 广播 · gas 预检与费用帽 | **已封口**（**2026-04-15**） | **B-291**：**feeHistory** **估算** **+** **cap** **超阈** **exit** **。** **互证** [**母表 B-291**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 302 | TT-B292-TX-TYPE-MATRIX-ANVIL-VS-PUBLIC-001 | ops · 广播 · tx 类型矩阵 | **已封口**（**2026-04-15**） | **B-292**：**legacy** **/** **1559** **×** **chainId** **文档** **+** **小** **测** **。** **互证** [**母表 B-292**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 303 | TT-B293-FINALITY-MODE-ENV-001 | ops · 广播 · finality 模式 env | **已封口**（**2026-04-15**） | **B-293**：**`TRAVELTRUST_FINALITY_MODE`** **统一** **口径** **。** **互证** [**母表 B-293**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 304 | TT-B294-SCHEDULED-BROADCAST-SMOKE-CRON-001 | ops · CI/cron · 缩短烟测 | **已封口**（**2026-04-15**） | **B-294**：**定时** **B-262→B-266** **缩短** **链** **失败** **告警** **。** **互证** [**母表 B-294**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 305 | TT-B295-EVIDENCE-BUNDLE-TAR-AND-MANIFEST-001 | ops · 证据 · tar+manifest | **已封口**（**2026-04-15**） | **B-295**：**`OUT_DIR`** **打包** **与** **sha256** **清单** **。** **互证** [**母表 B-295**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 306 | TT-B296-OPERATOR-RUN-STRUCTURED-JSONL-001 | ops · 证据 · operator 结构化元数据 | **已封口**（**2026-04-15**） | **B-296**：**who/when/git_sha** **等** **扩展** **`operator_run_evidence`** **。** **互证** [**母表 B-296**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 307 | TT-B297-RPC-URL-REDACTION-REGRESSION-TEST-001 | ops · 安全 · RPC URL 脱敏回归 | **已封口**（**2026-04-15**） | **B-297**：**自动化** **断言** **日志** **无** **完整** **凭据** **。** **互证** [**母表 B-297**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 308 | TT-B298-EVIDENCE-RETENTION-AND-INDEX-001 | ops · 证据 · 保留期与 INDEX | **已封口**（**2026-04-15**） | **B-298**：**`evidence/…/INDEX.md`** **模板** **。** **互证** [**母表 B-298**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 309 | TT-B299-RUNBOOK-VERSION-PIN-001 | ops · Runbook · 版本钉 | **已封口**（**2026-04-15**） | **B-299**：**命令** **旁** **commit/tag** **。** **互证** [**母表 B-299**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 310 | TT-B300-MAINNET-SECOND-OPERATOR-ACK-001 | ops · 广播 · 主网第二 ack | **已封口**（**2026-04-15**） | **B-300**：**双** **人** **/** **工单** **号** **元数据** **。** **互证** [**母表 B-300**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 311 | TT-B301-STUB-INTEGRITY-SIGNING-OPTIONAL-001 | ops · 广播 · stub 可选验签 | **已封口**（**2026-04-15**） | **B-301**：**GPG/minisign** **可选** **门禁** **。** **互证** [**母表 B-301**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 312 | TT-B302-ETH-SEND-RAW-RATE-LIMIT-001 | ops · 广播 · sendRaw 限流 | **已封口**（**2026-04-15**） | **B-302**：**QPS**/**并发** **上限** **。** **互证** [**母表 B-302**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 313 | TT-B303-BREAK-GLASS-AND-ROLLBACK-ROLES-001 | ops · 合规 · break-glass 角色 | **已封口**（**2026-04-15**） | **B-303**：**override** **批准** **与** **24h** **补证** **。** **互证** [**母表 B-303**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 314 | TT-B304-RPC-KEY-ROTATION-RUNBOOK-001 | ops · RPC · key 轮换 Runbook | **已封口**（**2026-04-15**） | **B-304**：**零** **改** **业务** **配置** **切换** **步骤** **。** **互证** [**母表 B-304**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
| 315 | TT-B305-ALLOWLIST-RPC-HOST-PREFIX-001 | ops · 广播 · RPC host 白名单 | **已封口**（**2026-04-15**） | **B-305**：**`TRAVELTRUST_CHAIN_RPC_URL_ALLOWLIST`** **前缀** **匹配** **。** **互证** [**母表 B-305**](./任务母表.md) · [**正文**](#tt-b276-b305-live-ops-enhancement-pack-registry-001) |
...
| 318 | TT-B308-WAVE-EVIDENCE-GO-DIR-TEMPLATE-ALIGN-001 | doc · 07 §零 0.4.1 · GO 证据目录与 15 附录〇对齐 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-308**：**[`go_wave_evidence_dir_preflight.py`](../scripts/ops/go_wave_evidence_dir_preflight.py)** **`validate`****/** **`self-test`****/** **`init`** **；** **主索引** **一览** **315** **/** [**§TT-B308**](./AI任务卡索引.md#tt-b308-wave-evidence-go-dir-template-align-001) **。** **互证** [**母表 B-308**](./任务母表.md) · [**registry**](#tt-b306-b335-07-aligned-backlog-registry-001) |
| 319 | TT-B309-P15-APPENDIX-O-P0-ROW-MAP-001 | doc · 15 附录〇 · 与缺口官方总表 P0 映射 | **已封口**（**2026-04-15** · **纯** **文档** **） | **B-309**：**[`15-附录〇与缺口官方总表-P0行映射-B309.md`](../spec/code-maps/15-附录〇与缺口官方总表-P0行映射-B309.md)** **双** **向** **表** **+** **15** **/** **缺口** **官方** **总表** **互** **指** **；** **主索引** **一览** **314** **/** [**§TT-B309**](./AI任务卡索引.md#tt-b309-p15-appendix-o-p0-row-map-001) **。** **互证** [**母表 B-309**](./任务母表.md) · [**registry**](#tt-b306-b335-07-aligned-backlog-registry-001) |
| 320 | TT-B310-110-CHECKS-TOTAL-TRIPLE-DOC-SYNC-CHECKLIST-001 | doc · 110 + 07 · checks_total 三文档同批核对 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-310**：**[`indexer_reconcile_gate_checks_total_preflight.py`](../scripts/ops/indexer_reconcile_gate_checks_total_preflight.py)** **`verify`****/** **`self-test`** **；** **主索引** **一览** **316** **/** [**§TT-B310**](./AI任务卡索引.md#tt-b310-110-checks-total-triple-doc-sync-checklist-001) **。** **互证** [**母表 B-310**](./任务母表.md) · [**registry**](#tt-b306-b335-07-aligned-backlog-registry-001) |
| 321 | TT-B311-87-USERS-ROLE-PREFLIGHT-INVENTORY-001 | db · 87 §11 · users.role 迁移前只读盘点 | **已封口**（**2026-04-15**） | **B-311**：**[`scripts/sql/users_role_preflight_inventory.sql`](../scripts/sql/users_role_preflight_inventory.sql)** **+** **[`docs/runbook/users-role-preflight-inventory.md`](./runbook/users-role-preflight-inventory.md)** **；** **87** **§11.1.1** **表** **一行** **。** **互证** [**母表 B-311**](./任务母表.md) · [**正文**](#tt-b311-87-users-role-preflight-inventory-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 322 | TT-B312-88-FIVE-ROUTES-SHELL-UX-MATRIX-AUDIT-001 | frontend · 88 · 五主路由壳层 UX 与 86 矩阵差分 | **已封口**（**2026-04-15** · **只读** **审计**） | **B-312**：**[`docs/runbook/TT-B312-five-routes-shell-ux-matrix-audit.md`](./runbook/TT-B312-five-routes-shell-ux-matrix-audit.md)** **。** **互证** [**母表 B-312**](./任务母表.md) · [**正文**](#tt-b312-88-five-routes-shell-ux-matrix-audit-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 323 | TT-B313-70-ADMIN-RBAC-04-ROUTE-DELTA-TABLE-001 | admin · 70 · RBAC 与 04 admin 路由差分 + alert-rules 实现 | **已封口**（**2026-04-15** · **审计** **+** **`traveltrust-api`** **实现**） | **B-313**：**[`docs/runbook/TT-B313-70-admin-rbac-04-route-delta-table.md`](./runbook/TT-B313-70-admin-rbac-04-route-delta-table.md)** **+** **`GET …/observability/alert-rules`** **/** **`read_contract`** **路径** **登记** **。** **互证** [**母表 B-313**](./任务母表.md) · [**正文**](#tt-b313-70-admin-rbac-04-route-delta-table-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 324 | TT-B314-04-INTERNAL-REQUIRE-REFS-GATE-DOC-001 | api · 04 · internal 路由 REQUIRE_REFS 纪律 | **已封口**（**2026-04-15** · **docs-only**） | **B-314**：**[`docs/runbook/TT-B314-04-internal-require-refs-gate-doc.md`](./runbook/TT-B314-04-internal-require-refs-gate-doc.md)** **；** **04** **零、SSOT Gate** **补** internal 场景 **`REQUIRE_REFS=1`** 纪律。**互证** [**母表 B-314**](./任务母表.md) · [**正文**](#tt-b314-04-internal-require-refs-gate-doc-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 325 | TT-B315-53-ORDER-TERMINAL-VS-ESCROW-SSOT-001 | product · 53 · 订单终端态 vs Escrow SSOT | **已封口**（**2026-04-15** · **docs-only 审计**） | **B-315**：**[`docs/runbook/TT-B315-53-order-terminal-vs-escrow-ssot-audit.md`](./runbook/TT-B315-53-order-terminal-vs-escrow-ssot-audit.md)**；**53/04/14** 终端态对照登记，不改实现。**互证** [**母表 B-315**](./任务母表.md) · [**正文**](#tt-b315-53-order-terminal-vs-escrow-ssot-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 326 | TT-B316-14-ABI-FORGE-SYNC-ANTI-DRIFT-HINT-001 | contracts · 14 · ABI forge 同步防 drift | **已封口**（**2026-04-15** · **docs-only 审计**） | **B-316**：**[`docs/runbook/TT-B316-14-abi-forge-sync-anti-drift-hint.md`](./runbook/TT-B316-14-abi-forge-sync-anti-drift-hint.md)**；补“流程提示/可选 hook 文案”登记，不改实现。**互证** [**母表 B-316**](./任务母表.md) · [**正文**](#tt-b316-14-abi-forge-sync-anti-drift-hint-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 327 | TT-B317-83-84-COUNTRY-LEDGER-PROJECTION-GLOSSARY-001 | doc · 83/84 · country-ledger 与 110 投影 glossary | **已封口**（**2026-04-15** · **docs-only 审计**） | **B-317**：**[`docs/runbook/TT-B317-83-84-country-ledger-projection-glossary.md`](./runbook/TT-B317-83-84-country-ledger-projection-glossary.md)**；概念层 vs 投影层字段最小映射，不改实现。**互证** [**母表 B-317**](./任务母表.md) · [**正文**](#tt-b317-83-84-country-ledger-projection-glossary-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 328 | TT-B318-FEE-ROUTER-INTERNAL-EXPORT-FIELD-GLOSSARY-001 | doc · FeeRouter · internal 导出 JSON glossary | **已封口**（**2026-04-15** · **docs-only 审计**） | **B-318**：**[`docs/runbook/TT-B318-fee-router-internal-export-field-glossary.md`](./runbook/TT-B318-fee-router-internal-export-field-glossary.md)**；字段与 admin 边界 glossary 登记，不改实现。**互证** [**母表 B-318**](./任务母表.md) · [**正文**](#tt-b318-fee-router-internal-export-field-glossary-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 329 | TT-B319-FRONTEND-429-RETRY-04-ALIGNMENT-001 | frontend · 429 重试与 04 约定对齐 | **已封口**（**2026-04-15** · **docs-only 审计**） | **B-319**：**[`docs/runbook/TT-B319-frontend-429-retry-04-alignment-audit.md`](./runbook/TT-B319-frontend-429-retry-04-alignment-audit.md)**；退避/错误包说明登记，不改实现。**互证** [**母表 B-319**](./任务母表.md) · [**正文**](#tt-b319-frontend-429-retry-04-alignment-001) · [**批次收官**](./runbook/TT-B311-B319-batch-closeout-summary.md) |
| 330 | TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC-001 | doc · NEXT_PUBLIC 与 .env.example 机读 diff 规格 | **已封口**（**2026-04-15** · **docs-only** **审计**） | **B-320**：**[`docs/runbook/TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC.md`](./runbook/TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC.md)** **（** **`frontend/.env.example`** **↔** **`process.env`** **键** **集** **规则** **+** **缺口** **登记** **）** **。** **互证** [**母表 B-320**](./任务母表.md) · [**正文**](#tt-b320-next-public-env-diff-spec-001) |
| 331 | TT-B321-I18N-KEY-PARITY-LINT-SPEC-001 | frontend · i18n en/zh 对称 lint 规格 | **已封口**（**2026-04-15** · **docs-only** **审计**） | **B-321**：**[`docs/runbook/TT-B321-I18N-KEY-PARITY-LINT-SPEC.md`](./runbook/TT-B321-I18N-KEY-PARITY-LINT-SPEC.md)** **（** **`test:i18n:ci`** **/** **`check-i18n-coverage.mjs`** **规格** **台账** **）** **。** **互证** [**母表 B-321**](./任务母表.md) · [**正文**](#tt-b321-i18n-key-parity-lint-spec-001) |
| 332 | TT-B322-CI-TSC-VITEST-BUDGET-DOC-001 | ci · tsc/vitest/cargo 分轨耗时预算文档 | **已封口**（**2026-04-15** · **docs-only** **审计**） | **B-322**：**[`docs/runbook/TT-B322-CI-TSC-VITEST-BUDGET-DOC.md`](./runbook/TT-B322-CI-TSC-VITEST-BUDGET-DOC.md)** **（** **命令** **分轨** **真值** **+** **无** **分钟** **SLO** **缺口** **登记** **；** **勿** **混** **一览** **376** **`TT-B322-TESTNET-…`** **）** **。** **互证** [**母表 B-322**](./任务母表.md) · [**正文**](#tt-b322-ci-tsc-vitest-budget-doc-001) |
| 333 | TT-B323-API-CARGO-FEATURES-SURFACE-MAP-001 | api · Cargo features 暴露面地图 | **已封口**（**2026-04-15** · **docs-only** **审计**） | **B-323**：**[`docs/runbook/TT-B323-API-CARGO-FEATURES-SURFACE-MAP.md`](./runbook/TT-B323-API-CARGO-FEATURES-SURFACE-MAP.md)** **（** **全仓** **无** **`[features]`** **/** **映射** **空** **表** **+** **术语** **分界** **）** **。** **互证** [**母表 B-323**](./任务母表.md) · [**正文**](#tt-b323-api-cargo-features-surface-map-001) |
| 334 | TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER-001 | db · 迁移正向回滚策略 + RUNBOOK 指针 | **已封口**（**2026-04-15** · **docs-only** **审计**） | **B-324**：**[`docs/runbook/TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER.md`](./runbook/TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER.md)** **（** **04/RUNBOOK/41/55** **指针** **+** **缺口** **登记** **）** **。** **互证** [**母表 B-324**](./任务母表.md) · [**正文**](#tt-b324-db-migration-rollforward-runbook-pointer-001) |
| 335 | TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP-001 | doc · evidence manifest 与 15 签字项映射 | **已封口**（**2026-04-15** · **docs-only** **审计**） | **B-325**：**[`docs/runbook/TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP.md`](./runbook/TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP.md)** **（** **`manifest`** **字段** **↔** **附录〇** **/** **`sign_off`** **分界** **+** **缺口** **登记** **）** **。** **互证** [**母表 B-325**](./任务母表.md) · [**正文**](#tt-b325-evidence-manifest-p15-signoff-map-001) |
| 336 | TT-B326-INTERNAL-DRILL-GATE-WORKFLOW-PARAMS-TABLE-001 | ci · internal-drill-gate 参数与 artifact 表 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-326**：**[`internal_drill_gate_workflow_digest.py`](../scripts/ops/internal_drill_gate_workflow_digest.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **317** **/** [**§TT-B326**](./AI任务卡索引.md#tt-b326-internal-drill-gate-workflow-params-table-001) **。** **互证** [**母表 B-326**](./任务母表.md) · [**registry**](#tt-b306-b335-07-aligned-backlog-registry-001) |
| 337 | TT-B327-DEV-START-STOP-PORT-MATRIX-AUDIT-001 | doc · 起停脚本与文档端口矩阵审计 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-327**：**[`dev_stack_port_defaults_preflight.py`](../scripts/ops/dev_stack_port_defaults_preflight.py)** **`verify`****/** **`self-test`** **；** **主索引** **一览** **318** **/** [**§TT-B327**](./AI任务卡索引.md#tt-b327-dev-start-stop-port-matrix-audit-001) **。** **互证** [**母表 B-327**](./任务母表.md) · [**registry**](#tt-b306-b335-07-aligned-backlog-registry-001) |
...
| 340 | TT-B330-55-VS-INDEXER-SCOPE-SSOT-001 | doc · 55 数据同步 vs 110 indexer 职责分界 | **已封口**（**2026-04-15** · **docs-only**） | **B-330**：**[`docs/runbook/TT-B330-55-VS-110-INDEXER-SCOPE-SSOT.md`](./runbook/TT-B330-55-VS-110-INDEXER-SCOPE-SSOT.md)** **（** **55** **/** **110** **读前摘要** **+** **§〇** **/** **§一** **互证** **）** **。** **互证** [**母表 B-330**](./任务母表.md) · [**正文**](#tt-b330-55-vs-110-indexer-scope-ssot-001) |
...
| 345 | TT-B335-SOLO-MVP-VS-MOTHER-TABLE-OPEN-QUEUE-INDEX-001 | doc · Solo MVP 与母表未封口队列对照索引 | **未封口**（**登记**） | **B-335**：**选** **卡** **背板** **；** **须** **覆盖** **一览** **286～375** **（** **B-276～B-365** **三** **registry** **）** **；** **其中** **一览** **286～315**/**B-276～B-305** **已于** **2026-04-15** **整批** **封口** **（** **状态列** **+** **主索引** **一览** **279～308** **互证** **）** **；** **一览** **287**/**B-277** **、** **292**/**B-282** **单卡** **深** **叙事** **仍** **见** **[§TT-B277](#tt-b277-multistep-signing-order-cross-batch-001)** **/** **[§TT-B282](#tt-b282-idempotent-resume-skip-mined-steps-001)** **。** **互证** [**母表 B-335**](./任务母表.md) · [**正文**](#tt-b306-b335-07-aligned-backlog-registry-001) |
...
| 354 | TT-B344-FLAKY-TEST-QUARANTINE-CI-POLICY-001 | ci · flaky quarantine 策略 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-344**：**[`ci_continue_on_error_inventory.py`](../scripts/ops/ci_continue_on_error_inventory.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **319** **/** [**§TT-B344**](./AI任务卡索引.md#tt-b344-flaky-test-quarantine-ci-policy-001) **。** **互证** [**母表 B-344**](./任务母表.md) · [**registry**](#tt-b336-b365-platform-reliability-registry-001) |
| 355 | TT-B345-BRANCH-PROTECTION-REQUIRED-CHECKS-DOC-001 | repo · 分支保护与 required checks | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-345**：**[`broadcast_batch_blockers_workflow_digest.py`](../scripts/ops/broadcast_batch_blockers_workflow_digest.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **320** **/** [**§TT-B345**](./AI任务卡索引.md#tt-b345-branch-protection-required-checks-doc-001) **。** **互证** [**母表 B-345**](./任务母表.md) · [**registry**](#tt-b336-b365-platform-reliability-registry-001) |
...
| 365 | TT-B355-SECRETS-SCAN-PRECOMMIT-SPEC-001 | security · secret 扫描接入规格 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-355**：**[`secret_key_gate_workflow_digest.py`](../scripts/ops/secret_key_gate_workflow_digest.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **321** **/** [**§TT-B355**](./AI任务卡索引.md#tt-b355-secrets-scan-precommit-spec-001) **。** **互证** [**母表 B-355**](./任务母表.md) · [**registry**](#tt-b336-b365-platform-reliability-registry-001) |
...
| 367 | TT-B357-OPENAPI-OR-SSOT-EXPORT-SMOKE-COMMAND-001 | api · OpenAPI/SSOT 导出烟测登记 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-357**：**[`openapi_or_api_smoke_touchpoints_preflight.py`](../scripts/ops/openapi_or_api_smoke_touchpoints_preflight.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **322** **/** [**§TT-B357**](./AI任务卡索引.md#tt-b357-openapi-or-ssot-export-smoke-command-001) **。** **互证** [**母表 B-357**](./任务母表.md) · [**registry**](#tt-b336-b365-platform-reliability-registry-001) |
| 368 | TT-B358-HEALTH-READY-SLO-AND-PROBE-CONTRACT-001 | api · health/ready SLO 与探针 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-358**：**[`health_http_probe_scripts_touchpoints_preflight.py`](../scripts/ops/health_http_probe_scripts_touchpoints_preflight.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **323** **/** [**§TT-B358**](./AI任务卡索引.md#tt-b358-health-ready-slo-and-probe-contract-001) **。** **互证** [**母表 B-358**](./任务母表.md) · [**registry**](#tt-b336-b365-platform-reliability-registry-001) |
...
| 370 | TT-B360-FEATURE-FLAG-LIFECYCLE-CLEANUP-LIST-001 | platform · feature flag 生命周期 | **已封口**（**2026-04-15** · **`scripts/ops`** **机读子集**） | **B-360**：**[`feature_flag_gate_workflow_digest.py`](../scripts/ops/feature_flag_gate_workflow_digest.py)** **`dump`****/** **`verify`****/** **`self-test`** **；** **主索引** **一览** **324** **/** [**§TT-B360**](./AI任务卡索引.md#tt-b360-feature-flag-lifecycle-cleanup-list-001) **。** **互证** [**母表 B-360**](./任务母表.md) · [**registry**](#tt-b336-b365-platform-reliability-registry-001) |
...
| 373 | TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC-001 | ops · indexer RPC 降级桌面演练 | **已封口**（**2026-04-15** · **docs-only**） | **B-363**：**[`docs/runbook/TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC.md`](./runbook/TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC.md)** **（** **四** **场景** **+** **议程** **+** **不** **默认** **生产** **RPC** **压测** **）** **；** **110** **读前摘要** **互证** **。** **互证** [**母表 B-363**](./任务母表.md) · [**正文**](#tt-b363-indexer-rpc-degradation-tabletop-spec-001) |
...
| 377 | TT-B381-GOVERNANCE-POOL-DB-VS-CHAIN-BALANCE-DRIFT-OBS-001 | governance · pool 表 vs FeeRouter 链上余额 | **已封口**（**2026-04-15**） | **B-381**：键 **`governance_pool_db_vs_chain_balance_drift_observability`**（锚 **`381-GOVERNANCE-POOL-DB-VS-CHAIN-BALANCE-DRIFT-OBS-V1`**）；**`POST …/internal/indexer-reconcile`** **`include_governance_pool_db_vs_chain_balance_drift_observability:true`** **+** **`GET …/admin/observability/overview`** **回读** **`persist` `summary`** **同键**；**不**改 **`GET …/governance/pool`**；**不**入 **`compound_gate`**。**互证** [**母表 B-381**](./任务母表.md)。 |
| 378 | TT-B382-GOVERNANCE-POOL-DRIFT-REAL-LINK-VERIFY-001 | ops · B-381 真实链路对拍验证 | **已封口**（**2026-04-15** · **本地** **smoke** **exit** **0** · **`marker=incomparable`** **最小** **链** **ENV** **）** | **B-382**：**[`TT-B382-GOVERNANCE-POOL-DRIFT-REAL-LINK-VERIFY-001.md`](./runbook/TT-B382-GOVERNANCE-POOL-DRIFT-REAL-LINK-VERIFY-001.md)** **+** **`scripts/ops/b381-governance-pool-drift-reconcile-admin-overview-smoke.sh`** **；** **reconcile** **与** **admin overview** **同键** **JSON** **深相等**。**互证** [**母表 B-382**](./任务母表.md)。 |
| 379 | TT-B383-FEE-ROUTER-PLATFORM-FEE-ROUTED-LOG-COUNT-CHAIN-VS-DB-OBS-001 | indexer · FeeRouter PlatformFeeRouted 链上日志数 vs DB | **已封口**（**2026-04-15** · **实现** **+** **测试** **+** **§3** **smoke** **exit** **0**） | **B-383**：**[`TT-B383-FEE-ROUTER-PLATFORM-FEE-ROUTED-LOG-COUNT-CHAIN-VS-DB-VERIFY-001.md`](./runbook/TT-B383-FEE-ROUTER-PLATFORM-FEE-ROUTED-LOG-COUNT-CHAIN-VS-DB-VERIFY-001.md)** **+** **`scripts/ops/b383-fee-router-platform-fee-routed-log-count-reconcile-admin-overview-smoke.sh`** **；** **锚** **`383-FEE-ROUTER-PLATFORM-FEE-ROUTED-LOG-COUNT-CHAIN-VS-DB-OBS-V1`** **。** **互证** [**母表 B-383**](./任务母表.md) **、** **04** **§** **表** **。 |
| 380 | TT-B384-REGION-VAULT-FORWARDED-LOG-COUNT-CHAIN-VS-DB-OBS-001 | indexer · RegionVaultForwarded 链上日志数 vs DB | **已封口**（**2026-04-15** · **实现** **+** **`cargo test`** **853** **passed** **+** **`run-check-04-routes`** **；** **§3** **smoke** **见** **Runbook** **）** | **B-384**：**[`TT-B384-REGION-VAULT-FORWARDED-LOG-COUNT-CHAIN-VS-DB-VERIFY-001.md`](./runbook/TT-B384-REGION-VAULT-FORWARDED-LOG-COUNT-CHAIN-VS-DB-VERIFY-001.md)** **+** **`scripts/ops/b384-region-vault-forwarded-log-count-reconcile-admin-overview-smoke.sh`** **；** **锚** **`384-REGION-VAULT-FORWARDED-LOG-COUNT-CHAIN-VS-DB-OBS-V1`** **。** **互证** [**母表 B-384**](./任务母表.md) **、** **04** **§** **表** **。 |
| 381 | TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-001 | indexer · revenue pipeline spread 双 slack 三角化 | **已封口**（**2026-04-15** **·** **§5.1** **目标环境** **smoke** **`exit 0`** **）** | **B-398**：**[`TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-001.md`](./runbook/TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-001.md)** **+** **Scope lock** **；** **键** **`revenue_pipeline_spread_dual_slack_triangulation_observability`** **/** **`triangulation_signal`** **。** **互证** [**母表 B-398**](./任务母表.md) **。** |
| 382 | TT-B399-REVENUE-PIPELINE-SPREAD-DUAL-AXIS-DOMINANCE-CONCORDANCE-OBS-001 | indexer · revenue pipeline spread 双轴 dominance 一致性 | **已封口**（**2026-04-15** **·** **§5.1** **目标环境** **smoke** **`exit 0`** **）** | **B-399**：**[`TT-B399-REVENUE-PIPELINE-SPREAD-DUAL-AXIS-DOMINANCE-CONCORDANCE-OBS-001.md`](./runbook/TT-B399-REVENUE-PIPELINE-SPREAD-DUAL-AXIS-DOMINANCE-CONCORDANCE-OBS-001.md)** **+** **Scope lock** **；** **键** **`revenue_pipeline_spread_dual_axis_dominance_concordance_observability`** **/** **`concordance_signal`** **。** **互证** [**母表 B-399**](./任务母表.md) **。** |
| 383 | TT-B409-ORDER-STATE-MACHINE-CHAIN-OFF-53-001 | orders · chain_off · 状态机 SSOT（53 / API / 前端） | **已封口**（**2026-04-15** **·** **实现** **+** **Runbook** **§8** **留痕** **）** | **B-409**：**[`TT-B409-ORDER-STATE-MACHINE-CHAIN-OFF-53-001.md`](./runbook/TT-B409-ORDER-STATE-MACHINE-CHAIN-OFF-53-001.md)** **§8** **。** **`ChainOffConfig.order_mock_pay_enabled`** **、** **`routes/orders/mutations`** **`order_mock_pay`** **、** **测试** **`tt_b409_chain_off_http_order_created_accepted_escrowed`** **。** **互证** [**母表 B-409**](./任务母表.md) **·** [**正文**](#tt-b409-order-state-machine-chain-off-53-001) |
| 384 | TT-B412-REVENUE-DATA-DISCOVERABILITY-OPS-001 | admin · revenue · 只读路径「数据可查」 | **已封口**（**2026-04-15** **·** **Runbook** **+** **`b412`** **脚本** **+** **`ops/RUNBOOK.md`** **§2.55** **）** | **B-412**：**[`TT-B412-REVENUE-DATA-DISCOVERABILITY-OPS-001.md`](./runbook/TT-B412-REVENUE-DATA-DISCOVERABILITY-OPS-001.md)** **§4～6** **；** **`scripts/ops/b412-order-to-revenue-discoverability-smoke.sh`** **（** **订单** **→** **B-402** **）** **。** **硬边界** **：** **不** **新增** **观测** **键** **。** **互证** [**母表 B-412**](./任务母表.md) **·** [**正文**](#tt-b412-revenue-data-discoverability-ops-001) |
| 385 | TT-B417-GOVERNANCE-EXECUTION-AUTOMATION-L3-001 | governance · B-416 L3 Governor/Timelock 执行自动化 | **已封口**（**2026-04-16**） | **B-417**：**[`TT-B417-GOVERNANCE-EXECUTION-AUTOMATION-L3-001.md`](./runbook/TT-B417-GOVERNANCE-EXECUTION-AUTOMATION-L3-001.md)** **；** **[`b417-run-onchain-evidence.sh`](../scripts/ops/b417-run-onchain-evidence.sh)** **+** **`B417_ALLOW_QUEUED_PREFLIGHT`** **；** **[`evidence/b417_governance_execution_runs/README.md`](../evidence/b417_governance_execution_runs/README.md)** **。** **互证** [**母表 B-417**](./任务母表.md) **/** [**主索引** **385**](./AI任务卡索引.md) **。** |
| 386 | TT-B418-GO-RELEASE-EVIDENCE-MANIFEST-001 | release · GO 闭环 B-418 发版证据 manifest/hash | **已封口**（**2026-04-16**） | **B-418**：**[`TT-B418-GO-RELEASE-EVIDENCE-MANIFEST-001.md`](./runbook/TT-B418-GO-RELEASE-EVIDENCE-MANIFEST-001.md)** **§1** **；** **基线** **`evidence/GO_20260409`** **；** **IMP-EV-001** **。** **互证** [**母表 B-418**](./任务母表.md) **·** [**主索引** §TT-B418](./AI任务卡索引.md#tt-b418-go-release-evidence-manifest-001) **。** |
| 387 | TT-B419-GO-SSOT-PR-TRIANGLE-CI-001 | release · GO 闭环 B-419 SSOT 三角 CI | **已封口**（**2026-04-16**） | **B-419**：**[`TT-B419-GO-SSOT-PR-TRIANGLE-CI-001.md`](./runbook/TT-B419-GO-SSOT-PR-TRIANGLE-CI-001.md)** **§1** **；** **`scripts/check-ssot-triangle-gate.sh`** **。** **互证** [**母表 B-419**](./任务母表.md) **·** [**主索引** §TT-B419](./AI任务卡索引.md#tt-b419-go-ssot-pr-triangle-ci-001) **。** |
| 388 | TT-B420-GO-W-GATE-PRERELEASE-001 | release · GO 闭环 B-420 W-GATE 发版前一键 | **已封口**（**2026-04-16**） | **B-420**：**[`TT-B420-GO-W-GATE-PRERELEASE-001.md`](./runbook/TT-B420-GO-W-GATE-PRERELEASE-001.md)** **§1** **；** **`scripts/check-w-gate-prerelease.sh`** **。** **互证** [**母表 B-420**](./任务母表.md) **·** [**主索引** §TT-B420](./AI任务卡索引.md#tt-b420-go-w-gate-prerelease-001) **。** |
| 389 | TT-B421-GO-RUNBOOK-GOLIVE-DOCLINK-001 | release · GO 闭环 B-421 Runbook/Go-Live 互指 | **已封口**（**2026-04-16**） | **B-421**：**`bash scripts/check-runbook-golive-doclink-gate.sh`** **/** **`--json`** **；** **[`docs/runbook/TT-B421-GO-RUNBOOK-GOLIVE-DOCLINK-001.md`](./runbook/TT-B421-GO-RUNBOOK-GOLIVE-DOCLINK-001.md)** **§1** **。** **互证** [**母表 B-421**](./任务母表.md) · [**主索引** **346**](./AI任务卡索引.md) · **[`TT-GO-CLOSELOOP-10-B418-B427-001` §B-421](./runbook/TT-GO-CLOSELOOP-10-B418-B427-001.md#b-421--tt-b421-go-runbook-golive-doclink-001)** **。** |
| 390 | TT-B422-GO-DATA-RECONCILE-PROJECTION-GOV-001 | orders · GO 闭环 B-422 投影 reconcile + 治理对拍 | **已封口**（**2026-04-16**） | **B-422**：**[`TT-B422-GO-DATA-RECONCILE-PROJECTION-GOV-001.md`](./runbook/TT-B422-GO-DATA-RECONCILE-PROJECTION-GOV-001.md)** **§1** **；** **`scripts/check-data-reconcile-projection-gov-gate.sh`** **。** **互证** [**母表 B-422**](./任务母表.md) **·** [**主索引** §TT-B422](./AI任务卡索引.md#tt-b422-go-data-reconcile-projection-gov-001) **。** |
| 391 | TT-B423-GO-DATA-8384-SNAPSHOT-COUNTRY-SMOKE-001 | indexer · GO 闭环 B-423 83/84 链↔DB smoke | **已封口**（**2026-04-16**） | **B-423**：**[`TT-B423-GO-DATA-8384-SNAPSHOT-COUNTRY-SMOKE-001.md`](./runbook/TT-B423-GO-DATA-8384-SNAPSHOT-COUNTRY-SMOKE-001.md)** **§1** **；** **`scripts/check-8384-snapshot-country-smoke-gate.sh`** **。** **互证** [**母表 B-423**](./任务母表.md) **·** [**主索引** §TT-B423](./AI任务卡索引.md#tt-b423-go-data-8384-snapshot-country-smoke-001) **。** |
| 392 | TT-B424-GO-OBS-META-OVERVIEW-DEEPEQ-001 | admin · GO 闭环 B-424 meta↔overview 深相等 | **已封口**（**2026-04-16**） | **B-424**：**[`TT-B424-GO-OBS-META-OVERVIEW-DEEPEQ-001.md`](./runbook/TT-B424-GO-OBS-META-OVERVIEW-DEEPEQ-001.md)** **§1** **；** **`scripts/check-meta-overview-deepeq-gate.sh`** **。** **互证** [**母表 B-424**](./任务母表.md) **·** [**主索引** §TT-B424](./AI任务卡索引.md#tt-b424-go-obs-meta-overview-deepeq-001) **。** |
| 393 | TT-B425-GO-OBS-INDEXER-LAG-LOCATE-001 | ops · GO 闭环 B-425 indexer lag 可定位 | **已封口**（**2026-04-16**） | **B-425**：**[`TT-B425-GO-OBS-INDEXER-LAG-LOCATE-001.md`](./runbook/TT-B425-GO-OBS-INDEXER-LAG-LOCATE-001.md)** **§1** **；** **`scripts/check-indexer-lag-locate-gate.sh`** **。** **互证** [**母表 B-425**](./任务母表.md) **·** [**主索引** §TT-B425](./AI任务卡索引.md#tt-b425-go-obs-indexer-lag-locate-001) **。** |
| 394 | TT-B426-GO-OBS-REVENUE-SUSPECT-RUNBOOK-001 | revenue · GO 闭环 B-426 pipeline suspect 值班 | **已封口**（**2026-04-16**） | **B-426**：**[`TT-B426-GO-OBS-REVENUE-SUSPECT-RUNBOOK-001.md`](./runbook/TT-B426-GO-OBS-REVENUE-SUSPECT-RUNBOOK-001.md)** **§1** **；** **`scripts/check-revenue-suspect-runbook-gate.sh`** **。** **互证** [**母表 B-426**](./任务母表.md) **·** [**主索引** §TT-B426](./AI任务卡索引.md#tt-b426-go-obs-revenue-suspect-runbook-001) **。** |
| 395 | TT-B427-GO-BIZ-ORDER-E2E-01353-001 | orders · GO 闭环 B-427 订单 E2E 01/03/53 | **已封口**（**2026-04-16**） | **B-427**：**`bash scripts/check-order-e2e-01353-gate.sh`** **/** **`--json`** **；** **[`docs/runbook/TT-B427-GO-BIZ-ORDER-E2E-01353-001.md`](./runbook/TT-B427-GO-BIZ-ORDER-E2E-01353-001.md)** **§1** **。** **互证** [**母表 B-427**](./任务母表.md) · [**主索引** **345**](./AI任务卡索引.md) · **[`TT-GO-CLOSELOOP-10-B418-B427-001` §B-427](./runbook/TT-GO-CLOSELOOP-10-B418-B427-001.md#b-427--tt-b427-go-biz-order-e2e-01353-001)** **。** |
| 396 | TT-TOURIST-JOURNEY-PROGRAM-001 | product · 旅行者主旅程 **P01→P07** 执行程序总表 | **未封口**（**登记** **2026-04-17**） | **B-436**：**[`TT-TOURIST-JOURNEY-PROGRAM-001.md`](./runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **；** **与** **B-410** **关系** **见** **文首** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 397 | TT-TOURIST-ORDER-ESCROW-JOURNEY-001 | product · 旅行者主旅程母卡（下单→支付→托管完成） | **未封口**（**登记** **2026-04-17**） | **B-436**：**[`TT-TOURIST-ORDER-ESCROW-JOURNEY-001.md`](./runbook/TT-TOURIST-ORDER-ESCROW-JOURNEY-001.md)** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 398 | TT-TOURIST-JOURNEY-P01-AUTH-MARKET-001 | product · 旅行者 **P01** 登录+市场 | **未封口**（**登记**） | **B-438** **专卡** **（** **依赖** **B-436** **总程序** **）** **：** **[`TT-TOURIST-JOURNEY-P01-AUTH-MARKET-001.md`](./runbook/TT-TOURIST-JOURNEY-P01-AUTH-MARKET-001.md)** **；** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **1** **步** **。** **互证** [**母表 B-438**](./任务母表.md) **/** [**B-436**](./任务母表.md) |
| 399 | TT-TOURIST-JOURNEY-P02-CREATE-ORDER-LIST-001 | product · 旅行者 **P02** 建单+列表 | **未封口**（**登记**） | **B-436** **·** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **2** **步** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 400 | TT-TOURIST-JOURNEY-P03-GUIDE-ACCEPT-001 | product · 旅行者 **P03** 向导接单 | **未封口**（**登记**） | **B-436** **·** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **3** **步** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 401 | TT-TOURIST-JOURNEY-P04-BILATERAL-001 | product · 旅行者 **P04** 双边确认 | **未封口**（**登记**） | **B-436** **·** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **4** **步** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 402 | TT-TOURIST-JOURNEY-P05-CONFIRM-FINAL-ESCROW-001 | product · 旅行者 **P05** 终版+进托管 | **未封口**（**登记**） | **B-436** **·** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **5** **步** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 403 | TT-TOURIST-JOURNEY-P06-PAY-DEPOSIT-001 | product · 旅行者 **P06** 支付+入金 | **未封口**（**登记**） | **B-436** **·** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **6** **步** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 404 | TT-TOURIST-JOURNEY-P07-COMPLETE-RATING-001 | product · 旅行者 **P07** 完成+评价 | **未封口**（**登记**） | **B-436** **·** **[PROGRAM](runbook/TT-TOURIST-JOURNEY-PROGRAM-001.md)** **第** **7** **步** **。** **互证** [**母表 B-436**](./任务母表.md) |
| 405 | TT-SPEC-89-GOV-UI-VOTING-B434-ALIGN-001 | spec/89 · 治理投票面板与 B-434 v3 / Governor 对齐 | **未封口**（**登记** **2026-04-17**） | **B-437**：**[`TT-SPEC-89-GOV-UI-VOTING-B434-ALIGN-001.md`](./runbook/TT-SPEC-89-GOV-UI-VOTING-B434-ALIGN-001.md)** **；** **规格** **[`89-治理UI-全球旅游市场治理控制台设计规格.md`](./spec/89-治理UI-全球旅游市场治理控制台设计规格.md)** **v2.0.9** **§5.3** **。** **互证** [**母表 B-437**](./任务母表.md) |
| 406 | TT-P07-CONFIRM-COMPLETION-NOT-ESCROWED-E2E-001 | orders · P07 **`confirm-completion`** 非法态（未 Escrowed）机读 E2E | **已封口**（**2026-04-17** **机读**） | **B-439**：**[`TT-P07-CONFIRM-COMPLETION-NOT-ESCROWED-E2E-001.md`](./runbook/TT-P07-CONFIRM-COMPLETION-NOT-ESCROWED-E2E-001.md)** **§1** **；** **`cargo test -p traveltrust-api post_confirm_completion_when_not_escrowed`** **。** **互证** [**母表 B-439**](./任务母表.md) **/** [**P07 Runbook**](./runbook/TT-TOURIST-JOURNEY-P07-COMPLETE-RATING-001.md) **验收** **勾选** **。** |
| 407 | TT-P07-DUPLICATE-CONFIRM-COMPLETION-E2E-001 | orders · P07 重复 **`confirm-completion`**（Completed）机读 E2E | **已封口**（**2026-04-17** **机读**） | **B-440**：**[`TT-P07-DUPLICATE-CONFIRM-COMPLETION-E2E-001.md`](./runbook/TT-P07-DUPLICATE-CONFIRM-COMPLETION-E2E-001.md)** **§1** **；** **`cargo test -p traveltrust-api post_confirm_completion_twice_second_returns_409`** **。** **互证** [**母表 B-440**](./任务母表.md) **/** [**P07 Runbook**](./runbook/TT-TOURIST-JOURNEY-P07-COMPLETE-RATING-001.md) **。** |
| 408 | TT-P07-DUPLICATE-REVIEW-SUBMIT-E2E-001 | orders · P07 重复 **`POST …/reviews`**（`already_reviewed`）机读 E2E | **已封口**（**2026-04-17** **机读**） | **B-441**：**[`TT-P07-DUPLICATE-REVIEW-SUBMIT-E2E-001.md`](./runbook/TT-P07-DUPLICATE-REVIEW-SUBMIT-E2E-001.md)** **§1** **；** **`cargo test -p traveltrust-api post_reviews_twice_second_returns_409`** **。** **互证** [**母表 B-441**](./任务母表.md) **/** [**P07 Runbook**](./runbook/TT-TOURIST-JOURNEY-P07-COMPLETE-RATING-001.md) **。** |
| 409 | TT-P07-CONCURRENT-REVIEW-SUBMIT-E2E-001 | orders · P07 并发 **`POST …/reviews`**（同用户 · `already_reviewed`）机读 E2E | **已封口**（**2026-04-17** **机读**） | **B-442**：**[`TT-P07-CONCURRENT-REVIEW-SUBMIT-E2E-001.md`](./runbook/TT-P07-CONCURRENT-REVIEW-SUBMIT-E2E-001.md)** **§1** **；** **`cargo test -p traveltrust-api post_reviews_concurrent_same_user`** **。** **互证** [**母表 B-442**](./任务母表.md) **/** [**P07 Runbook**](./runbook/TT-TOURIST-JOURNEY-P07-COMPLETE-RATING-001.md) **。** |
| 410 | TT-P07-DB-INSERT-REVIEW-ON-CONFLICT-CONCURRENT-001 | orders · P07 持久层 **`insert_review`** **`ON CONFLICT`** 并发机读（`DATABASE_URL`） | **已封口**（**2026-04-17** **机读**） | **B-443**：**[`TT-P07-DB-INSERT-REVIEW-ON-CONFLICT-CONCURRENT-001.md`](./runbook/TT-P07-DB-INSERT-REVIEW-ON-CONFLICT-CONCURRENT-001.md)** **§1** **；** **`DATABASE_URL=… cargo test -p traveltrust-api insert_review_concurrent_same_order_reviewer_one_true_one_false_on_conflict`** **。** **互证** [**母表 B-443**](./任务母表.md) **/** [**P07 Runbook**](./runbook/TT-TOURIST-JOURNEY-P07-COMPLETE-RATING-001.md) **。** |
| 411 | TT-P07-REVIEW-SUBMIT-DB-POOL-IDEMPOTENT-HTTP-001 | orders · P07 **`db_pool`** **`POST …/reviews`** 幂等 **200**（`persisted_review_inputs_not_replayed`）机读 | **已封口**（**2026-04-17** **机读**） | **B-444**：**[`TT-P07-REVIEW-SUBMIT-DB-POOL-IDEMPOTENT-HTTP-001.md`](./runbook/TT-P07-REVIEW-SUBMIT-DB-POOL-IDEMPOTENT-HTTP-001.md)** **§1** **；** **`cargo test -p traveltrust-api post_reviews_db_pool_insert_conflict`** **。** **互证** [**母表 B-444**](./任务母表.md) **。** |
| 412 | TT-B445-HYDRATE-AND-DEV-STACK-PORTS-001 | api · **`hydrate`** 用户/会话 + Unix/Win 全栈 **PORT** 契约 | **已封口**（**2026-04-17** **机读**） | **B-445**：**[`TT-B445-HYDRATE-AND-DEV-STACK-PORTS-001.md`](./runbook/TT-B445-HYDRATE-AND-DEV-STACK-PORTS-001.md)** **§1** **；** **`cargo test -p traveltrust-api hydrate_from_db_roundtrips`** **/** **`bash scripts/dev/check-b445-dev-stack-ports-contract.sh`** **。** **互证** [**母表 B-445**](./任务母表.md) **。** |
| 413 | TT-B446-SESSION-TOKENS-DB-POOL-HYDRATE-LOGIN-001 | auth · **`db_pool`** **`hydrate`** 后旧 **`tts_*`** **仍** **`get_me`** **+** **`auth_login`** **换发** **新** **token** **且** **旧** **session** **行** **默认** **仍** **有效** | **已封口**（**2026-04-17** **机读**） | **B-446**：**[`TT-B446-SESSION-TOKENS-DB-POOL-HYDRATE-LOGIN-001.md`](./runbook/TT-B446-SESSION-TOKENS-DB-POOL-HYDRATE-LOGIN-001.md)** **§1** **；** **`cargo test -p traveltrust-api b446_`** **。** **互证** [**母表 B-446**](./任务母表.md) **·** [**主索引** **一览** **361**](./AI任务卡索引.md) **。** |
| 414 | TT-B447-REVIEW-WEIGHT-BREAKDOWN-DB-POOL-MEMORY-PARITY-001 | orders · P07 **`POST …/reviews`** **weight** **+** **`weight_breakdown`** **`db_pool`** **成功插入** **vs** **无** **`db_pool`** **内存** **路径** **数值** **一致** | **已封口**（**2026-04-17** **机读**） | **B-447**：**[`TT-B447-REVIEW-WEIGHT-BREAKDOWN-DB-POOL-MEMORY-PARITY-001.md`](./runbook/TT-B447-REVIEW-WEIGHT-BREAKDOWN-DB-POOL-MEMORY-PARITY-001.md)** **§1** **；** **`cargo test -p traveltrust-api b447_`** **。** **互证** [**母表 B-447**](./任务母表.md) **·** [**主索引** **一览** **362**](./AI任务卡索引.md) **。** |
| 415 | TT-B448-REVIEW-WEIGHT-BOUNDARY-JSON-CONTRACT-001 | orders · P07 **`review_weight_v1`** **极值** **/** **账龄临界** **`weight`** **与** **`weight_breakdown`** **数值** **+** **`json_weight_breakdown`** **JSON** **契约** | **已封口**（**2026-04-17** **机读**） | **B-448**：**[`TT-B448-REVIEW-WEIGHT-BOUNDARY-JSON-CONTRACT-001.md`](./runbook/TT-B448-REVIEW-WEIGHT-BOUNDARY-JSON-CONTRACT-001.md)** **§1** **；** **`cargo test -p traveltrust-api b448_`** **。** **互证** [**母表 B-448**](./任务母表.md) **·** [**主索引** **一览** **363**](./AI任务卡索引.md) **·** [**B-449**](./runbook/TT-B449-REVIEW-JSON-CONTRACT-VERSION-STABILITY-COMPAT-001.md) **。** |
| 416 | TT-B449-REVIEW-JSON-CONTRACT-VERSION-STABILITY-COMPAT-001 | orders · P07 **`POST …/reviews`** **`weight`/`weight_breakdown`/`weight_breakdown_note`** **键** **与** **`null`** **/** **缺省** **JSON** **合约** | **已封口**（**2026-04-17** **机读**） | **B-449**：**[`TT-B449-REVIEW-JSON-CONTRACT-VERSION-STABILITY-COMPAT-001.md`](./runbook/TT-B449-REVIEW-JSON-CONTRACT-VERSION-STABILITY-COMPAT-001.md)** **§2** **；** **`cargo test -p traveltrust-api b449_`** **。** **互证** [**母表 B-449**](./任务母表.md) **·** [**主索引** **一览** **364**](./AI任务卡索引.md) **·** [**B-450**](./runbook/TT-B450-REVIEW-POST-JSON-SSOT-DOC-OPENAPI-ALIGN-001.md) **。** |
| 417 | TT-B450-REVIEW-POST-JSON-SSOT-DOC-OPENAPI-ALIGN-001 | orders · P07 **`POST …/reviews`** **`weight*`** **语义** **回写** **04/14/示例/前端** **+** **`check-b450-*`** **锚** | **已封口**（**2026-04-17** **文档** **+** **门禁** **）** | **B-450**：**[`TT-B450-REVIEW-POST-JSON-SSOT-DOC-OPENAPI-ALIGN-001.md`](./runbook/TT-B450-REVIEW-POST-JSON-SSOT-DOC-OPENAPI-ALIGN-001.md)** **§1** **；** **`cargo test -p traveltrust-api b449_`** **+** **`python scripts/gates/check-b450-review-post-ssot-doc-anchors.py`** **+** **`bash scripts/run-check-04-routes.sh`** **。** **互证** [**母表 B-450**](./任务母表.md) **·** [**主索引** **一览** **365**](./AI任务卡索引.md) **·** [**B-449**](./runbook/TT-B449-REVIEW-JSON-CONTRACT-VERSION-STABILITY-COMPAT-001.md) **·** [**B-451**](./runbook/TT-B451-REVIEW-JSON-CONTRACT-EVOLUTION-SCHEMA-GATE-001.md) **。** |
| 418 | TT-B451-REVIEW-JSON-CONTRACT-EVOLUTION-SCHEMA-GATE-001 | orders · P07 **`meta.review_json_contract`** **`schema_version`/`anchor`** **+** **`b451_*`** **/** **`check-b451-*`** | **已封口**（**2026-04-17** **机读** **+** **门禁** **）** | **B-451**：**[`TT-B451-REVIEW-JSON-CONTRACT-EVOLUTION-SCHEMA-GATE-001.md`](./runbook/TT-B451-REVIEW-JSON-CONTRACT-EVOLUTION-SCHEMA-GATE-001.md)** **§1** **；** **`cargo test -p traveltrust-api b451_`** **+** **`python scripts/gates/check-b451-review-json-contract-evolution-gate.py`** **+** **`bash scripts/run-check-04-routes.sh`** **。** **互证** [**母表 B-451**](./任务母表.md) **·** [**主索引** **一览** **366**](./AI任务卡索引.md) **·** [**B-450**](./runbook/TT-B450-REVIEW-POST-JSON-SSOT-DOC-OPENAPI-ALIGN-001.md) **。** |
| 419 | TT-B452-REVIEW-JSON-CONTRACT-CLIENT-PARSE-DEGRADE-001 | orders · P07 **`parseReviewJsonContractMeta`** **`→`** **`reviewJsonContractClient`** **`degrade`** **+** **`check-b452-*`** **Vitest** | **已封口**（**2026-04-17** **机读** **+** **门禁** **）** | **B-452**：**[`TT-B452-REVIEW-JSON-CONTRACT-CLIENT-PARSE-DEGRADE-001.md`](./runbook/TT-B452-REVIEW-JSON-CONTRACT-CLIENT-PARSE-DEGRADE-001.md)** **§1** **；** **`npm run test:b452`** **+** **`python scripts/gates/check-b452-review-json-contract-client-gate.py`** **+** **`bash scripts/run-check-04-routes.sh`** **。** **互证** [**母表 B-452**](./任务母表.md) **·** [**主索引** **一览** **367**](./AI任务卡索引.md) **·** [**B-451**](./runbook/TT-B451-REVIEW-JSON-CONTRACT-EVOLUTION-SCHEMA-GATE-001.md) **。** |
| 420 | TT-B486-93-R003-STAGING-BATCH-001 | regression · **93** · staging | **未封口**（**登记** **2026-04-18** · **`scripts/dev/.env.r003.local`** **已** **落** **显式** **占位** **；** **待** **真** **`R003_API_BASE`** **`/` `R003_A_PASSWORD`** **+** **证据链** **`validate`** **+** **铁律①** **后** **改** **本格** **为** **已封口** **）** | **B-486** **`93-R003-STAGING`** **：** **R-003** **首轮** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b486-93-r003-staging-batch-001)** **互证** [**母表 B-486**](./任务母表.md) **·** [**93-matrix-batch-tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 421 | TT-B487-93-A-REST-BATCH-001 | regression · **93** · auth | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-487** **`93-A-REST`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b487-93-a-rest-batch-001)** **互证** [**母表 B-487**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 422 | TT-B488-93-B-MKT-GDE-BATCH-001 | regression · **93** · market | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-488** **`93-B-MKT-GDE`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b488-93-b-mkt-gde-batch-001)** **互证** [**母表 B-488**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 423 | TT-B489-93-B-ORD-FLOW-BATCH-001 | regression · **93** · orders | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-489** **`93-B-ORD-FLOW`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b489-93-b-ord-flow-batch-001)** **互证** [**母表 B-489**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 424 | TT-B490-93-B-ESC-DSP-BATCH-001 | regression · **93** · escrow | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-490** **`93-B-ESC-DSP`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b490-93-b-esc-dsp-batch-001)** **互证** [**母表 B-490**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 425 | TT-B491-93-B-MSG-NEG-BATCH-001 | regression · **93** · messages | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-491** **`93-B-MSG-NEG`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b491-93-b-msg-neg-batch-001)** **互证** [**母表 B-491**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 426 | TT-B492-93-C-GOV-STK-BATCH-001 | regression · **93** · governance | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-492** **`93-C-GOV-STK`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b492-93-c-gov-stk-batch-001)** **互证** [**母表 B-492**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **/** [**R-004 §2**](spec/R-004-R003之后的扩展回归路线图.md) **。** |
| 427 | TT-B493-93-D-COM-API-BATCH-001 | regression · **93** · community | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-493** **`93-D-COM-API`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b493-93-d-com-api-batch-001)** **互证** [**母表 B-493**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 428 | TT-B494-93-D-COM-UI-BATCH-001 | regression · **93** · frontend | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-494** **`93-D-COM-UI`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b494-93-d-com-ui-batch-001)** **互证** [**母表 B-494**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 429 | TT-B495-93-D-DID-BATCH-001 | regression · **93** · did-rank | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-495** **`93-D-DID`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b495-93-d-did-batch-001)** **互证** [**母表 B-495**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 430 | TT-B496-93-D-STA-NET-BATCH-001 | regression · **93** · static | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-496** **`93-D-STA-NET`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b496-93-d-sta-net-batch-001)** **互证** [**母表 B-496**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 431 | TT-B497-93-D-ADM-BATCH-001 | regression · **93** · admin | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-497** **`93-D-ADM`** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b497-93-d-adm-batch-001)** **互证** [**母表 B-497**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 432 | TT-B498-93-S6-CROSS-BATCH-001 | regression · **93** · release | **未封口**（**登记** **2026-04-18** · **骨架**） | **B-498** **`93-§6-CROSS`** **（** **TT** **名** **用** **`S6`** **避** **锚** **字符** **）** **。** **`./AI任务卡索引.from-stash.md`** **[§正文](#tt-b498-93-s6-cross-batch-001)** **互证** [**母表 B-498**](./任务母表.md) **·** [**tracker**](./runbook/93-matrix-batch-tracker.md) **。** |
| 433 | TT-LOCAL-R003-DEV-FULLCHAIN-001 | regression · **local** · **R-003** **同源** **+** **A+B** **烟测** | **已封口（本机 · LOCAL FULL CHAIN）**（**2026-04-18** · **`bash scripts/smoke-ab-core-chain.sh` exit 0**（**HTTP** **+** **Postgres** **抽检**）· **`R003_LOCAL_CHAIN=1`** **`python scripts/dev/run_r003_staging_evidence_chain.py --from-env`** **末步** **`validate --fail-on-no-go` exit 0** · **`evidence/R003_local_evidence_chain/report.json`** **`release_gate=GO`** **`cases=12`** · **复现** **[Runbook §步骤](./runbook/TT-LOCAL-R003-DEV-FULLCHAIN-001.md)** **）** | **非** **93** **批次** **：** **[§正文](#tt-local-r003-dev-fullchain-001)** **·** **[Runbook](./runbook/TT-LOCAL-R003-DEV-FULLCHAIN-001.md)** **；** **不** **替代** **[TT-B486](#tt-b486-93-r003-staging-batch-001)** **`93-R003-STAGING`** **（** **行** **420** **仍** **待** **真实** **staging** **）** **。** |
| 434 | TT-STACK-LAYERS-REGRESSION-ORCH-001 | regression · **编排** · **L0～L7** **分层** **（** **无** **单一** **全站** **命令** **）** | **未封口**（**登记** **2026-04-18** **·** **SSOT** **[Runbook](./runbook/TT-STACK-LAYERS-REGRESSION-ORCH-001.md)** **；** **子卡** **`TT-STACK-L0`～`L7`** **见** **该** **文** **§2** **）** | **拆** **「** **API** **/** **ABI** **/** **单测** **/** **Vitest** **/** **烟测** **/** **E2E** **/** **93** **/** **发版** **人工** **」** **为** **可** **排期** **单元** **；** **与** **[93-matrix-batch-tracker](./runbook/93-matrix-batch-tracker.md)** **/** **[TT-LOCAL-R003](#tt-local-r003-dev-fullchain-001)** **互指** **。** |

### TT-LOCAL-R003-DEV-FULLCHAIN-001

- **Version**：**1.0.0**（**Runbook** **[`TT-LOCAL-R003-DEV-FULLCHAIN-001.md`](./runbook/TT-LOCAL-R003-DEV-FULLCHAIN-001.md)** **§** **为准** **）**
- **阶段**：本地 · **Docker Postgres** · **`http://127.0.0.1:8080`** · **R-003 同源脚本链**（**`R003_LOCAL_CHAIN=1`**）+ **`bash scripts/smoke-ab-core-chain.sh`**
- **状态**：**已封口（本机登记 · LOCAL FULL CHAIN）**（**2026-04-18** · **与** **一览** **行** **433** **第三列** **同** **口径** **；** **可** **按** **Runbook** **逐步** **复现** **）** · **与** **母表** **B-486** **无** **行级** **绑定** **；** **不** **改变** **`TT-B486`/`93-R003-STAGING`** **须** **真实** **staging** **`evidence/GO_20260418/`** **封口** **之** **事实** **。**
- **真值**：[dev-local-smoke-baseline.md](../dev-local-smoke-baseline.md) · [R-003 Staging 首轮](../spec/R-003-Staging首次完整回归-A-B域-执行Runbook.md)（**读** **前** **摘要** **：** **local** **为** **staging** **的** **工程** **替身** **）** · **`evidence/R003_local_evidence_chain/`**
- **重跑**：见 **[Runbook §步骤](./runbook/TT-LOCAL-R003-DEV-FULLCHAIN-001.md)** **；** **VS Code** **`R-003: staging evidence chain (env)`** **若** **误** **绑** **定** **`.env`** **请** **改用** **终端** **仅** **设** **`R003_LOCAL_CHAIN=1`** **（** **见** **Runbook** **）**
- **验收**：**`bash scripts/smoke-ab-core-chain.sh`** **exit** **0** **；** **`R003_LOCAL_CHAIN=1 python scripts/dev/run_r003_staging_evidence_chain.py --from-env`** **末步** **`validate --fail-on-no-go`** **exit** **0** **；** **`report.json`** **`environment.name=local`**
- **非目标**：**`evidence/GO_20260418/`** **、** **TT-B486** **行** **420** **staging** **封口** **、** **铁律①** **对** **staging** **PG** **的** **交付** **定义** **（** **local** **见** **`ENV-DB-PROOF/notes.md`** **机读** **追加** **段** **）**
- **下一跳**：已具备 **`R003_API_BASE=https://…`** **后** **→** **[TT-B486](#tt-b486-93-r003-staging-batch-001)** **`93-R003-STAGING`** **；** **全站** **页面** **→** **[93](../spec/93-全站功能验证矩阵-域别回归清单.md)** **+** **E2E** **/** **手工**

#### 本地全链路清单（执行人按序）

1. **`docker compose up -d`**  
2. **`DATABASE_URL` + `SEED_TEST_ACCOUNTS=1` + `cargo run -p traveltrust-api`**（**Win** **：** **`scripts/start-api-with-seed.bat`**）  
3. **`bash scripts/smoke-ab-core-chain.sh`**（**`API_BASE_URL=http://127.0.0.1:8080`**）  
4. **`R003_LOCAL_CHAIN=1`** **`python scripts/dev/run_r003_staging_evidence_chain.py --from-env`**  
5. **（** **可选** **）** **前端** **`NEXT_PUBLIC_API_BASE_URL`** **+** **`npm run dev`** **→** **[测试账号与本地联调.md](../测试账号与本地联调.md)**

**登记说明**：**一览** **行** **433** **第三列** **已** **登记** **本机** **LOCAL FULL CHAIN** **封口** **（** **2026-04-18** **）** **；** **他人** **机器** **须** **自行** **重跑** **上表** **1～4** **再** **核对** **证据** **目录** **时间戳** **。** **与** **`TT-B486`/`93-R003-STAGING`** **无关** **。**

### TT-B486-93-R003-STAGING-BATCH-001

- **阶段**：回归 · staging · **93 矩阵批次** **`93-R003-STAGING`**
- **与 TT-LOCAL-R003（行 433）**：**LOCAL FULL CHAIN** **仅** **覆盖** **本机** **`127.0.0.1:8080` + `evidence/R003_local_evidence_chain/`** **；** **本** **卡** **仍** **未** **封口** **，** **须** **真实** **`https://…` staging** **`+`** **非占位** **`R003_*`** **`+`** **`evidence/GO_20260418/`** **`validate`** **`+`** **铁律①** **+** **R-002** **回填** **后** **再** **改** **一览** **行** **420** **/** **tracker** **。**
- **前置（无 staging 域名时）**：**推荐** **先** **完成** **[TT-LOCAL-R003](#tt-local-r003-dev-fullchain-001)** **（** **行** **433** **）** **再** **并行** **开发** **；** **有** **`https://…` API** **后** **必须** **再** **走** **下方** **staging** **清单** **，** **不可** **以** **LOCAL** **证据** **冒充** **staging** **。**  
- **状态**：**未封口**（**登记** **2026-04-18** · **`scripts/dev/.env.r003.local`** **已** **写** **显式** **占位键** **；** **封口** **须** **真** **staging** **`validate`** **通过** **+** **铁律①** **+** **R-002** **回填** **后** **再** **改** **一览** **行** **420** **为** **已封口** **）**
- **母表**：[任务母表.md](./任务母表.md) **B-486**
- **真值**：[R-003 Staging 首轮](../spec/R-003-Staging首次完整回归-A-B域-执行Runbook.md) · [evidence/GO_20260418/README.md](../evidence/GO_20260418/README.md) · [93-matrix-batch-tracker](./runbook/93-matrix-batch-tracker.md) **行** **`93-R003-STAGING`**
- **重跑**：`python scripts/dev/run_r003_staging_evidence_chain.py --from-env` **；** **CI** **：** **Actions** **→** **`R-003 staging evidence chain (dispatch)`** **（** **`.github/workflows/r003-staging-evidence-chain-dispatch.yml`** **）** **+** **Secrets** **`R003_STAGING_*`** **；** **`runner_type`** **选** **`self-hosted`** **时** **须** **已** **注册** **`[self-hosted, linux]`** **runner** **且** **可** **达** **staging** **。**
- **验收**：**`report.json`** **`release_gate` ∈ {GO, PARTIAL_GO, NO_GO}`** **与** **铁律①** **`ENV-DB-PROOF/notes.md`** **写后读** **；** **`python scripts/validate-regression-report.py <out>/report.json --fail-on-no-go`** **；** **回填** **[R-002 §4](../spec/R-002-回归执行闭环与发布准入.md#§4-用例-id--自动化资产映射测试资产索引--持续补齐)** **/** **[§4.1](../spec/R-002-回归执行闭环与发布准入.md#41-93-矩阵批次--回填登记b-486b-498)** **（** **机读** **同源** **：** **[`evidence/GO_20260418/r002_section4_backfill.md`](../evidence/GO_20260418/r002_section4_backfill.md)** **）**
- **下一矩阵批次**：本目录 **`release_gate`** **会签** **后** **默认** **`93-A-REST`**（**B-487** **/** **[§TT-B487](#tt-b487-93-a-rest-batch-001)**）；**主题级** **R-004** **流水线** **见** **[R-004 §2](../spec/R-004-R003之后的扩展回归路线图.md)**

#### 真实 staging 封口清单（当前唯一目标 · 执行人按序）

1. **`scripts/dev/.env.r003.local`**：**不要**启用 **`R003_LOCAL_CHAIN=1`**（staging 交付以 **`evidence/GO_20260418/`** 为准）。填写 **`R003_API_BASE`**（`https://…`、无尾斜杠、非示例占位）、**`R003_A_PASSWORD`**、**`R003_EXECUTOR`**；保持 **`R003_ENVIRONMENT_NAME=staging`**、**`R003_OUT=evidence/GO_20260418`**。**勿提交**、**勿贴进聊天**。填毕可先跑 **`python scripts/dev/check_r003_staging_env_ready.py`**（或 VS Code **`R-003: check staging env (.env.r003.local)`**）做机读预检。
2. 在**能访问该 staging API** 的网络，仓库根执行：  
   `python scripts/dev/run_r003_staging_evidence_chain.py --from-env`  
   终端核对 **`GET /meta fingerprint`** 与 **`api_base`** 为目标环境。
3. **机读闸**：链末步为 **`validate-regression-report.py … --fail-on-no-go`**；**exit 0** 表示 **`release_gate`** 为 **GO** 或 **PARTIAL_GO**。若为 **NO_GO**，链会停在回归阶段，须先修 staging/API 后重跑。
4. **铁律①**：**`validate` 通过后**，由具备 **staging PostgreSQL** 读权限的人补全 **`evidence/GO_20260418/ENV-DB-PROOF/notes.md`**（写后读；若已有长文，回归脚本**只追加** **`api_base`** 锚点、不整文件覆盖）。
5. **R-002**：以 **`evidence/GO_20260418/r002_section4_backfill.md`**（与 **`report.json` `cases[]`** 同源）为机读真源，核对或增补 **[R-002 §4.1](../spec/R-002-回归执行闭环与发布准入.md#41-93-矩阵批次--回填登记b-486b-498)** **`93-R003-STAGING`** 行；**§4** 主表按需增补 **`cases[]`** 中出现的 **`id`** 行或写指针。
6. **封口登记**：跑通且 **铁律①**、**R-002** 人工核对后，执行 **`python scripts/dev/print_tt_b486_seal_snippet.py`**（可选 **`--require-iron-rule-notes`**）；将输出分别粘贴进 **一览** **行** **420** 与 **[93-matrix-batch-tracker](./runbook/93-matrix-batch-tracker.md)** **`93-R003-STAGING`**；**下一默认批次** **[TT-B487](#tt-b487-93-a-rest-batch-001)** **`93-A-REST`**。

#### 真跑已通过后的封口登记模板（复制替换 `{{…}}` 后再提交 PR）

**一览 行 420 · 第三列（状态）整格替换示例**（勿在真跑前使用）：

```markdown
**已封口**（**{{YYYY-MM-DD}}** · **staging** · **`evidence/GO_20260418/report.json`** **`release_gate={{GO|PARTIAL_GO}}`** · **`validate --fail-on-no-go` exit 0** · **铁律①已补** **`ENV-DB-PROOF/notes.md`** · **R-002 §4/§4.1 已对照** **`r002_section4_backfill.md`** **）**
```

**`93-matrix-batch-tracker.md` 批次总表**：在 **`93-R003-STAGING`** 行的 **`依赖`** 或团队约定的备注列追加一句 **`已封口 {{YYYY-MM-DD}} · 证据 evidence/GO_20260418/`** 即可（与上表 **勿** **双源** **矛盾** **时** **以** **`report.json` `run_id`** **为准** **）。

### TT-B487-93-A-REST-BATCH-001

- **阶段**：回归 · **93** · **§1 余量** · 批次 **`93-A-REST`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-487**
- **真值**：[93-matrix-batch-tracker](./runbook/93-matrix-batch-tracker.md) **·** [spec/93 §1](../spec/93-全站功能验证矩阵-域别回归清单.md)
- **重跑**：**tracker** **列** **「重跑入口」**（**当前** **手工** **/** **扩展** **脚本** **）** **；** **证据** **`evidence/93-batch-A-rest/<run_id>/`**
- **验收**：**每** **用例** **五态** **+** **R-002 §4** **回填**

### TT-B488-93-B-MKT-GDE-BATCH-001

- **阶段**：回归 · **93** · **§2** · **`93-B-MKT-GDE`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-488**
- **重跑**：**`cargo test`** **+** **`run-check-04-routes`** **+** **tracker** **所列** **手工**
- **验收**：**93** **PASS** **判据** **可** **复核** **；** **证据** **`evidence/93-batch-B-mkt-gde/<run_id>/`**

### TT-B489-93-B-ORD-FLOW-BATCH-001

- **阶段**：回归 · **93** · **订单深路径** · **`93-B-ORD-FLOW`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-489**
- **真值**：[spec/53](../spec/53-阶段开发技术文档.md) **·** [spec/93 §2](../spec/93-全站功能验证矩阵-域别回归清单.md)
- **验收**：**证据** **`evidence/93-batch-B-ord-flow/<run_id>/`** **；** **R-002 §4** **回填**

### TT-B490-93-B-ESC-DSP-BATCH-001

- **阶段**：回归 · **93** · **托管/争议** · **`93-B-ESC-DSP`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-490**
- **验收**：**链** **不符** **须** **N_A/BLOCKED** **+** **notes** **；** **证据** **`evidence/93-batch-B-esc-dsp/<run_id>/`**

### TT-B491-93-B-MSG-NEG-BATCH-001

- **阶段**：回归 · **93** · **消息/负例** · **`93-B-MSG-NEG`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-491**
- **验收**：**HTTP** **与** **93** **一致** **；** **证据** **`evidence/93-batch-B-msg-neg/<run_id>/`**

### TT-B492-93-C-GOV-STK-BATCH-001

- **阶段**：回归 · **93** · **治理/质押** · **`93-C-GOV-STK`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-492**
- **互指**：**扩面** **顺序** **见** **[R-004 §2](spec/R-004-R003之后的扩展回归路线图.md)** **（** **须** **R-003** **前置** **）**
- **验收**：**证据** **`evidence/93-batch-C-gov/<run_id>/`** **；** **R-002 §4**

### TT-B493-93-D-COM-API-BATCH-001

- **阶段**：回归 · **93** · **社区 API** · **`93-D-COM-API`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-493**
- **验收**：**证据** **`evidence/93-batch-D-com-api/<run_id>/`**

### TT-B494-93-D-COM-UI-BATCH-001

- **阶段**：回归 · **93** · **社区 UI** · **`93-D-COM-UI`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-494**
- **验收**：**Playwright** **/** **手工** **；** **证据** **`evidence/93-batch-D-com-ui/<run_id>/`**

### TT-B495-93-D-DID-BATCH-001

- **阶段**：回归 · **93** · **DID** · **`93-D-DID`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-495**
- **验收**：**证据** **`evidence/93-batch-D-did/<run_id>/`**

### TT-B496-93-D-STA-NET-BATCH-001

- **阶段**：回归 · **93** · **静态/外链** · **`93-D-STA-NET`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-496**
- **验收**：**证据** **`evidence/93-batch-D-sta/<run_id>/`**

### TT-B497-93-D-ADM-BATCH-001

- **阶段**：回归 · **93** · **Admin 抽检** · **`93-D-ADM`**
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-497**
- **真值**：[spec/70](../spec/70-管理员系统开发文档.md) **（** **非** **全量** **审计** **）**
- **验收**：**证据** **`evidence/93-batch-D-adm/<run_id>/`**

### TT-B498-93-S6-CROSS-BATCH-001

- **阶段**：回归 · **93** · **§6 横切** · **批次 ID** **`93-§6-CROSS`**（**TT** **ID** **用** **`S6`** **便于** **锚** **链接**）
- **状态**：**未封口**（**登记** **2026-04-18** · **骨架**）
- **母表**：[任务母表.md](./任务母表.md) **B-498**
- **验收**：**多** **域** **已** **绿** **后** **执行** **；** **证据** **`evidence/93-batch-S6-cross/<run_id>/`**

### TT-B276-B305-LIVE-OPS-ENHANCEMENT-PACK-REGISTRY-001

- **阶段**：上线运行 / 运维与安全增强（承 **B-262～B-275**，与已封口 UI·状态机正交）。
- **状态**：**已封口**（**2026-04-15** **整批** **；** **`scripts/ops`** **已落** **B-276～B-305** **对应** **实现** **，** **本** **轮** **台账** **/** **主索引** **[`AI任务卡索引.md`](./AI任务卡索引.md)** **一览** **279～308** **同批** **封口** **）** **。** **互证**：**一览** **286～315** **状态列** **；** **单卡** **深** **叙事** **见** **主索引** **§TT-B277** **/** **§TT-B282** **/** **各** **`###`**** **stub** **。**
...
- **封口批已落**：**`scripts/ops/region_vault_claim_broadcast_pipeline_resume.py`**（**`resume-execute`**** **`--signing-order-static-table`** **→** **`execute`** **）**；**根** **`scripts/region-vault-claim-broadcast-pipeline-resume.sh`** **；** **`execute`**** **`self-test`** **内** **`resume_from_prior_execution_report`** **断言** **（** **`eth_sendRawTransaction`** **skipped_idempotent_prior_mined** **）** **；** **from-stash** **一览** **292** **/** **主索引** **[`AI任务卡索引.md`](./AI任务卡索引.md)** **一览** **285** **/** **本节**
...
- **登记批内单卡封口**：**B-306** **/** **一览** **316** **→** **[`scripts-ops-preflight-matrix.md`](./scripts-ops-preflight-matrix.md)** **（** **`TT-B306-07-PR-PREFLIGHT-SCRIPT-MATRIX-INDEX-001`** **·** **2026-04-14** **）** **；** **B-307** **/** **一览** **317** **→** **[Runbook §12.7.1](../ops/RUNBOOK.md#1271-governance-doc-linkage-failure-triage)** **（** **`TT-B307-GOVERNANCE-DOC-LINKAGE-FAILURE-RUNBOOK-001`** **·** **2026-04-14** **）** **；** **B-309** **/** **一览** **319** **→** **[`15-附录〇与缺口官方总表-P0行映射-B309.md`](../spec/code-maps/15-附录〇与缺口官方总表-P0行映射-B309.md)** **（** **`TT-B309-P15-APPENDIX-O-P0-ROW-MAP-001`** **·** **2026-04-15** **）** **；** **B-311** **/** **一览** **321** **→** **`scripts/sql/users_role_preflight_inventory.sql`** **+** **`docs/runbook/users-role-preflight-inventory.md`** **（** **`TT-B311-87-USERS-ROLE-PREFLIGHT-INVENTORY-001`** **·** **2026-04-15** **）** **；** **B-312** **/** **一览** **322** **→** **`docs/runbook/TT-B312-five-routes-shell-ux-matrix-audit.md`** **（** **`TT-B312-88-FIVE-ROUTES-SHELL-UX-MATRIX-AUDIT-001`** **·** **2026-04-15** **）** **；** **B-313** **/** **一览** **323** **→** **`docs/runbook/TT-B313-70-admin-rbac-04-route-delta-table.md`** **（** **`TT-B313-70-ADMIN-RBAC-04-ROUTE-DELTA-TABLE-001`** **·** **2026-04-15** **）** **；** **B-314** **/** **一览** **324** **→** **`docs/runbook/TT-B314-04-internal-require-refs-gate-doc.md`** **（** **`TT-B314-04-INTERNAL-REQUIRE-REFS-GATE-DOC-001`** **·** **2026-04-15** **）** **；** **`scripts/ops`** **机读子集** **（** **2026-04-15** **）** **：** **B-308/B-310/B-326/B-327** **→** **主索引** **[`AI任务卡索引.md`](./AI任务卡索引.md)** **一览** **315～318** **；** **B-344/B-345/B-355/B-357/B-358/B-360** **→** **主索引** **一览** **319～324** **（** **详** **各** **TT** **`###`** **正文** **）** **。**
- **B-311～B-319 登记批收官互证**：**[`docs/runbook/TT-B311-B319-batch-closeout-summary.md`](./runbook/TT-B311-B319-batch-closeout-summary.md)** **（** **一览** **321～329** **·** **批次** **Runbook** **索引** **）** **。**
- **B-320** **/** **一览** **330** **→** **[`docs/runbook/TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC.md`](./runbook/TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC.md)** **（** **`TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
- **B-321** **/** **一览** **331** **→** **[`docs/runbook/TT-B321-I18N-KEY-PARITY-LINT-SPEC.md`](./runbook/TT-B321-I18N-KEY-PARITY-LINT-SPEC.md)** **（** **`TT-B321-I18N-KEY-PARITY-LINT-SPEC-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
- **B-322** **/** **一览** **332** **→** **[`docs/runbook/TT-B322-CI-TSC-VITEST-BUDGET-DOC.md`](./runbook/TT-B322-CI-TSC-VITEST-BUDGET-DOC.md)** **（** **`TT-B322-CI-TSC-VITEST-BUDGET-DOC-001`** **·** **2026-04-15** **·** **docs-only** **；** **勿** **与** **一览** **376** **`TT-B322-TESTNET-…`** **混** **）** **。**
- **B-323** **/** **一览** **333** **→** **[`docs/runbook/TT-B323-API-CARGO-FEATURES-SURFACE-MAP.md`](./runbook/TT-B323-API-CARGO-FEATURES-SURFACE-MAP.md)** **（** **`TT-B323-API-CARGO-FEATURES-SURFACE-MAP-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
- **B-324** **/** **一览** **334** **→** **[`docs/runbook/TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER.md`](./runbook/TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER.md)** **（** **`TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
- **B-325** **/** **一览** **335** **→** **[`docs/runbook/TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP.md`](./runbook/TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP.md)** **（** **`TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
- **B-330** **/** **一览** **340** **→** **[`docs/runbook/TT-B330-55-VS-110-INDEXER-SCOPE-SSOT.md`](./runbook/TT-B330-55-VS-110-INDEXER-SCOPE-SSOT.md)** **（** **`TT-B330-55-VS-110-INDEXER-SCOPE-SSOT-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
...
### TT-B311-87-USERS-ROLE-PREFLIGHT-INVENTORY-001

- **阶段**：db · **87 §11.1** **`users.role`** 迁移前只读盘点（允许集与 **`crates/api/src/routes/admin/mod.rs`** **`is_supported_target_role`** 同源）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-311**
- **封口批已落**：**[`scripts/sql/users_role_preflight_inventory.sql`](../scripts/sql/users_role_preflight_inventory.sql)**；**[`docs/runbook/users-role-preflight-inventory.md`](./runbook/users-role-preflight-inventory.md)**；**[spec/87-TravelTrust-角色体系技术文档-融合架构版.md](./spec/87-TravelTrust-角色体系技术文档-融合架构版.md)** **§11.1.1** **表** **续** **一行** **；** **from-stash** **一览** **321** **/** **本节**
- **验收**：**`psql "$DATABASE_URL" -v ON_ERROR_STOP=1 -f scripts/sql/users_role_preflight_inventory.sql`** **在** **目标库** **exit** **0** **；** **第二节** **（** **非** **允许集** **）** **须** **为空** **或** **已** **登记** **豁免** **；** **本轮** **不** **改** **`users`** **表** **DEFAULT** **/** **CHECK** **/** **应用** **枚举**
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[87 §11](./spec/87-TravelTrust-角色体系技术文档-融合架构版.md#11-与现有系统的兼容性结论)** · **`is_supported_target_role`** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B312-88-FIVE-ROUTES-SHELL-UX-MATRIX-AUDIT-001

- **阶段**：frontend · **88** **五** **主** **路由** **壳层** **Loading** **/** **Empty** **与** **86** **§6.0.1** **矩阵** **只读** **差分**
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-312**
- **封口批已落**：**[`docs/runbook/TT-B312-five-routes-shell-ux-matrix-audit.md`](./runbook/TT-B312-five-routes-shell-ux-matrix-audit.md)**；**from-stash** **一览** **322** **/** **本节**
- **验收**：**审计** **§2** **表** **五** **路由** **行** **齐** **；** **§3** **Empty** **壳层** **口径** **已** **划界** **（** **业务** **Empty** **见** **88** **§3.2** **另** **卡** **）** **；** **本轮** **0** **`page.tsx`** **diff**
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[88 §一](./spec/88-五主路由页身实现快照与UX缺口审计-20260330.md)** · **[86 §6.0.1](./spec/86-UI-双系统未来风-风格与动效技术规格.md)** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B313-70-ADMIN-RBAC-04-ROUTE-DELTA-TABLE-001

- **阶段**：admin · **70** **叙事** **/** **RBAC** **与** **04** **§3.5** **Admin** **路由** **及** **`admin::router()`** **差分** **；** **follow-up** **`GET …/observability/alert-rules`** **与** **`overview.observability_alerting_v1`**
- **状态**：**已封口**（**2026-04-15** · **审计** **+** **API** **/** **spec** **同批**）
- **母表**：[任务母表.md](./任务母表.md) **B-313**
- **封口批已落**：**[`docs/runbook/TT-B313-70-admin-rbac-04-route-delta-table.md`](./runbook/TT-B313-70-admin-rbac-04-route-delta-table.md)**；**`crates/api/src/routes/admin/mod.rs`** **（** **`get_admin_observability_alert_rules`** **+** **`observability_alerting_v1`** **）** **；** **`crates/api/src/routes/read_contract_route_guard.rs`** **（** **`READ_CONTRACT_GOVERNANCE_ADMIN_GET_PATHS`** **）** **；** **70** **/** **04** **路径** **修订** **；** **from-stash** **一览** **323** **/** **本节**
- **验收**：**`cargo test -p traveltrust-api`** **+** **`bash scripts/run-check-04-routes.sh`** **exit** **0**
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[70 读前摘要](./spec/70-管理员系统开发文档.md)** · **[04 §3.5 起](./spec/04-后端与API.md)** · **`crates/api/src/routes/admin/mod.rs`** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B314-04-INTERNAL-REQUIRE-REFS-GATE-DOC-001

- **阶段**：api · **04** · internal 路由 **`REQUIRE_REFS`** 门禁说明（docs-only）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-314**
- **封口批已落**：**[`docs/runbook/TT-B314-04-internal-require-refs-gate-doc.md`](./runbook/TT-B314-04-internal-require-refs-gate-doc.md)**；**`docs/spec/04-后端与API.md`** **零、SSOT Gate**（internal 场景 `CRATES_METADATA_GATE_REQUIRE_REFS=1` 纪律句）
- **验收**：**docs-only** 同批互证；不改公开 API 路由表、不改门禁脚本行为
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[04 零、SSOT Gate](./spec/04-后端与API.md)** · **`scripts/gates/check-pr-crates-needs-metadata.sh`** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B315-53-ORDER-TERMINAL-VS-ESCROW-SSOT-001

- **阶段**：product · **53** 订单终端态 vs **Escrow SSOT**（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-315**
- **封口批已落**：**[`docs/runbook/TT-B315-53-order-terminal-vs-escrow-ssot-audit.md`](./runbook/TT-B315-53-order-terminal-vs-escrow-ssot-audit.md)**（53/04/14 终态语义对照与登记）
- **验收**：仅文档/台账/索引更新；不改 API/合约/前端实现
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[53](./spec/53-阶段开发技术文档.md)** · **[04](./spec/04-后端与API.md)** · **[14](./spec/14-合约-API-ABI-前后端对齐.md)** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B316-14-ABI-FORGE-SYNC-ANTI-DRIFT-HINT-001

- **阶段**：contracts · **14** · ABI forge 同步防 drift（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-316**
- **封口批已落**：**[`docs/runbook/TT-B316-14-abi-forge-sync-anti-drift-hint.md`](./runbook/TT-B316-14-abi-forge-sync-anti-drift-hint.md)**（流程提示/可选 hook 文案登记）
- **验收**：仅文档/台账/索引更新；不改 gate 语义、不改 API/合约/前端实现
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[14 §1.2](./spec/14-合约-API-ABI-前后端对齐.md)** · **[04 §3.4](./spec/04-后端与API.md)** · **[Runbook §12.4](../ops/RUNBOOK.md)** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B317-83-84-COUNTRY-LEDGER-PROJECTION-GLOSSARY-001

- **阶段**：doc · **83/84** Country Pool 叙事 与 **110** 投影字段 Glossary（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-317**
- **封口批已落**：**[`docs/runbook/TT-B317-83-84-country-ledger-projection-glossary.md`](./runbook/TT-B317-83-84-country-ledger-projection-glossary.md)**（概念层 vs 投影层最小字段映射）
- **验收**：仅文档/台账/索引更新；不改 API/DB/脚本实现
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[83](./spec/83-区域治理与收益分配-协议白皮书.md)** · **[84](./spec/84-第一阶段10国Country-Pool发行参数总表.md)** · **[110](./spec/110-阶段开发链上索引器与事件同步器.md)** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B318-FEE-ROUTER-INTERNAL-EXPORT-FIELD-GLOSSARY-001

- **阶段**：doc · FeeRouter · internal 导出 JSON 字段 glossary（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-318**
- **封口批已落**：**[`docs/runbook/TT-B318-fee-router-internal-export-field-glossary.md`](./runbook/TT-B318-fee-router-internal-export-field-glossary.md)**（字段词汇与 admin 边界登记）
- **验收**：仅文档/台账/索引更新；不改 API/DB/脚本实现
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[04](./spec/04-后端与API.md)** · **[110](./spec/110-阶段开发链上索引器与事件同步器.md)** · **[83](./spec/83-区域治理与收益分配-协议白皮书.md)** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B319-FRONTEND-429-RETRY-04-ALIGNMENT-001

- **阶段**：frontend · 429 重试与 04 约定对齐（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-319**
- **封口批已落**：**[`docs/runbook/TT-B319-frontend-429-retry-04-alignment-audit.md`](./runbook/TT-B319-frontend-429-retry-04-alignment-audit.md)**（退避/错误包说明登记）
- **验收**：仅文档/台账/索引更新；不改前端实现、不改后端契约
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[04](./spec/04-后端与API.md)** · **[53](./spec/53-阶段开发技术文档.md)** · **[13-1](./spec/13-1-UI产品级SSOT与页面规范.md)** · **[批次收官 Runbook](./runbook/TT-B311-B319-batch-closeout-summary.md)**

### TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC-001

- **阶段**：doc · **`NEXT_PUBLIC_*`** 与 **`frontend/.env.example`** 机读 diff 规格（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-320**
- **封口批已落**：**[`docs/runbook/TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC.md`](./runbook/TT-B320-NEXT-PUBLIC-ENV-DIFF-SPEC.md)**（键集规则 + 审计快照 + **`NEXT_PUBLIC_DISABLE_IDLE_PREFETCH`** 示例缺口登记）；**from-stash** **一览** **330** **/** **本节**
- **验收**：仅文档/母表/索引更新；不改 `frontend` 业务实现、不新增机读脚本门禁
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[53 BB2](./spec/53-阶段开发技术文档.md)** · **[05 前端总览](./spec/05-前端总览.md)** · **`frontend/.env.example`**

### TT-B321-I18N-KEY-PARITY-LINT-SPEC-001

- **阶段**：frontend · **`en.ts`/`zh.ts`** 键对称与 **`test:i18n:ci`** 规格台账（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-321**
- **封口批已落**：**[`docs/runbook/TT-B321-I18N-KEY-PARITY-LINT-SPEC.md`](./runbook/TT-B321-I18N-KEY-PARITY-LINT-SPEC.md)**（≤8 只读文件清单 + 与 **`check-i18n-coverage.mjs`**/**`build.yml`** 互证 + 缺口登记）；**from-stash** **一览** **331** **/** **本节**
- **验收**：仅文档/母表/索引更新；不改 `locales`、不改 i18n 脚本、不改 CI
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[13-1](./spec/13-1-UI产品级SSOT与页面规范.md)** · **[53](./spec/53-阶段开发技术文档.md)** · **`frontend/scripts/check-i18n-coverage.mjs`**

### TT-B322-CI-TSC-VITEST-BUDGET-DOC-001

- **阶段**：ci · **`tsc` / Vitest / `cargo test`** 分轨与耗时预算叙事（docs-only 审计；**非** 一览 376 testnet 证据 TT）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-322**
- **封口批已落**：**[`docs/runbook/TT-B322-CI-TSC-VITEST-BUDGET-DOC.md`](./runbook/TT-B322-CI-TSC-VITEST-BUDGET-DOC.md)**（≤8 只读文件清单 + **`build.yml`**/**63/07/CONTRIBUTING** 分轨互证 + **无分钟 SLO / 无 step timeout** 缺口登记）；**from-stash** **一览** **332** **/** **本节**
- **验收**：仅文档/母表/索引更新；**默认**不改 **workflow** 语义
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[63 §六](./spec/63-项目优化与问题清单.md)** · **[07 §二 2.2](./spec/07-开发流程与顺序.md)** · **[`CONTRIBUTING.md`](../CONTRIBUTING.md)** · **[`.github/workflows/build.yml`](../.github/workflows/build.yml)**

### TT-B323-API-CARGO-FEATURES-SURFACE-MAP-001

- **阶段**：api · **`traveltrust-api`/`core`** **Cargo** **`[features]`** 与 **`cfg(feature)`** 暴露面地图（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-323**
- **封口批已落**：**[`docs/runbook/TT-B323-API-CARGO-FEATURES-SURFACE-MAP.md`](./runbook/TT-B323-API-CARGO-FEATURES-SURFACE-MAP.md)**（≤8 只读文件清单 + **全仓无 `[features]`** + **映射空表** + **与 04 admin flags 术语分界**）；**from-stash** **一览** **333** **/** **本节**
- **验收**：仅文档/母表/索引更新；不改 **`Cargo.toml`**、不改 **`src`**
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **`Cargo.toml`** **/** **`crates/api/Cargo.toml`** **/** **`crates/core/Cargo.toml`** · **[04 §3.5 admin/flags](./spec/04-后端与API.md)**（**运行时** **flags** **↔** **非** **Rust** **features**）

### TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER-001

- **阶段**：db · **SQLx** **迁移** **正向** **/** **回滚** **策略** **与** **RUNBOOK/04/41/55** **指针**（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-324**
- **封口批已落**：**[`docs/runbook/TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER.md`](./runbook/TT-B324-DB-MIGRATION-ROLLFORWARD-RUNBOOK-POINTER.md)**（≤8 只读文件清单 + **04 §四 P0** / **RUNBOOK §100·§2.6** / **41** / **55 §1.2** / **`GET …/admin/schema/migrations`** 聚合 + 缺口登记）；**from-stash** **一览** **334** **/** **本节**
- **验收**：仅文档/母表/索引更新；不改 **migrations**、不改 **RUNBOOK** 目录结构
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[04 §四](./spec/04-后端与API.md)** · **[RUNBOOK §100 / §2.6](../ops/RUNBOOK.md)** · **[41](./spec/41-后端数据库接库与落地清单.md)** · **[55 §1.2](./spec/55-阶段-数据同步与数据库功能同步.md)**

### TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP-001

- **阶段**：doc · **`evidence/GO_YYYYMMDD/manifest.json`** **字段** **与** **[15 附录〇](./spec/15-多维度文档与技术检查报告.md#发版前勾选总表)** **勾选** **/** **签字** **语义** **映射**（docs-only 审计）
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-325**
- **封口批已落**：**[`docs/runbook/TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP.md`](./runbook/TT-B325-EVIDENCE-MANIFEST-P15-SIGNOFF-MAP.md)**（≤8 只读文件清单 + **附录〇 第 11 项** 等对读 + **`sign_off`** vs **08-4** 签字分界 + 缺口登记）；**from-stash** **一览** **335** **/** **本节**
- **验收**：仅文档/母表/索引更新；不改 **`evidence/GO_*`** 目录内容、不恢复已移除 manifest 校验脚本
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[evidence/README.md](../evidence/README.md)** · **[07 §4.3.1](./spec/07-开发流程与顺序.md#07-sec-4-3-1-p0-release-index)** · **[B-309 · P0↔附录〇](./spec/code-maps/15-附录〇与缺口官方总表-P0行映射-B309.md)**

### TT-B330-55-VS-110-INDEXER-SCOPE-SSOT-001

- **阶段**：doc · **[55](../spec/55-阶段-数据同步与数据库功能同步.md)** **应用层数据同步** **vs** **[110](../spec/110-阶段开发链上索引器与事件同步器.md)** **链上索引器** **职责分界**
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-330**
- **封口批已落**：**[`docs/runbook/TT-B330-55-VS-110-INDEXER-SCOPE-SSOT.md`](./runbook/TT-B330-55-VS-110-INDEXER-SCOPE-SSOT.md)**；**55** **读前摘要** **+** **§〇**；**110** **读前摘要** **+** **§一**；**from-stash** **一览** **340** **/** **本节**
- **验收**：**`bash scripts/run-check-04-routes.sh`** **exit** **0**；**本轮** **0** **`crates/**`** **diff**
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[55 §〇](../spec/55-阶段-数据同步与数据库功能同步.md#〇55-阶段目标与范围)** · **[110 §一](../spec/110-阶段开发链上索引器与事件同步器.md#一文档定位)**

### TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC-001

- **阶段**：ops · **indexer** **所** **依赖** **JSON-RPC** **降级** **时** **的** **桌面** **演练** **议程** **（** **不** **默认** **对** **生产** **端点** **做** **故障** **注入** **）**
- **状态**：**已封口**（**2026-04-15**）
- **母表**：[任务母表.md](./任务母表.md) **B-363**
- **封口批已落**：**[`docs/runbook/TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC.md`](./runbook/TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC.md)**；**110** **读前摘要** **「** **RPC** **降级** **桌面** **演练** **」** **；** **from-stash** **一览** **373** **/** **本节**
- **验收**：**`bash scripts/run-check-04-routes.sh`** **exit** **0**；**本轮** **0** **`crates/**`** **diff** **、** **0** **04** **契约** **表** **正文** **diff**
- **互证**：[§TT-B336-B365](#tt-b336-b365-platform-reliability-registry-001) · **[110 读前摘要](../spec/110-阶段开发链上索引器与事件同步器.md)** · **[`ops/RUNBOOK.md` §2.55](../ops/RUNBOOK.md)** · **[母表 B-175](./任务母表.md)**（**chainId** **探针** **叙事** **邻域** **）
...
- **B-363** **/** **一览** **373** **→** **[`docs/runbook/TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC.md`](./runbook/TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC.md)** **（** **`TT-B363-INDEXER-RPC-DEGRADATION-TABLETOP-SPEC-001`** **·** **2026-04-15** **·** **docs-only** **）** **。**
...
| **上线运维增强（登记批）** | **286～315** | **B-276～B-305** **已于** **2026-04-15** **整批** **封口** **（** **一览** **状态列** **+** **主索引** **[`AI任务卡索引.md`](./AI任务卡索引.md)** **一览** **279～308** **）** **；** **硬** **边界** **与** **五类** **划分** **见** **[§TT-B276-B305-LIVE-OPS-ENHANCEMENT-PACK-REGISTRY-001](#tt-b276-b305-live-ops-enhancement-pack-registry-001)** |
| **07 对齐工程欠账（登记批 · 二）** | **316～345** | **一览** **316** **/** **B-306** **已于** **2026-04-14** **文档** **封口** **（** **矩阵** **[`scripts-ops-preflight-matrix.md`](./scripts-ops-preflight-matrix.md)** **）** **；** **一览** **317** **/** **B-307** **已于** **2026-04-14** **文档** **封口** **（** **[Runbook §12.7.1](../ops/RUNBOOK.md#1271-governance-doc-linkage-failure-triage)** **）** **；** **一览** **319** **/** **B-309** **已于** **2026-04-15** **纯** **文档** **封口** **（** **[`15-附录〇与缺口官方总表-P0行映射-B309.md`](../spec/code-maps/15-附录〇与缺口官方总表-P0行映射-B309.md)** **·** **主索引** **一览** **314** **互证** **）** **；** **一览** **318/320/336/337** **（** **B-308/B-310/B-326/B-327** **）** **已于** **2026-04-15** **`scripts/ops`** **机读子集** **封口** **（** **主索引** **一览** **315～318** **互证** **）** **；** **一览** **330～335** **（** **B-320～B-325** **）** **已于** **2026-04-15** **docs-only** **审计** **封口** **（** **详见** **一览** **表** **状态列** **）** **；** **其余** **（** **一览** **318～345** **扣** **除** **已** **封口** **之** **318/319/320/330～335/336/337** **）** **仍** **未** **全** **卡** **封口** **。** **与** **B-276～B-305** **广播** **包** **正交** **，** **互证** **[§TT-B306-B335-07-ALIGNED-BACKLOG-REGISTRY-001](#tt-b306-b335-07-aligned-backlog-registry-001)** |
| **平台可靠性 / 安全 / 可观测（登记批 · 三）** | **346～375** | **一览** **361** **/** **B-351** **已于** **2026-04-14** **文档** **封口**（**[`docs/adr/`](./adr/README.md)** **+** **[`CODEOWNERS-map.md`](./CODEOWNERS-map.md)** **+** **[`.github/CODEOWNERS`](../.github/CODEOWNERS)** **注释** **占位** **）** **；** **一览** **354/355/365/367/368/370** **（** **B-344/B-345/B-355/B-357/B-358/B-360** **）** **已于** **2026-04-15** **`scripts/ops`** **机读子集** **封口** **（** **主索引** **一览** **319～324** **互证** **）** **；** **其余** **346～360** **/** **B-336～B-350** **与** **362～375** **/** **B-352～B-365** **（** **除** **已** **列** **外** **）** **仍** **未** **全** **卡** **封口** **。** **互证** **[§TT-B336-B365-PLATFORM-RELIABILITY-REGISTRY-001](#tt-b336-b365-platform-reliability-registry-001)** |
...
- **状态**：已封口（**Completion**）  
- **本轮仅改**：`crates/api/migrations/20260422000051_investor_stake_state_events.sql`、`crates/api/src/db/investor_stake.rs`、`crates/api/src/chain/indexer/`（**`fetch_guide_staking_state_logs`**）、`crates/api/src/routes/internal.rs`（**tick**/**reorg**）、`crates/api/src/routes/investor_distribution.rs`、`crates/api/src/db/investor_distribution.rs`、`docs/spec/04-后端与API.md`、`docs/任务母表.md`、本索引  
- **禁止再分析**：—  
...
- **封口摘要（代码路径）**：**`GET /api/v1/traveltrust/page-brief`** — **`crates/api/src/routes/traveltrust_page.rs`**（**handler + `traveltrust_page_brief_json`** **单测** **`page_brief_doc_version_matches_protocol_reference`**）；**`crates/api/src/routes/mod.rs`** **`merge(traveltrust_page::router())`**；**`frontend/lib/api.ts`** **`routes.traveltrustPageBrief`**；**`frontend/modules/traveltrust-home/presentation/TravelTrustNetworkPageComposer.tsx`** **`TravelTrustPageBriefProvider`**（**2026-05-26 勘误**：**非** **`page.tsx`** **`TravelTrustPageBriefHydrate`** 直挂）；**`frontend/lib/analytics.ts`** **`trackTravelTrustEvent`** **必填** **`target`**（**P1** **`/allocation`** **见** **B-200** / **`#allocation`** **仍** **为** **合法** **类型值**；**P2** **`/market`**）；Hero/页尾 CTA 埋点与 **`page-brief`** 同源；**`TravelTrustStickyCta`** **① 未**挂载现行 **`/traveltrust`** 页树（**FIVE-MAIN** · **`traveltrustNetworkPage.contract.test.ts`**）；**`frontend/lib/api.test.ts`** **`traveltrustPageBrief`** **路径断言**
...
- **状态**：**已封口**（**2026-04-14** **；** **EXTEND** **2026-04-15** **：** **`--signing-order-static-table`****+** **`signing_order_static_table_validated`** **、** **`--require-preflight-ok`**** **子进程** **接线** **、** **B-282** **`resume_from_prior_execution_report`** **断言** **、** **self-test** **stub** **隔离** **）**
- **母表**：[任务母表.md](./任务母表.md) **B-262**
- **封口批已落**：**`scripts/ops/region_vault_claim_broadcast_execute.py`**（**`execute`****/** **`self-test`**）；**`scripts/ops/region_vault_claim_broadcast_signing_order_static.py`**（**`emit`****/** **`verify`****/** **`self-test`** **→** **B-277** **）**；**`scripts/ops/region_vault_claim_broadcast_pipeline_resume.py`**（**`resume-execute`**** **`--signing-order-static-table`** **→** **`execute`**** **→** **B-282** **）**；**`scripts/region-vault-claim-broadcast-execute.sh`**；**[spec/14-合约-API-ABI-前后端对齐.md](./spec/14-合约-API-ABI-前后端对齐.md)** **§1.1.1.1p**；**[spec/04-后端与API.md](./spec/04-后端与API.md)** **§3.5**（**`TT-B277`** **）**；**[ops/RUNBOOK.md](../ops/RUNBOOK.md)** **§2.55** **B-262**；**[scripts/README.md](../scripts/README.md)**；**本索引一览 274 / 本节**
- **任务（摘要）**：**`execute <stub.json> -o report.json`** **内** **嵌** **`run_rehearsal`** **→** **`eth_sendRawTransaction`**** **×** **`global_broadcast_sequence`**** **→** **可选** **`eth_getTransactionReceipt`**** **；** **`CHAIN_RPC_URL`**** **/** **`--rpc-url`** **；** **`--dry-run`** **；** **可选** **`--signing-order-static-table`**** **（** **B-277** **）** **；** **主网** **ack** **`TRAVELTRUST_BROADCAST_EXECUTE_ACK_MAINNET=1`**
...
- **任务目标（聚合 · 极简）**：
  1. **P0**：旅行者从 **落地/首页** 经 **`/market`** 完成 **下单/意向** 并进入 **`/escrow/[id]`** 主路径，**弱网/错误** 下仍可理解下一步。
...
- **阶段**：indexer / revenue · **B-398** **`revenue_pipeline_spread_dual_slack_triangulation_observability`**（**`triangulation_signal`** **：** **B-391** **`gap_blocks`** **与** **B-392** **`tail_slack_blocks`** **双轴** **对** **`spread_blocks`** **之** **三角化** **读** **；** **不** **替代** **B-396/B-397** **单轴** **`dominance_signal`** **）** · **已实现**
- **状态**：**已封口**（**2026-04-15** **；** **代码** **+** **04** **+** **Runbook** **§2.55** **+** **smoke** **脚本** **；** **§5.1** **目标环境** **末行** **自填** **）**
- **母表**：[任务母表.md](./任务母表.md) **B-398**
- **实现已落**：[`docs/runbook/TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-001.md](./runbook/TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-001.md) **、** [`docs/runbook/TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-SCOPE-LOCK.md](./runbook/TT-B398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-SCOPE-LOCK.md) **、** **`crates/api/src/db/revenue_pipeline_spread_dual_slack_triangulation_obs.rs`**
- **任务（实现轮）**：**已完成** **：** **DB** **模块** **+** **`indexer_reconcile`** **body** **flag** **+** **`admin/observability/overview`** **同键** **回读** **+** **`scripts/ops/b398-*-smoke.sh`** **+** **04 §3.4** **+** **`ops/RUNBOOK.md`** **§2.55**
- **验收**：**`cargo test -p traveltrust-api`** **；** **`bash scripts/run-check-04-routes.sh`** **；** **目标** **环境** **smoke** **`exit 0`** **（** **勿** **含** **密钥** **）**
- **互证**：锚 **`398-REVENUE-PIPELINE-SPREAD-DUAL-SLACK-TRIANGULATION-OBS-V1`** · **from-stash** **一览** **381**

### TT-B409-ORDER-STATE-MACHINE-CHAIN-OFF-53-001

- **阶段**：orders · chain_off · 状态机（**53** / **04 §三** / 前端同源）
- **状态**：**已封口**（**2026-04-15** **；** **实现** **+** **Runbook** **§8** **验收** **留痕** **）**
- **母表**：[任务母表.md](./任务母表.md) **B-409**
- **Runbook**：[docs/runbook/TT-B409-ORDER-STATE-MACHINE-CHAIN-OFF-53-001.md](./runbook/TT-B409-ORDER-STATE-MACHINE-CHAIN-OFF-53-001.md) **（** **§8** **封口** **）**
- **实现已落**：**`crates/api/src/chain_off/mod.rs`** **`ChainOffConfig.order_mock_pay_enabled`**（**`from_env`** **与** **`P3_CHAIN_OFF=1`** **同源**）**；** **`crates/api/src/routes/orders/mutations.rs`** **`order_mock_pay`** **；** **`crates/api/src/routes/orders/tests/suite.rs`** **`tt_b409_chain_off_http_order_created_accepted_escrowed`** **。**
- **本轮仅改（默认）**：见 Runbook **§4** **≤8** **文件** **白名单** **；** **禁止** **新增** **indexer** **/** **reconcile** **观测键** **（** **已** **自检** **）** **。**
- **任务（结果）**：链下 **HTTP** **`created → accepted → escrowed`** **与** **`p21_order_create_accept_mock_pay_confirm`** **对齐** **；** **mock-pay** **闸** **由** **配置** **承载** **便于** **单测** **。**
- **验收**：见 Runbook **§8** **。** **`cargo test -p traveltrust-api`** **；** **本** **轮** **未** **改** **04** **契约** **句** **。**
- **互证**：**from-stash** **一览** **383** **。**

### TT-B412-REVENUE-DATA-DISCOVERABILITY-OPS-001

- **阶段**：admin · indexer · revenue · **只读** **「** **数据** **可查** **」**
- **状态**：**已封口**（**2026-04-15** **·** **Runbook** **§4～6** **+** **`b412`** **脚本** **+** **`ops/RUNBOOK.md`** **§2.55** **）**
- **母表**：[任务母表.md](./任务母表.md) **B-412**
- **Runbook**：[docs/runbook/TT-B412-REVENUE-DATA-DISCOVERABILITY-OPS-001.md](./runbook/TT-B412-REVENUE-DATA-DISCOVERABILITY-OPS-001.md)
- **实现已落**：**`scripts/ops/b412-order-to-revenue-discoverability-smoke.sh`** **（** **`GET …/admin/orders/:id`** **→** **复用** **`b402-min-revenue-e2e-reconcile-smoke.sh`** **）** **；** **不** **改** **`crates/api`** **观测** **实现** **。**
- **硬边界**：**不** **新增** **indexer** **/** **reconcile** **观测** **JSON** **键** **（** **沿用** **B-383/B-386** **）** **。**
- **任务（结果）**：打通 **订单** **UUID** **锚** **→** **收入** **观测** **reconcile** **↔** **overview** **同键** **对拍** **路径** **。**
- **验收**：见 Runbook **§6** **；** **目标** **环境** **`bash scripts/ops/b412-order-to-revenue-discoverability-smoke.sh`** **`exit 0`** **（** **须** **`B412_ORDER_ID`** **+** **与** **b402** **同源** **ENV** **）** **。**
- **互证**：**from-stash** **一览** **384** **。**

### TT-STACK-LAYERS-REGRESSION-ORCH-001

- **阶段**：regression · **编排** · **全栈对齐分层**（**API** **/** **ABI** **/** **Vitest** **/** **烟测** **/** **Playwright** **/** **93** **/** **发版人工**）
- **状态**：**未封口**（**登记** **2026-04-18** **·** **一览** **行** **434** **）**
- **母表**：**无** **独立** **B** **行** **（** **编排** **元** **卡** **；** **若** **需** **工时** **签核** **再** **单开** **B-5xx** **挂** **93** **/** **release** **）**
- **Runbook**：[docs/runbook/TT-STACK-LAYERS-REGRESSION-ORCH-001.md](./runbook/TT-STACK-LAYERS-REGRESSION-ORCH-001.md) **（** **§2** **子任务卡** **`TT-STACK-L0`～`TT-STACK-L7`** **）**
- **任务**：把「无单一命令证明全站」拆成 **L0** 文档门禁、**L1** Rust、**L2** Vitest、**L3** `smoke-ab-core-chain`、**L4** Playwright、**L5** forge ABI、**L6** 93 批次（**TT-B486～B498**）、**L7** 发版人工矩阵。
- **验收**：按 Runbook **§2** 逐层执行并留证；**不**替代 **TT-B486** **staging** **首轮** **、** **不** **替代** **93** **正文** **判据** **。
- **互证**：[93-matrix-batch-tracker](./runbook/93-matrix-batch-tracker.md) · [dev-local-smoke-baseline.md](../dev-local-smoke-baseline.md) · [TT-LOCAL-R003](#tt-local-r003-dev-fullchain-001) **一览** **433**

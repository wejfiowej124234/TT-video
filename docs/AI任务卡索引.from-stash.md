...
| 321 | TT-B311-87-USERS-ROLE-PREFLIGHT-INVENTORY-001 | db · 87 §11 · users.role 迁移前只读盘点 | **已封口**（**2026-04-15**） | **B-311**：**[`scripts/sql/users_role_preflight_inventory.sql`](../scripts/sql/users_role_preflight_inventory.sql)** **+** **[`docs/runbook/users-role-preflight-inventory.md`](./runbook/users-role-preflight-inventory.md)** **；** **87** **§11.1.1** **表** **一行** **。** **互证** [**母表 B-311**](./任务母表.md) · [**正文**](#tt-b311-87-users-role-preflight-inventory-001) |
| 322 | TT-B312-88-FIVE-ROUTES-SHELL-UX-MATRIX-AUDIT-001 | frontend · 88 · 五主路由壳层 UX 与 86 矩阵差分 | **已封口**（**2026-04-15** · **只读** **审计**） | **B-312**：**[`docs/runbook/TT-B312-five-routes-shell-ux-matrix-audit.md`](./runbook/TT-B312-five-routes-shell-ux-matrix-audit.md)** **。** **互证** [**母表 B-312**](./任务母表.md) · [**正文**](#tt-b312-88-five-routes-shell-ux-matrix-audit-001) |
| 323 | TT-B313-70-ADMIN-RBAC-04-ROUTE-DELTA-TABLE-001 | admin · 70 · RBAC 与 04 admin 路由差分 + alert-rules 实现 | **已封口**（**2026-04-15** · **审计** **+** **`traveltrust-api`** **实现**） | **B-313**：**[`docs/runbook/TT-B313-70-admin-rbac-04-route-delta-table.md`](./runbook/TT-B313-70-admin-rbac-04-route-delta-table.md)** **+** **`GET …/observability/alert-rules`** **/** **`read_contract`** **路径** **登记** **。** **互证** [**母表 B-313**](./任务母表.md) · [**正文**](#tt-b313-70-admin-rbac-04-route-delta-table-001) |
...
- **登记批内单卡封口**：**B-306** **/** **一览** **316** **→** **[`scripts-ops-preflight-matrix.md`](./scripts-ops-preflight-matrix.md)** **（** **`TT-B306-07-PR-PREFLIGHT-SCRIPT-MATRIX-INDEX-001`** **·** **2026-04-14** **）** **；** **B-307** **/** **一览** **317** **→** **[Runbook §12.7.1](../ops/RUNBOOK.md#1271-governance-doc-linkage-failure-triage)** **（** **`TT-B307-GOVERNANCE-DOC-LINKAGE-FAILURE-RUNBOOK-001`** **·** **2026-04-14** **）** **；** **B-309** **/** **一览** **319** **→** **[`15-附录〇与缺口官方总表-P0行映射-B309.md`](../spec/15-附录〇与缺口官方总表-P0行映射-B309.md)** **（** **`TT-B309-P15-APPENDIX-O-P0-ROW-MAP-001`** **·** **2026-04-15** **）** **；** **B-311** **/** **一览** **321** **→** **`scripts/sql/users_role_preflight_inventory.sql`** **+** **`docs/runbook/users-role-preflight-inventory.md`** **（** **`TT-B311-87-USERS-ROLE-PREFLIGHT-INVENTORY-001`** **·** **2026-04-15** **）** **；** **B-312** **/** **一览** **322** **→** **`docs/runbook/TT-B312-five-routes-shell-ux-matrix-audit.md`** **（** **`TT-B312-88-FIVE-ROUTES-SHELL-UX-MATRIX-AUDIT-001`** **·** **2026-04-15** **）** **；** **B-313** **/** **一览** **323** **→** **`docs/runbook/TT-B313-70-admin-rbac-04-route-delta-table.md`** **（** **`TT-B313-70-ADMIN-RBAC-04-ROUTE-DELTA-TABLE-001`** **·** **2026-04-15** **）** **；** **`scripts/ops`** **机读子集** **（** **2026-04-15** **）** **：** **B-308/B-310/B-326/B-327** **→** **主索引** **[`AI任务卡索引.md`](./AI任务卡索引.md)** **一览** **315～318** **；** **B-344/B-345/B-355/B-357/B-358/B-360** **→** **主索引** **一览** **319～324** **（** **详** **各** **TT** **`###`** **正文** **）** **。**
...
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[87 §11](./spec/87-TravelTrust-角色体系技术文档-融合架构版.md#11-与现有系统的兼容性结论)** · **`is_supported_target_role`**
...
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[88 §一](./spec/88-五主路由页身实现快照与UX缺口审计-20260330.md)** · **[86 §6.0.1](./spec/86-UI-双系统未来风-风格与动效技术规格.md)**
...
- **互证**：[§TT-B306-B335](#tt-b306-b335-07-aligned-backlog-registry-001) · **[70 读前摘要](./spec/70-管理员系统开发文档.md)** · **[04 §3.5 起](./spec/04-后端与API.md)** · **`crates/api/src/routes/admin/mod.rs`**

...
`cargo test -p traveltrust-api matrix_93_b_mkt_010_f022_get_acquisition_listing_detail_app_stack_ok_pg` exit=0

```

running 1 test
test routes::market_subsite_catalog_db_api_tests::matrix_93_b_mkt_010_f022_get_acquisition_listing_detail_app_stack_ok_pg ... ok
...
[req] x-request-id=495d1c9d-79a7-44e8-8798-e01f688b5130 path=/api/v1/market/acquisition/listings/80d0ac4e-bcf3-4afb-9b45-d824ed820bcc status=200
[req] x-message-id=8ea85a2d-1637-494a-8fb8-a18162a451b2 path=/api/v1/market/acquisition/listings/80d0ac4e-bcf3-4afb-9b45-d824ed820bcc status=200

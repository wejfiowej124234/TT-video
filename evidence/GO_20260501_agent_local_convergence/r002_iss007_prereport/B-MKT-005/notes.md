...
running 1 test
test routes::market_subsite_catalog_db_api_tests::matrix_93_b_mkt_005_f021_get_provider_listings_app_stack_ok_pg ... ok
...
[req] x-request-id=0d94d3eb-56dd-4515-abfe-bac99e736aa3 path=/api/v1/market/provider/listings status=200
[req] x-message-id=cd843a5e-bfa7-48eb-a913-cf4d1549dec9 path=/api/v1/market/provider/listings status=200

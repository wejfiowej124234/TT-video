...
`cargo test -p traveltrust-api matrix_93_b_gde_001_f023_post_guide_get_detail_app_stack_ok_pg` exit=0

```

running 1 test
test routes::guides_disputes_db_api_tests::matrix_93_b_gde_001_f023_post_guide_get_detail_app_stack_ok_pg ... ok
...
[req] x-request-id=523a2d4a-cbef-4ccc-bd9c-11cd6403806e path=/api/v1/guides status=200
[req] x-message-id=a5b8529d-0291-40b0-8a03-09928e911ade path=/api/v1/guides status=200
[req] x-request-id=a2366214-dfef-4f7b-b0fa-f1e568e381ed path=/api/v1/guides/a971dd71-5ce9-4bf8-86c5-b549e57b7f7e status=200
[req] x-message-id=5910638b-3cc5-4a3d-921f-fe0e1a190fb2 path=/api/v1/guides/a971dd71-5ce9-4bf8-86c5-b549e57b7f7e status=200

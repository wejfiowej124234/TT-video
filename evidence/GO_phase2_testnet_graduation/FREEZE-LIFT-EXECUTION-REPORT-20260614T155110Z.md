...
| **WT dirty (full tree)** | 1168 files |
| **HEAD = Staging SHA** | ✅ exact `head=877a1e77bf05…` `staging=877a1e77bf05…` |

**grep:** `TT_SINGLE_SSOT_RECONCILIATION: RECONCILED_100_PERCENT 20260614T155110Z`
...
| **部署版本** | not deployed | 877a1e77bf05cf1d4d5141aedac404a23d219e5f | 877a1e77bf05cf1d4d5141aedac404a23d219e5f | 877a1e77bf05 | ✅ |
| **链上参数** | registry SSOT | registry in git | escrow=0xbf746B6a… | spine audit OK 20260614 | ✅ |
| **证据链** | local-first-closure-20260614T140715Z | 877a1e77bf05 | 877a1e77bf05 | TN-P1-D6:PASS · TN-P1-D24:PASS · TN-P1-010:PASS · DEEP_GATE:PASS · PHASE28_HAT:PASS · TN-P1-009:PASS | ✅ |
...
- **BLK-WT-NONSSOT** (P2): 1168 non-deploy WT files (docs/scripts/evidence); deploy-SSOT clean

# Phase ② Testnet Graduation Audit · 20260615T021337Z
...
| **missing_coverage** | 6 |
| **evidence_gap** | 12 |
| **enterprise_coverage_pct** | 75% |
| **operational_readiness_pct** | 20% |
| **full_closure_coverage_pct** | 75% |
...
| **L5 forbidden reasons** | missing_coverage>0 · evidence_gap>0 · full_closure_coverage_pct<100 · p2fc_soak_72h_staging_not_completed · tt_testnet_graduation_not_closed · owner_signoff_incomplete · d1_d24_not_all_pass |
...
| D20 Production Readiness Review 多维签审 | OPEN | 3 |
...
**full_closure_coverage_pct:** 75% · **surface_coverage_pct:** 100% · **untested_ui/action:** 0/0
...
- `deep_closure_missing_coverage`: 6
- `deep_closure_evidence_gap`: 12
- `enterprise_coverage_pct`: 75
- `operational_readiness_pct`: 20
- `full_closure_coverage_pct`: 75
- `surface_coverage_pct`: 100

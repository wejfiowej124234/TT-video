...
| **WT dirty (full tree)** | 1185 files |
| **HEAD = Staging SHA** | ✅ `0d8d09702a36…` |

**grep:** `TT_SINGLE_SSOT_RECONCILIATION: RECONCILED 20260614T090036Z`
...
|------|-----|------|---------|----------|---------|
| **代码** | deploy-SSOT clean | committed | matches HEAD | PASS on old behavior | ✅ |
...
| **部署版本** | not deployed | 0d8d09702a368c254db2893617df4439344fe582 | 0d8d09702a368c254db2893617df4439344fe582 | 0d8d09702a36 | ✅ |
...
- **BLK-WT-NONSSOT** (P2): 1185 non-deploy WT files (docs/scripts/evidence); deploy-SSOT clean

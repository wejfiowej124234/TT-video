# Phase ② Testnet Graduation Audit · 20260614T095536Z
...
| **L5 forbidden reasons** | blocking_open>0 · missing_coverage>0 · evidence_gap>0 · full_closure_coverage_pct<100 · p2fc_soak_72h_staging_not_completed · tt_testnet_graduation_not_closed · owner_signoff_incomplete · d1_d24_not_all_pass |
...
**full_closure_coverage_pct:** 83% · **surface_coverage_pct:** 100% · **untested_ui/action:** 0/0
...
- `deep_closure_missing_coverage`: 1
- `deep_closure_evidence_gap`: 1
- `enterprise_coverage_pct`: 63
- `operational_readiness_pct`: 100
- `full_closure_coverage_pct`: 83
- `surface_coverage_pct`: 100

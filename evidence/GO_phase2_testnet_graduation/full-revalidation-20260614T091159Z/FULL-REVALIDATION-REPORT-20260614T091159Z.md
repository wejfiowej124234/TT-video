...
| **Deep Release Gate** | FAIL/PARTIAL |

**grep:** `TT_PHASE2_TESTNET_FULL_REVALIDATION: REVALIDATION_CLEAR_EXCEPT_SOAK 20260614T091159Z`
...
| TN-P1-004 | **PASS** | re-validated on baseline |
| TN-P1-005 | **PASS** | re-validated on baseline |
...
**Summary:** PASS=20 PARTIAL=4 OPEN=0
...
| Indexer compound | ⚠️ |
| Graduation matrix | `evidence\GO_phase2_testnet_graduation\20260614T095536Z` |

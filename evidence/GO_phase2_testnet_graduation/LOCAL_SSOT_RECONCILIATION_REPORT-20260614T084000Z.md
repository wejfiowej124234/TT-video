...
| **WT vs HEAD** | 278 modified · 1806 untracked |
| **WT vs Staging** | ❌ **not converged** |
| **HEAD vs Staging** | ✅ aligned |
| **Gaps** | C:3 H:5 M:4 L:2 |

**grep:** `TT_LOCAL_SSOT_RECONCILIATION: RECONCILIATION_REQUIRED 20260614T084000Z`

**机读：** `LOCAL_SSOT_RECONCILIATION_REPORT-20260614T084000Z.json` · `freeze-lift-backlog.v1.json`
...
- 278 modified + 1806 untracked vs HEAD 5ab1f8ba2229; staging /meta git_sha = HEAD (not working tree).

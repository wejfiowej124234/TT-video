...
**At:** 20260630T052104Z
**HEAD (dev SSOT):** `6e1fb5aca42b99f916ea6d6fc488a089536d3742`
...
- **GAP-CLOSURE-WT**: ["scripts/dev/emit-local-first-alignment-audit.mjs"]
...
- **GAP-LOCAL-AHEAD-UNDEPLOYED** (INFO): head=6e1fb5aca42b staging=9979b35efe56 — Local First; bring at S5 deploy only

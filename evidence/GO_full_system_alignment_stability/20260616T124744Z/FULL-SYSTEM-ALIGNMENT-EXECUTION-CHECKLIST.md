...
**Stamp:** `20260616T124744Z`
**Baseline:** GovFreeze V2 Clean Baseline（只读 · 禁止重审计）
**Generated:** 2026-06-16T12:48:13Z

**纪律：** 一致性 · 追溯性 · 稳定性 · **禁止** Tokenomics/GovFreeze/MTM146 重复审计

**Inventory:** ACTIVE=68 · LEGACY=6 · DELETE_CANDIDATE=0 · BROKEN=0 · NEEDS_FIX=0
**Fix queue:** P0=0 · P1=0 · P2=0
...
| FE-GOV-STEWARD-REDIRECT | `frontend/next.config.js` | alias /governance/steward-region-workbench → /governance?view=region · Next redirect 已配置 | — | — |
...
| API-PARITY-params | `/api/v1/governance/params` | FE=Y BE=Y · /api/v1/governance/params · FE 经 protocol-reference 镜像 | — | — |
| API-PARITY-proposals | `/api/v1/governance/proposals` | FE=Y BE=Y · /api/v1/governance/proposals | — | — |
| API-PARITY-:id | `/api/v1/governance/proposal-status/:id` | FE=Y BE=Y · /api/v1/governance/proposal-status/:id | — | — |
...
| API-PARITY-:jurisdiction | `/api/v1/governance/country-ledger/:jurisdiction` | FE=Y BE=Y · /api/v1/governance/country-ledger/:jurisdiction · FE 经 params/protocol-referen | — | — |
...
| REG-PROTOCOL-CONVERGENCE | `registry/protocol-convergence-deployments.v1.yaml` | protocol-convergence-deployments.v1.yaml | — | — |
...
| FLOW-STEWARD-WORKBENCH | `/governance?view=region` | 质押/Seat 工作台 · alias redirect → ?view=region | — | — |
...
**Machine key:** `TT_FULL_SYS_ALIGN: ACTIVE=68 LEGACY=6 DEL=0 BROKEN=0 FIX=0 P0=0 P1=0 P2=0`
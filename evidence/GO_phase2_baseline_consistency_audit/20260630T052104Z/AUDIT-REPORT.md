...
**SSOT SHA:** `6e1fb5aca42b99f916ea6d6fc488a089536d3742`
**审计时间:** 20260630T052104Z UTC
...
| 项 | 值 |
|----|-----|
| git HEAD | `6e1fb5aca42b99f916ea6d6fc488a089536d3742` |
...
|----|-----|-----------|-------------|--------|------|
| 六角色/业务链 | login traveler | `seed account expected` | `<urlopen error [SSL: UNEXPECTED_EOF_WHILE_READIN` | DIFF |  |
...
机读：`evidence\GO_phase2_baseline_consistency_audit\20260630T052104Z/audit.json`

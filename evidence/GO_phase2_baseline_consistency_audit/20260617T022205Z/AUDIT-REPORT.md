...
| 项 | 值 |
|----|-----|
| git HEAD | `35ad2824ccea5466dbf4747c7e54391f5d1aacda` |
...
|----|-----|-----------|-------------|--------|------|
| SHA | git HEAD vs SSOT pin | `8dcd304afae1bafe5a4de738175e171256a9501e` | `35ad2824ccea5466dbf4747c7e54391f5d1aacda` | DIFF |  |
...
机读：`D:\TravelTrust-V1.1\evidence\GO_phase2_baseline_consistency_audit\20260617T022205Z/audit.json`

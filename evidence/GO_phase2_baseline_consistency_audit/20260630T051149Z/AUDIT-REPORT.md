...
**SSOT SHA:** `9979b35efe562e8dd200e9f1a1e17fcc8182d170`
**审计时间:** 20260630T051149Z UTC
...
| 项 | 值 |
|----|-----|
| git HEAD | `9979b35efe562e8dd200e9f1a1e17fcc8182d170` |
| API git_sha (probe=none) | `` |
| Web /meta SHA | `n/a` |
| **SHA Hard Match** | **NO** |
| 差异项 | 2 |
| 风险项 | 20 |
...
|----|-----|-----------|-------------|--------|------|
| SHA | API git_sha (probe=none) | `9979b35efe562e8dd200e9f1a1e17fcc8182d170` | `(missing)` | DIFF |  |
| 治理 | GET /governance/proposals | `200` | `<urlopen error [SSL: UNEXPECTED_EOF_WHILE_READIN` | DIFF |  |
...
机读：`evidence\GO_phase2_baseline_consistency_audit\20260630T051149Z/audit.json`

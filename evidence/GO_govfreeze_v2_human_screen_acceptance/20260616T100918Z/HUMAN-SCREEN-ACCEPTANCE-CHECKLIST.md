# GovFreeze V2 · 真人录屏验收清单 · 20260616T100918Z

**基线：** GovFreeze V2 + Four-Ledger PASS (`20260616T084248Z`) · **② only** · **禁止 Tokenomics 设计变更**

**录屏要求：** 每段含 URL 栏 · 身份/角色标识 · 关键操作与结果 · 时间戳；保存 `/d/TravelTrust-V1.1/evidence/GO_govfreeze_v2_human_screen_acceptance/20260616T100918Z/recordings/`
...
**签核：** `bash scripts/dev/record-govfreeze-v2-human-screen-acceptance.sh --evidence-dir /d/TravelTrust-V1.1/evidence/GO_govfreeze_v2_human_screen_acceptance/20260616T100918Z --signer "…"`

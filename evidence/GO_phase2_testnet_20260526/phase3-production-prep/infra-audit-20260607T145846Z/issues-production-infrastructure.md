...
| INF-P1-001 | P1 | Fly PG staging backup | WARN | tt-traveltrust-staging: fly unavailable — prod must not copy staging gap |
| INF-P0-003 | P0 | Fly PG prod backup | BLOCKER | tt-traveltrust-prod: fly unavailable |

...
\restrict HPDord7KkzfUukoxkiYE0sj0Mh4J9TMGyyNRqnLlZAfz88QHTFmnUvUxmSrc9AS

-- Dumped from database version 16.14 - Percona Distribution
...
--
-- Name: admin_console_roles; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: admin_data_policies; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: admin_security_policies; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: admin_tenant_scopes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: admin_totp_enrollments; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: airdrop_campaigns; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: airdrop_snapshots; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: api_versions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: auth_email_send_window_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: auth_email_send_window_events_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: auth_email_send_window_events_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: catalog_cities; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_content_revisions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_countries; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_hotel_tier_definitions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_intercity_routes; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_media_assets; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_poi_image_batches; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_poi_image_candidates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_poi_images_published; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_pois; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_pricing_templates; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: catalog_seo_metadata; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.catalog_seo_metadata (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    entity_type text NOT NULL,
    entity_id uuid NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT catalog_seo_metadata_locale_check CHECK (((char_length(locale) >= 1) AND (char_length(locale) <= 16))),
    CONSTRAINT catalog_seo_metadata_publish_status_check CHECK ((publish_status = ANY (ARRAY['draft'::text, 'in_review'::text, 'published'::text, 'archived'::text])))
);


--
-- Name: catalog_translation_entries; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.catalog_translation_entries (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    entity_type text NOT NULL,
    entity_id uuid NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT catalog_translation_entries_field_key_check CHECK (((char_length(field_key) >= 1) AND (char_length(field_key) <= 64))),
    CONSTRAINT catalog_translation_entries_locale_check CHECK (((char_length(locale) >= 2) AND (char_length(locale) <= 16))),
    CONSTRAINT catalog_translation_entries_publish_status_check CHECK ((publish_status = ANY (ARRAY['draft'::text, 'in_review'::text, 'published'::text, 'archived'::text])))
);


--
-- Name: catalog_transport_region_rules; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: checkpoints_sharded; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_abuse_policy; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_collects; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_conversations; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_dm_messages; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_dm_read_state; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_follows; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_friend_requests; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_friends; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_media_assets; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: TABLE community_media_assets; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN community_media_assets.playback_manifest_json; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: community_moderation_cases; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_penalties; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_policy_change_logs; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.community_posts (
    ...
    display_status text DEFAULT 'draft'::text NOT NULL,
    display_origin text DEFAULT 'REAL'::text NOT NULL,
    display_source text,
    featured boolean DEFAULT false NOT NULL,
    display_priority integer DEFAULT 0 NOT NULL,
    display_surfaces text[] DEFAULT '{}'::text[] NOT NULL,
    ...
    CONSTRAINT community_posts_display_origin_check CHECK ((display_origin = ANY (ARRAY['REAL'::text, 'OFFICIAL'::text, 'SHOWCASE'::text, 'TEST'::text, 'SMOKE'::text, 'SYSTEM'::text]))),
    CONSTRAINT community_posts_display_status_check CHECK ((display_status = ANY (ARRAY['draft'::text, 'published'::text, 'hidden'::text, 'archived'::text]))),
...
--
-- Name: COLUMN community_posts.commerce_showcase_kind; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: COLUMN community_posts.commerce_market_listing_id; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: community_ranking_snapshots; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_report_appeals; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: community_risk_signals; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: compliance_data_request_events; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: compliance_data_requests; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: config_releases; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: correction_log_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: correction_log_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: country_market_launches; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.country_market_launches (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    jurisdiction_iso character(2) NOT NULL,
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT country_market_launches_phase_check CHECK ((phase = ANY (ARRAY['intake'::text, 'legal'::text, 'catalog'::text, 'geo'::text, 'steward'::text, 'publish'::text, 'live'::text, 'archived'::text])))
);


--
-- Name: did_rank_rank_snapshots; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: dual_write_checks; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: early_bird_stages; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: COLUMN event_log.track_type; Type: COMMENT; Schema: public; Owner: -
--
...
--
-- Name: executor_executions; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: fee_router_routed_events; Type: TABLE; Schema: public; Owner: -
--

...
**Verdict:** `AU_COUNTRY_RUNTIME_PASS`
**TT_CMS_AU_COUNTRY_RUNTIME:** `PASS`
...
| 7 | 三城 AU LOCK 资产 (24/24) | ✅ PASS |
| 8 | AU POI Catalog Scope Lock · 24 POI / 3 cities 不变 | ✅ PASS |
...
| 12 | 首页 Destination Ambient · 澳大利亚读 CMS · 无 Unsplash | ✅ PASS |
| 13 | Catalog API AU POI 24/24 与 LOCK 一致 | ✅ PASS |
| 14 | 三城 Market POI Runtime · Exit Check Gate 4 聚合 | ✅ PASS |
| 15 | Live Consumer · 首页澳大利亚 Ambient + Market 壳 + 澳大利亚相关内容无 fallback | ✅ PASS |

**AU POI Runtime:** 24/24 PASS

**三城汇总**

- 悉尼: Exit 8/8 · Catalog 8/8 · Live 8/8
- 墨尔本: Exit 8/8 · Catalog 8/8 · Live 8/8
- 黄金海岸: Exit 8/8 · Catalog 8/8 · Live 8/8

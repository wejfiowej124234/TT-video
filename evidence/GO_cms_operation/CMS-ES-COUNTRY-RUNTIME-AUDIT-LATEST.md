...
**Verdict:** `ES_COUNTRY_RUNTIME_PASS`
**TT_CMS_ES_COUNTRY_RUNTIME:** `PASS`
...
| 7 | 三城 ES LOCK 资产 (24/24) | ✅ PASS |
| 8 | ES POI Catalog Scope Lock · 24 POI / 3 cities 不变 | ✅ PASS |
...
| 12 | 首页 Destination Ambient · 西班牙读 CMS · 无 Unsplash | ✅ PASS |
| 13 | Catalog API AU POI 24/24 与 LOCK 一致 | ✅ PASS |
| 14 | 三城 Market POI Runtime · Exit Check Gate 4 聚合 | ✅ PASS |
| 15 | Live Consumer · 首页西班牙 Ambient + Market 壳 + 西班牙相关内容无 fallback | ✅ PASS |

**AU POI Runtime:** 24/24 PASS

**三城汇总**

- 巴塞罗那: Exit 8/8 · Catalog 8/8 · Live 8/8
- 马德里: Exit 8/8 · Catalog 8/8 · Live 8/8
- 塞维利亚: Exit 8/8 · Catalog 8/8 · Live 8/8

...
**Stamp:** `20260616T110903Z`
**Baseline SSOT:** GovFreeze V2 Clean Baseline
**Generated:** 2026-06-16T11:09:15Z
...
| ID | Category | Path | Summary | Action | Risk |
|----|----------|------|---------|--------|------|
| ROUTE-DRIFT-01 | route_drift | `scripts/dev/gen-tt-repository-alignment-inventory.py` | capture-hat-r1 / browser-acceptance 仍引用 create；App SSOT 为 new · hits=1 | 统一为 /governance/proposals/new | P1 |

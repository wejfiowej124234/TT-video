...
**Stamp:** `20260616T112136Z`
**Baseline SSOT:** GovFreeze V2 Clean Baseline
**Generated:** 2026-06-16T11:21:45Z

**纪律：** 一致性 · 追溯性 · 仓库清洁度 · **禁止**重复评估已通过治理逻辑

**Inventory:** ACTIVE=30 · LEGACY=18 · DELETE_CANDIDATE=2
...
| ADDR-REF-LEGACY-0x87c77986 | address_drift | `registry/protocol-convergence-deployments.v1.yaml` | 引用 legacy 地址 0x87c77986c7de47131d02a6407308b974324cc6dc 无 LEGACY/cutover 上下文 | 改为 ACTIVE 或显式 LEGACY 注释 | P1 |
...
| DOC-LEG-TTG-GOVERNANCE-FULL-COVE | superseded_doc | `docs/spec/governance-token/TTG-GOVERNANCE-FULL-COVERAGE-MATRIX.md` | SSOT-MTM-146 取代 · 只读旁证 | 标 LEGACY · 禁止扩写 · 可归档 | P2 |
| DOC-LEG-gen-ttg-governance-full- | superseded_doc | `scripts/dev/gen-ttg-governance-full-coverage-matrix.py` | MTM generator 为执行真源 | 标 LEGACY · 禁止扩写 · 可归档 | P2 |
| DOC-LEG-TTG-GOVERNANCE-HUMAN-CER | superseded_doc | `docs/spec/governance-token/TTG-GOVERNANCE-HUMAN-CERTIFICATION-COVERAGE-REPORT.md` | Cert 轨 · MTM 146 为真源 | 标 LEGACY · 禁止扩写 · 可归档 | P2 |
...
**Machine key:** `TT_REPO_ALIGN: ACTIVE=30 LEGACY=18 DEL=2 P0_ROUTE_DRIFT=0 BASELINE=V2`
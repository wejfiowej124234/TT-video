...
**Stamp:** `20260616T110635Z`
**Baseline SSOT:** GovFreeze V2 Clean Baseline
**Generated:** 2026-06-16T11:06:35Z

**纪律：** 一致性 · 追溯性 · 仓库清洁度 · **禁止**重复评估已通过治理逻辑

**Inventory:** ACTIVE=30 · LEGACY=108 · DELETE_CANDIDATE=15
...
| ID | Category | Path | Summary | Action | Risk |
|----|----------|------|---------|--------|------|
| ROUTE-DRIFT-01 | route_drift | `scripts/dev/capture-hat-r1-screenshots.mjs` | capture-hat-r1 / browser-acceptance 仍引用 create；App SSOT 为 new · hits=4 | 统一为 /governance/proposals/new | P1 |
...
**Machine key:** `TT_REPO_ALIGN: ACTIVE=30 LEGACY=108 DEL=15 BASELINE=V2`
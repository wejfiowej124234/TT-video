...
**STATUS:** `V9_REMINT_LOCAL_PASS` · Owner Norm 5.1–5.4 sealed · **DESIGN_ONLY beyond local** · **NOT** Sepolia · **NOT** Mainnet · **NOT** Production GO  
**Stamp:** `evidence/GO_ttg_v9_design/V9_REMINT_LOCAL_PASS.json` · gate `scripts/dev/run-ttg-v9-remint-local-gate.sh`  

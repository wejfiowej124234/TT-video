...
**真源：** [../../defects/](../../defects/) · [../../summary/MASTER-DEFECT-REGISTER.md](../../summary/MASTER-DEFECT-REGISTER.md)

| Status | 含义 |
|--------|------|
| OPEN | 新发现 |
| FIXED | 已合码待部署/复测 |
| READY_FOR_RETEST | 可回归 |
| VERIFIED | 回归通过 |
| CLOSED | 关闭（**不删档**） |
| REOPENED | 回归失败或复发 |

每缺陷：**Fix Commit** · **Regression Session** — 见 DEFECT-NNN.md

**本轮 ID 映射：** API-20260630-001 → DEFECT-001 · INFRA-* → DEFECT-002/003

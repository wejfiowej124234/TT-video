...
**Generated:** 2026-06-24T04:29:22Z · **verdict:** **WARN** · **preconvergence:** 100/100
**Job:** `evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 37 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.211 · wall ETA=372.0h · budget ETA=71.4h
- poll overhead=259.7s · jitter_trend=stable
- interval mean=319.7s stdev=14.5s
...
- observability samples=23 · exec_ok_ratio=1.0

## 3. Indexer parse rate

- parse_rate=0.027 · empty_rate=0.973 · flap_rate=0.027
- probe_fallback_ratio=1.0

## 4. Backlog risk diffusion

- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T042922Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~372.0h — no deploy during soak…
...
- wall_growth=stable · overhead_slope=-0.22
- indexer_decline=stable · slope=-0.0004
...
- **lock_status:** `FAIL` · strategy=STRAT-A_PLUS_MR12
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.211 — 72h completion wall-clock >> nominal

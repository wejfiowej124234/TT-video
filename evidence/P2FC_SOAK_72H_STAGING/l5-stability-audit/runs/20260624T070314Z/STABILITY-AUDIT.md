...
**Generated:** 2026-06-24T07:03:15Z · **verdict:** **WARN** · **preconvergence:** 65/100
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T070314Z
...
- wall_growth=rising · overhead_slope=1.34
- indexer_decline=stable · slope=0.0034
...
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0224/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.34s/snapshot — probe latency creep (/meta pressure)

...
**Generated:** 2026-06-24T05:18:12Z · **verdict:** **WARN** · **preconvergence:** 65/100
**Job:** `D:\TravelTrust-V1.1\evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 45 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.387 · wall ETA=383.8h · budget ETA=71.2h
- poll overhead=269.2s · jitter_trend=stable
- interval mean=329.2s stdev=53.7s
...
- observability samples=34 · exec_ok_ratio=1.0

## 3. Indexer parse rate

- parse_rate=0.022 · empty_rate=0.978 · flap_rate=0.022
- probe_fallback_ratio=1.0

## 4. Backlog risk diffusion

- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T051812Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~383.8h — no deploy during soak…
...
- wall_growth=rising · overhead_slope=1.9
- indexer_decline=stable · slope=-0.001
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.387 — 72h completion wall-clock >> nominal
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0352/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.9s/snapshot — probe latency creep (/meta pressure)

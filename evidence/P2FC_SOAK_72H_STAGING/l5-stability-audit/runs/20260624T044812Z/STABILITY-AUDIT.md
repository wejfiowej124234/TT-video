...
**Generated:** 2026-06-24T04:48:12Z · **verdict:** **WARN** · **preconvergence:** 65/100
**Job:** `D:\TravelTrust-V1.1\evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 39 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.371 · wall ETA=383.2h · budget ETA=71.3h
- poll overhead=269.1s · jitter_trend=slowing
- interval mean=329.1s stdev=57.5s
...
- observability samples=28 · exec_ok_ratio=1.0

## 3. Indexer parse rate

- parse_rate=0.025 · empty_rate=0.975 · flap_rate=0.025
- probe_fallback_ratio=1.0

## 4. Backlog risk diffusion

- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T044812Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~383.2h — no deploy during soak…
...
- indexer_decline=stable · slope=-0.0006
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.371 — 72h completion wall-clock >> nominal
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0312/snapshot — slow wall-clock creep

...
**Generated:** 2026-06-24T06:48:14Z · **verdict:** **WARN** · **preconvergence:** 65/100
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T064814Z
...
- wall_growth=rising · overhead_slope=1.2
...
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0208/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.2s/snapshot — probe latency creep (/meta pressure)

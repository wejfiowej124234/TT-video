...
**Generated:** 2026-06-24T05:48:13Z · **verdict:** **WARN** · **preconvergence:** 65/100
**Job:** `D:\TravelTrust-V1.1\evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 50 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.376 · wall ETA=382.6h · budget ETA=71.2h
- poll overhead=267.9s · jitter_trend=stable
- interval mean=327.9s stdev=51.2s
- fail_events=1 · verdict=warn

## 2. /meta layered failure propagation

- dominant chain=408>503>exec_ok>accept_deferred (0.977)
- L1→L2 503 ratio=1.0 · transitions=2
- observability samples=43 · exec_ok_ratio=0.977
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T054813Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~382.6h — no deploy during soak…
...
- wall_growth=stable · overhead_slope=-0.24
- indexer_decline=stable · slope=-0.001
- meta_cluster=stable_cluster · density=0.977
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.376 — 72h completion wall-clock >> nominal

...
**Generated:** 2026-06-24T06:03:13Z · **verdict:** **WARN** · **preconvergence:** 65/100
...
- dominant chain=408>503>exec_ok>accept_deferred (0.979)
- L1→L2 503 ratio=1.0 · transitions=2
- observability samples=47 · exec_ok_ratio=0.979
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T060313Z
...
- **M3_INDEXER_PARSE** indexer parse rate: convergence=converged · gate=TN-P1-010 · post-soak=TN-P1-010 independent via internal/indexer-* — not GET /meta…
...
- wall_growth=rising · overhead_slope=1.1
- indexer_decline=stable · slope=0.0024
- meta_cluster=stable_cluster · density=0.979
...
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0234/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.1s/snapshot — probe latency creep (/meta pressure)

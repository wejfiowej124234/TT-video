...
**Generated:** 2026-06-24T05:03:12Z · **verdict:** **WARN** · **preconvergence:** 65/100
**Job:** `D:\TravelTrust-V1.1\evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 42 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.372 · wall ETA=383.0h · budget ETA=71.3h
- poll overhead=268.7s · jitter_trend=slowing
- interval mean=328.7s stdev=55.4s
...
- observability samples=32 · exec_ok_ratio=1.0

## 3. Indexer parse rate

- parse_rate=0.023 · empty_rate=0.977 · flap_rate=0.023
- probe_fallback_ratio=1.0

## 4. Backlog risk diffusion

- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T050312Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~383.0h — no deploy during soak…
...
- wall_growth=rising · overhead_slope=1.8
- indexer_decline=stable · slope=-0.0008
- meta_cluster=stable_cluster · density=1.0
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.372 — 72h completion wall-clock >> nominal
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0322/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.8s/snapshot — probe latency creep (/meta pressure)

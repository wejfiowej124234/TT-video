...
**Generated:** 2026-06-24T05:33:13Z · **verdict:** **WARN** · **preconvergence:** 65/100
**Job:** `D:\TravelTrust-V1.1\evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 48 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.384 · wall ETA=383.3h · budget ETA=71.2h
- poll overhead=268.6s · jitter_trend=stable
- interval mean=328.6s stdev=52.2s
- fail_events=1 · verdict=warn

## 2. /meta layered failure propagation

- dominant chain=408>503>exec_ok>accept_deferred (0.974)
- L1→L2 503 ratio=1.0 · transitions=2
- observability samples=39 · exec_ok_ratio=0.974

## 3. Indexer parse rate

- parse_rate=0.02 · empty_rate=0.98 · flap_rate=0.02
- probe_fallback_ratio=1.0

## 4. Backlog risk diffusion

- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T053313Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~383.3h — no deploy during soak…
...
- wall_growth=rising · overhead_slope=1.78
- indexer_decline=stable · slope=-0.0014
- meta_cluster=stable_cluster · density=0.974
- hotspots=5 · drift_signals=5
...
- **[medium]** DRIFT_INDEXER_SOURCE_EMPTY: indexer_source empty 98% of polls — /meta body unavailable; TN-P1-010 must use internal spine
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.384 — 72h completion wall-clock >> nominal
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0346/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.78s/snapshot — probe latency creep (/meta pressure)

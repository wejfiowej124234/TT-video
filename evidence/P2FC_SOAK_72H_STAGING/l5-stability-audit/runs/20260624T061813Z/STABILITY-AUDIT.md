...
**Generated:** 2026-06-24T06:18:14Z · **verdict:** **WARN** · **preconvergence:** 65/100
...
- dominant chain=408>503>exec_ok>accept_deferred (0.98)
- L1→L2 503 ratio=1.0 · transitions=2
- observability samples=49 · exec_ok_ratio=0.98
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T061813Z
...
- wall_growth=rising · overhead_slope=1.18
- indexer_decline=stable · slope=0.0028
- meta_cluster=stable_cluster · density=0.98
...
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0232/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.18s/snapshot — probe latency creep (/meta pressure)

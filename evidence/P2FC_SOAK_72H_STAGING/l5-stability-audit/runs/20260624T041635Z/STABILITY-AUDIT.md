...
**Generated:** 2026-06-24T04:16:35Z · **verdict:** **WARN** · **preconvergence:** 100/100
**Job:** `D:\TravelTrust-V1.1\evidence\P2FC_SOAK_72H_STAGING\job-20260624T011124Z` · **ok_polls:** 34 · **completed:** False

## 1. Wall-clock deviation

- wall/budget ratio=5.218 · wall ETA=372.7h · budget ETA=71.4h
- poll overhead=260.8s · jitter_trend=stable
- interval mean=320.8s stdev=14.4s
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T041635Z
...
- **M1_WALL_CLOCK** wall-clock 偏差: convergence=converged · gate=SOAK_72H · post-soak=monitor wall ETA ~372.7h — no deploy during soak…
...
- wall_growth=stable · overhead_slope=0.2
- indexer_decline=stable · slope=-0.000667
...
- **[medium]** HR_WALL_BUDGET_DIVERGE: wall/budget ratio 5.218 — 72h completion wall-clock >> nominal

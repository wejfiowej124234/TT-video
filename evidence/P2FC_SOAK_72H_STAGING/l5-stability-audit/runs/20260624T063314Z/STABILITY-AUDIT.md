...
**Generated:** 2026-06-24T06:33:14Z · **verdict:** **WARN** · **preconvergence:** 65/100
...
- TT_BACKLOG_DEPENDENCY_GRAPH: WARN files=180 risks=1 diffusion=1.1 out=D:/TravelTrust-V1.1/evidence/P2FC_SOAK_72H_STAGING/l5-stability-audit/runs/20260624T063314Z
...
- wall_growth=rising · overhead_slope=1.08
- indexer_decline=stable · slope=0.003
...
- **[medium]** DRIFT_WALL_CLOCK_RISING: wall/budget ratio slope +0.0202/snapshot — slow wall-clock creep
- **[medium]** DRIFT_POLL_OVERHEAD_RISING: poll overhead +1.08s/snapshot — probe latency creep (/meta pressure)

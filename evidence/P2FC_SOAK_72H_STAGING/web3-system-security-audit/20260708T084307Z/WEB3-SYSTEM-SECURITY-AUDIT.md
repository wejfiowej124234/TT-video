...
- **verdict:** WARN · SPOF=8 · **P0 RBAC bypass isolated:** NOT_CONFIRMED · **ADM-U01 live prep:** BLOCKED

## P0 RBAC bypass isolation

- status=NOT_CONFIRMED · before COMPLETED.json=False
- static_pass=False · live meta reachable=True
...
- [medium] D3-F01: Permission ID drift across SSOT layers

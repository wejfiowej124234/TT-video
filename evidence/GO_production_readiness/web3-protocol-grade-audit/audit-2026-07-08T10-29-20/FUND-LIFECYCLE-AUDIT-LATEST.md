...
**Recorded:** 2026-07-08T10:30:07.987Z
...
| FL-02 | R3_escrow | Escrow Funded → Release split (after bilateral service complete) | permissionless Keeper AFTER service bilateral complete — Design Intent | none | none after Completed | release before bilateral confirm if atte… | **UNVERIFIED** |
...
```json
{
  "verified": true,
  "restricted": false,
  "caller_model": "public_anyone",
  "note": "UNVERIFIED — release() has no caller guard"
}
```

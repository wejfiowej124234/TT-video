...
**Updated:** 2026-07-08T12:32:42.897Z
...
- **②-B Admin** — `PASS`
- **②-C CMS / COS / Data** — `IN_PROGRESS` ← **focus**
- **②-D Web3** — `BLOCKED`
...
| Blocked | — |
| Waiting Reason | Staging media/CDN — G6 provider/acquisition cover bindings |
| ETA | — |
| Next | Re-run G6 until PASS |
| Owner | Junxi |

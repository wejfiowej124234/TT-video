...
- [x] **2A-WEBSITE-PRODUCT-UAT** (2A) — Surface coverage registry + multi-identity UAT — human signoff pending
- [ ] **2B-ADMIN-OPS-UAT** (2B) — Admin console · moderation · provider apps · official ops UAT pending
- [ ] **2C-DATA-CMS-COS** (2C) — CMS/COS/data governance validation not yet recorded
...
1. `node scripts/dev/run-web3-freeze.cjs` — freeze Contracts · Registry · ABI · etc.
2. `node scripts/dev/generate-mainnet-deployment-package.cjs`
3. Phase ③ Wave deployment from `MANIFEST/manifest.json` (NOT param swap)

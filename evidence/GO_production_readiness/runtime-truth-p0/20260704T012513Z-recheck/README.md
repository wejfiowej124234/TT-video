...
**Stamp:** 20260704T012513Z-recheck

## Reproduce from clean clone

```bash
node scripts/dev/audit-runtime-truth-call-graph.cjs
node scripts/dev/validate-runtime-truth-p0.cjs --evidence-dir evidence/GO_production_readiness/runtime-truth-p0/20260704T012513Z-recheck

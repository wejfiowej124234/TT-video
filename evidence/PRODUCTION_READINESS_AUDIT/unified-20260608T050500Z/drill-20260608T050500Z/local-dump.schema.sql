...
\restrict EP2WhDhaULd9xdiZIbDhtR8V9NAL8GUsNPIhXB6Oq4Y4y0ChJifDJhtzKP3hJYb
...
--
-- Name: governance_mvp_delegations; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.governance_mvp_delegations (
...
--
-- Name: governance_mvp_proposals; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.governance_mvp_proposals (
    id uuid NOT NULL,
    title text NOT NULL,
    body text NOT NULL,
    status text NOT NULL,
...
--
-- Name: governance_mvp_votes; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.governance_mvp_votes (
    proposal_id uuid NOT NULL,
    voter_user_id uuid NOT NULL,
    choice text NOT NULL,
    weight bigint NOT NULL,
    voted_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT governance_mvp_votes_choice_check CHECK ((choice = ANY (ARRAY['yes'::text, 'no'::text, 'abstain'::text]))),
    CONSTRAINT governance_mvp_votes_weight_check CHECK ((weight > 0))
);


--
-- Name: governance_pool; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.governance_pool (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    balance text,
    currency text,
    updated_at timestamp with time zone DEFAULT now() NOT NULL
...
--
-- Name: governance_proposals_projection; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.governance_proposals_projection (
    chain_id bigint NOT NULL,
    proposal_id numeric(78,0) NOT NULL,
    proposer bytea,
    snapshot_block bigint DEFAULT 0 NOT NULL,
    vote_start_block bigint DEFAULT 0 NOT NULL,
    vote_end_block bigint DEFAULT 0 NOT NULL,
    title text,
...
--
-- Name: governance_reward_records; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.governance_reward_records (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    user_id uuid,
...
--
-- Name: growth_fraud_cases; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.growth_fraud_cases (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    subject_user_id uuid NOT NULL,
    status text DEFAULT 'open'::text NOT NULL,
    resolution text,
...
--
-- Name: growth_fraud_signals; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.growth_fraud_signals (
    id uuid DEFAULT gen_random_uuid() NOT NULL,
    subject_user_id uuid NOT NULL,
    signal_type text NOT NULL,
    ...
    payload jsonb DEFAULT '{}'::jsonb NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT growth_fraud_signals_risk_level_check CHECK ((risk_level = ANY (ARRAY['LOW'::text, 'MEDIUM'::text, 'HIGH'::text])))
);


--
-- Name: growth_point_ledger; Type: TABLE; Schema: public; Owner: -
--
...
CREATE TABLE public.growth_point_ledger (
    ...
    fraud_status text DEFAULT 'cleared'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL
);


--
-- Name: growth_registration_seq; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.growth_registration_seq (
    id integer DEFAULT 1 NOT NULL,
    next_rank bigint DEFAULT 1 NOT NULL,
    CONSTRAINT growth_registration_seq_id_check CHECK ((id = 1))
);
...
CREATE TABLE public.guides (
    ...
    stake_amount text DEFAULT '0'::text NOT NULL,
    status text DEFAULT 'pending'::text NOT NULL,
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    updated_at timestamp with time zone DEFAULT now() NOT NULL,

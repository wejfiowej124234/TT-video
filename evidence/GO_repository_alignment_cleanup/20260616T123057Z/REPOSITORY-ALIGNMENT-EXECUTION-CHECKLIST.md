...
**Stamp:** `20260616T123057Z`
**Baseline SSOT:** GovFreeze V2 Clean Baseline
**Generated:** 2026-06-16T12:31:08Z

**纪律：** 一致性 · 追溯性 · 仓库清洁度 · **禁止**重复评估已通过治理逻辑

**Inventory:** ACTIVE=31 · LEGACY=18 · DELETE_CANDIDATE=1
**P0 route drift open=1** · **P1 doc narrative open=0** · **P1 address drift open=0**
**P2 dead-code open=0** · **P2 superseded-doc drift open=0**
**P3 evidence stale open=0** · **DELETE_CANDIDATE total=1**
...
| EVID-ARCHIVE-INDEX | evidence | `evidence/archive-evidence/ARCHIVE-EVIDENCE-INDEX.v1.json` | P3 归档索引 · entries=46 | 只读 · 禁止删最终证据 | P3 |
...
| ADDR-REF-LEGACY-0x462c2351 | address_drift | `registry/protocol-convergence-deployments.v1.yaml` | 引用 legacy 地址 0x462c2351971707a8ceeb3ce789f268b8326c76a0 无 LEGACY/cutover 上下文 | 改为 ACTIVE 或显式 LEGACY 注释 | P1 |
...
| ID | Category | Path | Summary | Action | Risk |
|----|----------|------|---------|--------|------|
| ROUTE-DRIFT-01 | route_drift | `scripts/dev/gen-tt-full-system-alignment-stability-inventory.py` | capture-hat-r1 / browser-acceptance 仍引用 create；App SSOT 为 new · hits=1 | 统一为 /governance/proposals/new | P0 |
...
**Machine key:** `TT_REPO_ALIGN: ACTIVE=31 LEGACY=18 DEL=1 P0_ROUTE_DRIFT=1 BASELINE=V2`
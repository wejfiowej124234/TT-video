...
**Stamp:** `20260616T121042Z`
**Baseline SSOT:** GovFreeze V2 Clean Baseline
**Generated:** 2026-06-16T12:11:05Z
...
| EVID-ARCHIVE-INDEX | evidence | `evidence/archive-evidence/ARCHIVE-EVIDENCE-INDEX.v1.json` | P3 归档索引 · entries=41 | 只读 · 禁止删最终证据 | P3 |
...
| ADDR-REF-LEGACY-0xbf1f5b8c | address_drift | `registry/protocol-convergence-deployments.v1.yaml` | 引用 legacy 地址 0xbf1f5b8c5b8a1cfc8e4458eb43c1a0ab24012806 无 LEGACY/cutover 上下文 | 改为 ACTIVE 或显式 LEGACY 注释 | P1 |

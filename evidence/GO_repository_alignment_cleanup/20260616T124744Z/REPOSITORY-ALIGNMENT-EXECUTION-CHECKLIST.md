...
**Generated:** 2026-06-16T12:48:00Z

**纪律：** 一致性 · 追溯性 · 仓库清洁度 · **禁止**重复评估已通过治理逻辑

**Inventory:** ACTIVE=31 · LEGACY=17 · DELETE_CANDIDATE=1
...
| EVID-ARCHIVE-INDEX | evidence | `evidence/archive-evidence/ARCHIVE-EVIDENCE-INDEX.v1.json` | P3 归档索引 · entries=48 | 只读 · 禁止删最终证据 | P3 |
...
**Machine key:** `TT_REPO_ALIGN: ACTIVE=31 LEGACY=17 DEL=1 P0_ROUTE_DRIFT=1 BASELINE=V2`
...
**Stamp:** `20260616T113725Z`
**Baseline SSOT:** GovFreeze V2 Clean Baseline
**Generated:** 2026-06-16T11:37:36Z

**纪律：** 一致性 · 追溯性 · 仓库清洁度 · **禁止**重复评估已通过治理逻辑

**Inventory:** ACTIVE=31 · LEGACY=18 · DELETE_CANDIDATE=0
...
| EVID-ARCHIVE-INDEX | evidence | `evidence/archive-evidence/ARCHIVE-EVIDENCE-INDEX.v1.json` | P3 归档索引 · entries=38 | 只读 · 禁止删最终证据 | P3 |
...
| EVID-LATEST-GO_ai_pre_human_uat | evidence | `evidence/GO_ai_pre_human_uat/latest-stamp.txt` | latest=20260616T105001Z | 保留 latest + baseline 锚 · 旧 stamp 归档 archive-evidence | P3 |
...
**Machine key:** `TT_REPO_ALIGN: ACTIVE=31 LEGACY=18 DEL=0 P0_ROUTE_DRIFT=0 BASELINE=V2`
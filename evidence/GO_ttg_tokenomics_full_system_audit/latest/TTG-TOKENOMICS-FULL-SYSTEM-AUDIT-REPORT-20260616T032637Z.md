...
**Stamp:** `20260616T032637Z`  
**Phase:** ② Sepolia · **Verdict:** **PASS_WITH_PARTIAL**  
...
| Country Pool（每国独立） | 45% Steward / 55% Global · G23-04 frozen ABI | CountryPoolNetProfitLedger + vaults | params 45/55 资金流 | PASS |
| Steward 45% 路径 | country-revenue-model §2 | StewardPathVault / UnallocatedStewardPathVault | steward workbench | PASS |
| Global 55% 路径 | country-revenue-model §2 · Treasury 顺序 | ledger.globalTreasury | treasury policy section | PASS |
...
| UI 文案与资金流图 | TTG-TOKENOMICS-FREEZE-V1 §6 | — | GovernanceParamsProfitFlowVisual | PASS |
...
**机读报告：** `evidence/GO_ttg_tokenomics_full_system_audit/20260616T032540Z/ttg-tokenomics-full-system-audit-20260616T032637Z.json`

**稳定 grep：** `TTG_TOKENOMICS_FULL_SYSTEM_AUDIT: PASS_WITH_PARTIAL`

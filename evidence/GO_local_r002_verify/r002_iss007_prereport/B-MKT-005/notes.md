...
`cargo test -p traveltrust-api matrix_93_b_mkt_005_f021_get_provider_listings_app_stack_ok_pg` exit=0
...
[req] x-request-id=239b80d5-4acf-4192-b1d0-577ae93f2c98 path=/api/v1/market/provider/listings status=200
[req] x-message-id=36a43774-7f4c-41a2-b3e3-72aeeca3c479 path=/api/v1/market/provider/listings status=200

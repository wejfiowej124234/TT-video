...
```
)]` (part of `#[warn(unused)]`) on by default
...
[req] x-request-id=24904b7d-9ea9-490b-a006-0455dcf627d0 path=/api/v1/guides status=200
[req] x-message-id=9d568a58-124e-4100-865d-f88b3ecaf86c path=/api/v1/guides status=200
[req] x-request-id=a9686467-5cf9-4759-9cb9-3eeba875ad7c path=/api/v1/guides/062eee58-f921-45a5-a931-c52ff5a312c6 status=200
[req] x-message-id=01fca304-25bb-47be-9eaa-0de36af02ea2 path=/api/v1/guides/062eee58-f921-45a5-a931-c52ff5a312c6 status=200

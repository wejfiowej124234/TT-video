...
```
ant`, `market_listing_surface_key`, and `select_governed_public_market_listing_by_id`
...
[req] x-request-id=1d2f84c5-bf72-472c-99cd-b8903f9373bd path=/auth/register status=200
[req] x-message-id=1292344a-8ef4-4537-9011-bd716b648466 path=/auth/register status=200
[req] x-request-id=26d66890-6902-4edd-9028-37bf2ada2abf path=/api/v1/itineraries status=200
[req] x-message-id=e7053f06-7dcb-40ca-b24e-7e3adf0ba54a path=/api/v1/itineraries status=200
audit_key_write op=confirm_final_plan request_id=- user_id=29e96ff2-8ea8-460b-965a-a66bb0a804ff order_id=b49eca04-012b-4557-b9b8-2eacd07651eb
[req] x-request-id=e74e4079-f60a-4768-9c4e-bfd8431b5f67 path=/api/v1/orders/b49eca04-012b-4557-b9b8-2eacd07651eb/confirm-final-plan status=200
[req] x-message-id=7e46e3f6-8985-4d27-9d0f-ac48476bb0bc path=/api/v1/orders/b49eca04-012b-4557-b9b8-2eacd07651eb/confirm-final-plan status=200

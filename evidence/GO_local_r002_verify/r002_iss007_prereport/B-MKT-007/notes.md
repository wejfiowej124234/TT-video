...
```
ts)]` (part of `#[warn(unused)]`) on by default
...
[req] x-request-id=8a25f390-1779-4fad-8779-03ad8c3d1151 path=/api/v1/market/provider/listings status=200
[req] x-message-id=6c5b85c4-b749-4909-a309-e6e173f29f7c path=/api/v1/market/provider/listings status=200
[req] x-request-id=d16573e1-e42c-479f-ae58-6ecca17932c7 path=/api/v1/market/provider/listings status=200
[req] x-message-id=37531987-7303-486e-8ef5-33bf7f6f0154 path=/api/v1/market/provider/listings status=200

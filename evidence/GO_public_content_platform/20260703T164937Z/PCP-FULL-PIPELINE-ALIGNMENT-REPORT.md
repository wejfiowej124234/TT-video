# PCP Full Pipeline Alignment · 20260703T164937Z
...
| **Phase ② Staging Runtime** | **FAIL** |
| **TT_PCP_ARCHITECTURE_COMPLIANCE** | **PASS** |
| **TT_PCP_PHASE_0_5 Sign-off** | **PAUSED** |
| **PCP Full Pipeline Alignment Sign-off** | **FAIL** |

Blocking gaps: **1** · Non-blocking: **2**
...
| community | governance | PASS | FAIL | governed_community_posts_v1 SQL view (P2) |
...
| market | governance | REFERENCE | REFERENCE | display_status + DDG filter in Rust (reference — no SQL governed view yet) |
| market | builder | REFERENCE | REFERENCE | chain_off/market_public_surface.rs (reference MarketBuilder) |
...
| provider | governance | REFERENCE | REFERENCE | shared with market DDG |
| provider | builder | REFERENCE | REFERENCE | MarketBuilder reference |
...
| acquisition | governance | REFERENCE | REFERENCE | shared with market DDG |
| acquisition | builder | REFERENCE | REFERENCE | MarketBuilder reference |
...
| official_guide | governance | REFERENCE | REFERENCE | OCS tier + display_status + Public Ops publish |
| official_guide | builder | REFERENCE | REFERENCE | MarketBuilder / guides public surface |
...
- **[NON_BLOCKING]** `MKT-GOV-001` · market/governance — Market uses Rust-side display_status filter, not Governed SQL View (reference impl)
  - Fix: Phase 1: governed_market_* views + migrate MarketBuilder to pcp/
...
- **[BLOCKING]** `STG-COM-GOV-001` · community/governance — Admin unpublish succeeds but post remains in Feed — governed view not active on staging
  - Fix: Deploy Phase 0 to tt-api-staging + migration 20260704100000; re-run validate-pcp-phase0-5-staging.cjs

## Fix Order

1. [BLOCKING] STG-COM-GOV-001 — Deploy Phase 0 to tt-api-staging + migration 20260704100000; re-run validate-pcp-phase0-5-staging.cjs
2. [NON_BLOCKING] MKT-GOV-001 — Phase 1: governed_market_* views + migrate MarketBuilder to pcp/
3. [NON_BLOCKING] CAM-BLD-001 — Phase 1: pcp/campaign_builder.rs + governed campaign surfaces

# PCP Full Pipeline Alignment · 20260703T230939Z
...
| campaign | governance | FAIL | PENDING | governed_campaign_surfaces_v1 + governed_campaign_items_v1 |
| campaign | builder | PASS | PASS | CampaignBuilder · pcp/campaign_builder.rs |
...
- **[NON_BLOCKING]** `CAM-GOV-001` · campaign/governance — Campaign governed views incomplete on static scan
  - Fix: Verify migration 20260704120000 + campaign_catalog reads

## Fix Order

1. [NON_BLOCKING] MKT-GOV-001 — Verify migration 20260704110000 + market_catalog reads
2. [NON_BLOCKING] CAM-GOV-001 — Verify migration 20260704120000 + campaign_catalog reads

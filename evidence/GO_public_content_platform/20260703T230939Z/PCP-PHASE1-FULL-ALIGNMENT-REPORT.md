# PCP Phase 1 Full Platform Alignment · 20260703T230939Z
...
| **Domains fully aligned (7/7 layers PASS)** | **6 / 7** |
| **Phase 1 gaps (REFERENCE · PARTIAL · OLD_READ_PATH)** | **2** |
...
| market | evidence | PASS | evidence/GO_public_content_platform/20260703T230939Z/phase1-market-batch-validation-chain.json | phase1-market-batch-validation-chain.json |
...
| campaign | governance | GAP | ops_cold_start direct read | governed_campaign_surfaces_v1 |
...
| campaign | evidence | PASS | evidence/GO_public_content_platform/20260703T230939Z/phase1-campaign-batch-validation-chain.json | phase1-campaign-batch-validation-chain.json |
...
- **[REFERENCE_IMPL]** `P1-CAM-GOV-001` · campaign/governance — Campaign public read not wired to governed_campaign_surfaces_v1
  - Fix: Apply migration 20260704120000 + campaign_catalog + pcp/campaign_builder.rs

## Phase 1 Fix Order

1. [REFERENCE_IMPL] P1-CAM-GOV-001 — Apply migration 20260704120000 + campaign_catalog + pcp/campaign_builder.rs
